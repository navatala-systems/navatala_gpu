...
- Generated: `2026-07-08T01:45:20Z`
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| baseline | baseline shared buffers | yes | 3630 | 3630 | 0 | 3530 | 0 | 0 | 0/1/1 |
| batch_submits | submit batching(limit=64) | yes | 220 | 220 | 0 | 3530 | 3630 | 220 | 1/0/0 |
| private | private buffers(min=1048576B) | yes | 7156 | 3630 | 3526 | 4 | 0 | 0 | 1/0/0 |
| private_batch_blits | private buffers(min=1048576B), blit batching(limit=64) | yes | 3744 | 3630 | 114 | 4 | 0 | 0 | 1/0/0 |

## Timings

| Run | submit_sync mean ms | submit_burst mean ms | copy_roundtrip mean ms | copy_roundtrip GB/s |
|---|---:|---:|---:|---:|
| baseline | 0.244 | 1.108 | 1.775 | 75.6 |
| batch_submits | 0.150 | 1.063 | 1.787 | 75.1 |
| private | 0.176 | 1.089 | 0.453 | 296.4 |
| private_batch_blits | 0.116 | 1.086 | 0.388 | 345.5 |
