...
- Generated: `2026-07-08T01:45:26Z`
...
| batch_submits | submit batching(limit=32) | yes | 132 | 132 | 0 | 1594 | 2178 | 132 | 1/0/0 |
| private | private buffers | yes | 3772 | 2178 | 1594 | 0 | 0 | 0 | 1/0/0 |
| private_batch_blits | private buffers, blit batching(limit=32) | yes | 2248 | 2178 | 70 | 0 | 0 | 0 | 1/0/0 |

## Timings

| Run | submit_sync mean ms | submit_burst mean ms | copy_roundtrip mean ms | copy_roundtrip GB/s |
|---|---:|---:|---:|---:|
| baseline | 0.249 | 1.098 | 1.328 | 75.8 |
| batch_submits | 0.158 | 1.049 | 1.330 | 75.7 |
| private | 0.189 | 1.098 | 0.372 | 270.6 |
| private_batch_blits | 0.121 | 1.092 | 0.313 | 321.9 |
