...
- Generated: `2026-07-08T01:45:22Z`
...
| batch_submits | submit batching(limit=8) | yes | 330 | 330 | 0 | 1594 | 2178 | 330 | 1/0/0 |
| private | private buffers | yes | 3772 | 2178 | 1594 | 0 | 0 | 0 | 1/0/0 |
| private_batch_blits | private buffers, blit batching(limit=8) | yes | 2380 | 2178 | 202 | 0 | 0 | 0 | 1/0/0 |

## Timings

| Run | submit_sync mean ms | submit_burst mean ms | copy_roundtrip mean ms | copy_roundtrip GB/s |
|---|---:|---:|---:|---:|
| baseline | 0.253 | 1.104 | 1.336 | 75.4 |
| batch_submits | 0.164 | 1.031 | 1.392 | 72.3 |
| private | 0.181 | 1.100 | 0.370 | 272.3 |
| private_batch_blits | 0.122 | 1.089 | 0.305 | 329.7 |
