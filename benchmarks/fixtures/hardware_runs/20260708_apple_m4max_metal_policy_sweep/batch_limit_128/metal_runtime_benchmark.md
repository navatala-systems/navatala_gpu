...
- Generated: `2026-07-08T01:45:29Z`
...
| batch_submits | submit batching(limit=128) | yes | 132 | 132 | 0 | 1594 | 2178 | 132 | 1/0/0 |
| private | private buffers | yes | 3772 | 2178 | 1594 | 0 | 0 | 0 | 1/0/0 |
| private_batch_blits | private buffers, blit batching(limit=128) | yes | 2248 | 2178 | 70 | 0 | 0 | 0 | 1/0/0 |

## Timings

| Run | submit_sync mean ms | submit_burst mean ms | copy_roundtrip mean ms | copy_roundtrip GB/s |
|---|---:|---:|---:|---:|
| baseline | 0.263 | 1.099 | 1.341 | 75.1 |
| batch_submits | 0.126 | 1.084 | 1.317 | 76.4 |
| private | 0.189 | 1.102 | 0.377 | 267.3 |
| private_batch_blits | 0.115 | 1.091 | 0.314 | 320.3 |
