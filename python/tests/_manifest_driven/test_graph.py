...
def test_graph_unsupported_backend_fails_before_extension_load():
    ...
    try:
        mod.out_degree(runtime.Tensor(shape=(1,), dtype="UInt32", device=runtime.Device("unsupported")), runtime.Tensor(shape=(1,), dtype="UInt32", device=runtime.Device("unsupported")), 1, "auto")
