...
const char* k_cuda_navatala_cfd_alpha_proc_face_interp = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_mules_proc_face_update = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_mules_proc_face_update_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_pack_owner_values_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_cf_mesh_volume_optimizer_gradient_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_cf_mesh_volume_optimizer_gradient_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_cf_mesh_volume_optimizer_objective_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_cf_mesh_volume_optimizer_objective_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_ddt_source = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_scalar_ldu_coupled_interface_add = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_upwind_weights = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_cast_f32_to_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_cast_f64_to_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_ref_add_ax_native_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_ref_add_b_native_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_cfd_exact_mat_vec_native_f64 = R"kernel(
#include <cuda_runtime.h>
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_alpha_proc_face_interp[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_alpha_proc_face_interp = {
  1,
  "navatala_cfd_alpha_proc_face_interp",
  "cuda",
  "navatala_cfd_alpha_proc_face_interp",
  "kernel:cuda:navatala_cfd_alpha_proc_face_interp",
  "abi-r1:cuda:navatala_cfd_alpha_proc_face_interp",
  "abi-r1:cuda:navatala_cfd_alpha_proc_face_interp",
  5,
  kAbiArgs_cuda_navatala_cfd_alpha_proc_face_interp
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_mules_proc_face_update[] = {
  { "procFaces", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_mules_proc_face_update = {
  1,
  "navatala_cfd_mules_proc_face_update",
  "cuda",
  "navatala_cfd_mules_proc_face_update",
  "kernel:cuda:navatala_cfd_mules_proc_face_update",
  "abi-r1:cuda:navatala_cfd_mules_proc_face_update",
  "abi-r1:cuda:navatala_cfd_mules_proc_face_update",
  9,
  kAbiArgs_cuda_navatala_cfd_mules_proc_face_update
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_mules_proc_face_update_f64[] = {
  { "procFaces", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "counts", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "phiCorr", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "lambda", 3, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_mules_proc_face_update_f64 = {
  1,
  "navatala_cfd_mules_proc_face_update_f64",
  "cuda",
  "navatala_cfd_mules_proc_face_update_f64",
  "kernel:cuda:navatala_cfd_mules_proc_face_update_f64",
  "abi-r1:cuda:navatala_cfd_mules_proc_face_update_f64",
  "abi-r1:cuda:navatala_cfd_mules_proc_face_update_f64",
  9,
  kAbiArgs_cuda_navatala_cfd_mules_proc_face_update_f64
};
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_pack_owner_values_f64[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "owner", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "procFaces", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "counts", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_pack_owner_values_f64 = {
  1,
  "navatala_cfd_pack_owner_values_f64",
  "cuda",
  "navatala_cfd_pack_owner_values_f64",
  "kernel:cuda:navatala_cfd_pack_owner_values_f64",
  "abi-r1:cuda:navatala_cfd_pack_owner_values_f64",
  "abi-r1:cuda:navatala_cfd_pack_owner_values_f64",
  5,
  kAbiArgs_cuda_navatala_cfd_pack_owner_values_f64
};
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_cf_mesh_volume_optimizer_gradient_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_cf_mesh_volume_optimizer_gradient_f32 = {
  1,
  "navatala_cfd_cf_mesh_volume_optimizer_gradient_f32",
  "cuda",
  "navatala_cfd_cf_mesh_volume_optimizer_gradient_f32",
  "kernel:cuda:navatala_cfd_cf_mesh_volume_optimizer_gradient_f32",
  "abi-r1:cuda:navatala_cfd_cf_mesh_volume_optimizer_gradient_f32",
  "abi-r1:cuda:navatala_cfd_cf_mesh_volume_optimizer_gradient_f32",
  12,
  kAbiArgs_cuda_navatala_cfd_cf_mesh_volume_optimizer_gradient_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_cf_mesh_volume_optimizer_gradient_f64[] = {
  { "pointX", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pointY", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pointZ", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "tetConn", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_cf_mesh_volume_optimizer_gradient_f64 = {
  1,
  "navatala_cfd_cf_mesh_volume_optimizer_gradient_f64",
  "cuda",
  "navatala_cfd_cf_mesh_volume_optimizer_gradient_f64",
  "kernel:cuda:navatala_cfd_cf_mesh_volume_optimizer_gradient_f64",
  "abi-r1:cuda:navatala_cfd_cf_mesh_volume_optimizer_gradient_f64",
  "abi-r1:cuda:navatala_cfd_cf_mesh_volume_optimizer_gradient_f64",
  12,
  kAbiArgs_cuda_navatala_cfd_cf_mesh_volume_optimizer_gradient_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f32[] = {
  { "pointX", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pointY", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pointZ", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "tetConn", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f32 = {
  1,
  "navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f32",
  "cuda",
  "navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f32",
  "kernel:cuda:navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f32",
  "abi-r1:cuda:navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f32",
  "abi-r1:cuda:navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f32",
  10,
  kAbiArgs_cuda_navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f64[] = {
  { "pointX", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pointY", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pointZ", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "tetConn", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f64 = {
  1,
  "navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f64",
  "cuda",
  "navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f64",
  "kernel:cuda:navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f64",
  "abi-r1:cuda:navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f64",
  "abi-r1:cuda:navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f64",
  10,
  kAbiArgs_cuda_navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_cf_mesh_volume_optimizer_objective_f32[] = {
  { "pointX", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pointY", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pointZ", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "tetConn", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_cf_mesh_volume_optimizer_objective_f32 = {
  1,
  "navatala_cfd_cf_mesh_volume_optimizer_objective_f32",
  "cuda",
  "navatala_cfd_cf_mesh_volume_optimizer_objective_f32",
  "kernel:cuda:navatala_cfd_cf_mesh_volume_optimizer_objective_f32",
  "abi-r1:cuda:navatala_cfd_cf_mesh_volume_optimizer_objective_f32",
  "abi-r1:cuda:navatala_cfd_cf_mesh_volume_optimizer_objective_f32",
  10,
  kAbiArgs_cuda_navatala_cfd_cf_mesh_volume_optimizer_objective_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_cf_mesh_volume_optimizer_objective_f64[] = {
  { "pointX", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pointY", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pointZ", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "tetConn", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_cf_mesh_volume_optimizer_objective_f64 = {
  1,
  "navatala_cfd_cf_mesh_volume_optimizer_objective_f64",
  "cuda",
  "navatala_cfd_cf_mesh_volume_optimizer_objective_f64",
  "kernel:cuda:navatala_cfd_cf_mesh_volume_optimizer_objective_f64",
  "abi-r1:cuda:navatala_cfd_cf_mesh_volume_optimizer_objective_f64",
  "abi-r1:cuda:navatala_cfd_cf_mesh_volume_optimizer_objective_f64",
  10,
  kAbiArgs_cuda_navatala_cfd_cf_mesh_volume_optimizer_objective_f64
};
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_ddt_source[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_ddt_source = {
  1,
  "navatala_cfd_ddt_source",
  "cuda",
  "navatala_cfd_ddt_source",
  "kernel:cuda:navatala_cfd_ddt_source",
  "abi-r1:cuda:navatala_cfd_ddt_source",
  "abi-r1:cuda:navatala_cfd_ddt_source",
  5,
  kAbiArgs_cuda_navatala_cfd_ddt_source
};
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_scalar_ldu_coupled_interface_add[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_scalar_ldu_coupled_interface_add = {
  1,
  "navatala_cfd_scalar_ldu_coupled_interface_add",
  "cuda",
  "navatala_cfd_scalar_ldu_coupled_interface_add",
  "kernel:cuda:navatala_cfd_scalar_ldu_coupled_interface_add",
  "abi-r1:cuda:navatala_cfd_scalar_ldu_coupled_interface_add",
  "abi-r1:cuda:navatala_cfd_scalar_ldu_coupled_interface_add",
  5,
  kAbiArgs_cuda_navatala_cfd_scalar_ldu_coupled_interface_add
};
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_upwind_weights[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_upwind_weights = {
  1,
  "navatala_cfd_upwind_weights",
  "cuda",
  "navatala_cfd_upwind_weights",
  "kernel:cuda:navatala_cfd_upwind_weights",
  "abi-r1:cuda:navatala_cfd_upwind_weights",
  "abi-r1:cuda:navatala_cfd_upwind_weights",
  3,
  kAbiArgs_cuda_navatala_cfd_upwind_weights
};
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_cast_f32_to_f64[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_cast_f32_to_f64 = {
  1,
  "navatala_cfd_cast_f32_to_f64",
  "cuda",
  "navatala_cfd_cast_f32_to_f64",
  "kernel:cuda:navatala_cfd_cast_f32_to_f64",
  "abi-r1:cuda:navatala_cfd_cast_f32_to_f64",
  "abi-r1:cuda:navatala_cfd_cast_f32_to_f64",
  3,
  kAbiArgs_cuda_navatala_cfd_cast_f32_to_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_cast_f64_to_f32[] = {
  { "src", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "dst", 1, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "counts", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 12, 12, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_cast_f64_to_f32 = {
  1,
  "navatala_cfd_cast_f64_to_f32",
  "cuda",
  "navatala_cfd_cast_f64_to_f32",
  "kernel:cuda:navatala_cfd_cast_f64_to_f32",
  "abi-r1:cuda:navatala_cfd_cast_f64_to_f32",
  "abi-r1:cuda:navatala_cfd_cast_f64_to_f32",
  3,
  kAbiArgs_cuda_navatala_cfd_cast_f64_to_f32
};
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_ref_add_ax_native_f64[] = {
  { "diag", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "x", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "outAx", 2, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "refCell", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_ref_add_ax_native_f64 = {
  1,
  "navatala_cfd_ref_add_ax_native_f64",
  "cuda",
  "navatala_cfd_ref_add_ax_native_f64",
  "kernel:cuda:navatala_cfd_ref_add_ax_native_f64",
  "abi-r1:cuda:navatala_cfd_ref_add_ax_native_f64",
  "abi-r1:cuda:navatala_cfd_ref_add_ax_native_f64",
  4,
  kAbiArgs_cuda_navatala_cfd_ref_add_ax_native_f64
};
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_ref_add_b_native_f64[] = {
  { "diag", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "b", 1, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "refCell", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "refVal", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 8, 8, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_ref_add_b_native_f64 = {
  1,
  "navatala_cfd_ref_add_b_native_f64",
  "cuda",
  "navatala_cfd_ref_add_b_native_f64",
  "kernel:cuda:navatala_cfd_ref_add_b_native_f64",
  "abi-r1:cuda:navatala_cfd_ref_add_b_native_f64",
  "abi-r1:cuda:navatala_cfd_ref_add_b_native_f64",
  4,
  kAbiArgs_cuda_navatala_cfd_ref_add_b_native_f64
};
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_cfd_exact_mat_vec_native_f64[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "owner", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "neighbour", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "offsets", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_cfd_exact_mat_vec_native_f64 = {
  1,
  "navatala_cfd_exact_mat_vec_native_f64",
  "cuda",
  "navatala_cfd_exact_mat_vec_native_f64",
  "kernel:cuda:navatala_cfd_exact_mat_vec_native_f64",
  "abi-r1:cuda:navatala_cfd_exact_mat_vec_native_f64",
  "abi-r1:cuda:navatala_cfd_exact_mat_vec_native_f64",
  11,
  kAbiArgs_cuda_navatala_cfd_exact_mat_vec_native_f64
};
...
bool tryGetKernelAbiManifest_cuda_cfd(const std::string& backend, const std::string& kernelName, const KernelAbiManifestInfo*& out) {
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_alpha_proc_face_interp") {
    out = &kAbiManifest_cuda_navatala_cfd_alpha_proc_face_interp;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_mules_proc_face_update") {
    out = &kAbiManifest_cuda_navatala_cfd_mules_proc_face_update;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_mules_proc_face_update_f64") {
    out = &kAbiManifest_cuda_navatala_cfd_mules_proc_face_update_f64;
    return true;
  }
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_pack_owner_values_f64") {
    out = &kAbiManifest_cuda_navatala_cfd_pack_owner_values_f64;
    return true;
  }
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_cf_mesh_volume_optimizer_gradient_f32") {
    out = &kAbiManifest_cuda_navatala_cfd_cf_mesh_volume_optimizer_gradient_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_cf_mesh_volume_optimizer_gradient_f64") {
    out = &kAbiManifest_cuda_navatala_cfd_cf_mesh_volume_optimizer_gradient_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f32") {
    out = &kAbiManifest_cuda_navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f64") {
    out = &kAbiManifest_cuda_navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_cf_mesh_volume_optimizer_objective_f32") {
    out = &kAbiManifest_cuda_navatala_cfd_cf_mesh_volume_optimizer_objective_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_cf_mesh_volume_optimizer_objective_f64") {
    out = &kAbiManifest_cuda_navatala_cfd_cf_mesh_volume_optimizer_objective_f64;
    return true;
  }
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_ddt_source") {
    out = &kAbiManifest_cuda_navatala_cfd_ddt_source;
    return true;
  }
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_scalar_ldu_coupled_interface_add") {
    out = &kAbiManifest_cuda_navatala_cfd_scalar_ldu_coupled_interface_add;
    return true;
  }
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_upwind_weights") {
    out = &kAbiManifest_cuda_navatala_cfd_upwind_weights;
    return true;
  }
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_cast_f32_to_f64") {
    out = &kAbiManifest_cuda_navatala_cfd_cast_f32_to_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_cast_f64_to_f32") {
    out = &kAbiManifest_cuda_navatala_cfd_cast_f64_to_f32;
    return true;
  }
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_ref_add_ax_native_f64") {
    out = &kAbiManifest_cuda_navatala_cfd_ref_add_ax_native_f64;
    return true;
  }
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_ref_add_b_native_f64") {
    out = &kAbiManifest_cuda_navatala_cfd_ref_add_b_native_f64;
    return true;
  }
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_exact_mat_vec_native_f64") {
    out = &kAbiManifest_cuda_navatala_cfd_exact_mat_vec_native_f64;
    return true;
  }
...
bool tryGetKernelSource_cuda_cfd(const std::string& backend, const std::string& kernelName, GpuRuntime::ProgramSource& out) {
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_alpha_proc_face_interp") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_alpha_proc_face_interp);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_mules_proc_face_update") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_mules_proc_face_update);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_mules_proc_face_update_f64") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_mules_proc_face_update_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_pack_owner_values") {
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_pack_owner_values_f64") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_pack_owner_values_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_scatter_values_and_mask") {
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_cf_mesh_volume_optimizer_gradient_f32") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_cf_mesh_volume_optimizer_gradient_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_cf_mesh_volume_optimizer_gradient_f64") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_cf_mesh_volume_optimizer_gradient_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f32") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f64") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_cf_mesh_volume_optimizer_k_prepass_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_cf_mesh_volume_optimizer_objective_f32") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_cf_mesh_volume_optimizer_objective_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_cf_mesh_volume_optimizer_objective_f64") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_cf_mesh_volume_optimizer_objective_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_add_vol_vector") {
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_ddt_source") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_ddt_source);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_div_upwind_coeffs") {
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_scalar_ldu_coupled_interface_add") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_scalar_ldu_coupled_interface_add);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_scalar_ldu_mat_vec") {
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_upwind_weights") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_upwind_weights);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_gamg_axpy_in_place") {
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_cast_f32_to_f64") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_cast_f32_to_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_cast_f64_to_f32") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_cast_f64_to_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_coeff_to_cf_in_place") {
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_ref_add_ax_native_f64") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_ref_add_ax_native_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_ref_add_b") {
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_ref_add_b_native_f64") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_ref_add_b_native_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_rhs_sub") {
  ...
  if (backend == "cuda" && kernelName == "navatala_cfd_exact_mat_vec_native_f64") {
    ...
    std::string_view sv(k_cuda_navatala_cfd_exact_mat_vec_native_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_cfd_face_flux_boundary") {
