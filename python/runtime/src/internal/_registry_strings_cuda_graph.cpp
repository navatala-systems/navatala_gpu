...
// Kernel registry partition for the `cuda_graph` bucket. Compiles
...
const char* k_cuda_navatala_graph_pack_f32 = R"kernel(
...
const char* k_cuda_navatala_graph_pack_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_pack_i32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_pack_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_unpack_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_unpack_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_unpack_i32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_unpack_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_pack_f32x3 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_unpack_f32x3 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_pack_f32x6 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_unpack_f32x6 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_pack_f32x9 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_unpack_f32x9 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_pack_f64x3 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_unpack_f64x3 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_pack_f64x6 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_unpack_f64x6 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_pack_f64x9 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_unpack_f64x9 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_degree_out_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_degree_in_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_spmv_weighted_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_spmv_weighted_subgroup_f32 = R"kernel(
#include <cuda_runtime.h>
template <typename T>
...
const char* k_cuda_navatala_graph_spmv_unweighted_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_spmv_unweighted_subgroup_f32 = R"kernel(
#include <cuda_runtime.h>
template <typename T>
__device__ inline T gpu_warp_reduce_sum(T v) {
  unsigned mask = 0xffffffffu;
...
const char* k_cuda_navatala_graph_axpy2_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_scale_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_scale_add_bias_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_l1norm_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_recip_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_l1_diff_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_count_diff_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_copy_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_copy_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_relax_vertex_pull_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_label_propagate_edges_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_symmetrize_reverse_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_apply_renumber_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_peel_below_threshold_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_pair_intersection_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_jaccard_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_overlap_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_sorensen_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_cosine_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_uniform_random_walk_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_out_degree_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_in_degree_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_rbf_affinity_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_rbf_affinity_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_compute_degree_matrix_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_compute_degree_matrix_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_compute_laplacian_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_compute_laplacian_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_normalized_laplacian_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_normalized_laplacian_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_normalize_eigenvector_rows_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_normalize_eigenvector_rows_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_spectral_embedding_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_spectral_embedding_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_rmat_generator_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_rmat_generator_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_erdos_renyi_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_erdos_renyi_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_barabasi_albert_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_barabasi_albert_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_compute_modularity_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_compute_modularity_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_modularity_matrix_vec_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_modularity_matrix_vec_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_construct_indicator_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_construct_indicator_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_compute_edge_cut_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_compute_edge_cut_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_compute_partition_cost_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_compute_partition_cost_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_analyze_partition_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_analyze_partition_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_transform_eigen_matrix_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_transform_eigen_matrix_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_compute_cluster_sizes_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_compute_cluster_sizes_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_laplacian_from_adjacency_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_graph_laplacian_from_adjacency_f64 = R"kernel(
#include <cuda_runtime.h>
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_pack_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_pack_f32 = {
  1,
  "navatala_graph_pack_f32",
  "cuda",
  "navatala_graph_pack_f32",
  "kernel:cuda:navatala_graph_pack_f32",
  "abi-r1:cuda:navatala_graph_pack_f32",
  "abi-r1:cuda:navatala_graph_pack_f32",
  4,
  kAbiArgs_cuda_navatala_graph_pack_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_pack_f64[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dst", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_pack_f64 = {
  1,
  "navatala_graph_pack_f64",
  "cuda",
  "navatala_graph_pack_f64",
  "kernel:cuda:navatala_graph_pack_f64",
  "abi-r1:cuda:navatala_graph_pack_f64",
  "abi-r1:cuda:navatala_graph_pack_f64",
  4,
  kAbiArgs_cuda_navatala_graph_pack_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_pack_i32[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dst", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_pack_i32 = {
  1,
  "navatala_graph_pack_i32",
  "cuda",
  "navatala_graph_pack_i32",
  "kernel:cuda:navatala_graph_pack_i32",
  "abi-r1:cuda:navatala_graph_pack_i32",
  "abi-r1:cuda:navatala_graph_pack_i32",
  4,
  kAbiArgs_cuda_navatala_graph_pack_i32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_pack_u32[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dst", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_pack_u32 = {
  1,
  "navatala_graph_pack_u32",
  "cuda",
  "navatala_graph_pack_u32",
  "kernel:cuda:navatala_graph_pack_u32",
  "abi-r1:cuda:navatala_graph_pack_u32",
  "abi-r1:cuda:navatala_graph_pack_u32",
  4,
  kAbiArgs_cuda_navatala_graph_pack_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_unpack_f32[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dst", 3, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_unpack_f32 = {
  1,
  "navatala_graph_unpack_f32",
  "cuda",
  "navatala_graph_unpack_f32",
  "kernel:cuda:navatala_graph_unpack_f32",
  "abi-r1:cuda:navatala_graph_unpack_f32",
  "abi-r1:cuda:navatala_graph_unpack_f32",
  4,
  kAbiArgs_cuda_navatala_graph_unpack_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_unpack_f64[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dst", 3, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_unpack_f64 = {
  1,
  "navatala_graph_unpack_f64",
  "cuda",
  "navatala_graph_unpack_f64",
  "kernel:cuda:navatala_graph_unpack_f64",
  "abi-r1:cuda:navatala_graph_unpack_f64",
  "abi-r1:cuda:navatala_graph_unpack_f64",
  4,
  kAbiArgs_cuda_navatala_graph_unpack_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_unpack_i32[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dst", 3, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_unpack_i32 = {
  1,
  "navatala_graph_unpack_i32",
  "cuda",
  "navatala_graph_unpack_i32",
  "kernel:cuda:navatala_graph_unpack_i32",
  "abi-r1:cuda:navatala_graph_unpack_i32",
  "abi-r1:cuda:navatala_graph_unpack_i32",
  4,
  kAbiArgs_cuda_navatala_graph_unpack_i32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_unpack_u32[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dst", 3, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_unpack_u32 = {
  1,
  "navatala_graph_unpack_u32",
  "cuda",
  "navatala_graph_unpack_u32",
  "kernel:cuda:navatala_graph_unpack_u32",
  "abi-r1:cuda:navatala_graph_unpack_u32",
  "abi-r1:cuda:navatala_graph_unpack_u32",
  4,
  kAbiArgs_cuda_navatala_graph_unpack_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_pack_f32x3[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_pack_f32x3 = {
  1,
  "navatala_graph_pack_f32x3",
  "cuda",
  "navatala_graph_pack_f32x3",
  "kernel:cuda:navatala_graph_pack_f32x3",
  "abi-r1:cuda:navatala_graph_pack_f32x3",
  "abi-r1:cuda:navatala_graph_pack_f32x3",
  5,
  kAbiArgs_cuda_navatala_graph_pack_f32x3
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_unpack_f32x3[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_unpack_f32x3 = {
  1,
  "navatala_graph_unpack_f32x3",
  "cuda",
  "navatala_graph_unpack_f32x3",
  "kernel:cuda:navatala_graph_unpack_f32x3",
  "abi-r1:cuda:navatala_graph_unpack_f32x3",
  "abi-r1:cuda:navatala_graph_unpack_f32x3",
  5,
  kAbiArgs_cuda_navatala_graph_unpack_f32x3
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_pack_f32x6[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_pack_f32x6 = {
  1,
  "navatala_graph_pack_f32x6",
  "cuda",
  "navatala_graph_pack_f32x6",
  "kernel:cuda:navatala_graph_pack_f32x6",
  "abi-r1:cuda:navatala_graph_pack_f32x6",
  "abi-r1:cuda:navatala_graph_pack_f32x6",
  5,
  kAbiArgs_cuda_navatala_graph_pack_f32x6
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_unpack_f32x6[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_unpack_f32x6 = {
  1,
  "navatala_graph_unpack_f32x6",
  "cuda",
  "navatala_graph_unpack_f32x6",
  "kernel:cuda:navatala_graph_unpack_f32x6",
  "abi-r1:cuda:navatala_graph_unpack_f32x6",
  "abi-r1:cuda:navatala_graph_unpack_f32x6",
  5,
  kAbiArgs_cuda_navatala_graph_unpack_f32x6
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_pack_f32x9[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_pack_f32x9 = {
  1,
  "navatala_graph_pack_f32x9",
  "cuda",
  "navatala_graph_pack_f32x9",
  "kernel:cuda:navatala_graph_pack_f32x9",
  "abi-r1:cuda:navatala_graph_pack_f32x9",
  "abi-r1:cuda:navatala_graph_pack_f32x9",
  5,
  kAbiArgs_cuda_navatala_graph_pack_f32x9
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_unpack_f32x9[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_unpack_f32x9 = {
  1,
  "navatala_graph_unpack_f32x9",
  "cuda",
  "navatala_graph_unpack_f32x9",
  "kernel:cuda:navatala_graph_unpack_f32x9",
  "abi-r1:cuda:navatala_graph_unpack_f32x9",
  "abi-r1:cuda:navatala_graph_unpack_f32x9",
  5,
  kAbiArgs_cuda_navatala_graph_unpack_f32x9
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_pack_f64x3[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_pack_f64x3 = {
  1,
  "navatala_graph_pack_f64x3",
  "cuda",
  "navatala_graph_pack_f64x3",
  "kernel:cuda:navatala_graph_pack_f64x3",
  "abi-r1:cuda:navatala_graph_pack_f64x3",
  "abi-r1:cuda:navatala_graph_pack_f64x3",
  5,
  kAbiArgs_cuda_navatala_graph_pack_f64x3
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_unpack_f64x3[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_unpack_f64x3 = {
  1,
  "navatala_graph_unpack_f64x3",
  "cuda",
  "navatala_graph_unpack_f64x3",
  "kernel:cuda:navatala_graph_unpack_f64x3",
  "abi-r1:cuda:navatala_graph_unpack_f64x3",
  "abi-r1:cuda:navatala_graph_unpack_f64x3",
  5,
  kAbiArgs_cuda_navatala_graph_unpack_f64x3
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_pack_f64x6[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_pack_f64x6 = {
  1,
  "navatala_graph_pack_f64x6",
  "cuda",
  "navatala_graph_pack_f64x6",
  "kernel:cuda:navatala_graph_pack_f64x6",
  "abi-r1:cuda:navatala_graph_pack_f64x6",
  "abi-r1:cuda:navatala_graph_pack_f64x6",
  5,
  kAbiArgs_cuda_navatala_graph_pack_f64x6
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_unpack_f64x6[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_unpack_f64x6 = {
  1,
  "navatala_graph_unpack_f64x6",
  "cuda",
  "navatala_graph_unpack_f64x6",
  "kernel:cuda:navatala_graph_unpack_f64x6",
  "abi-r1:cuda:navatala_graph_unpack_f64x6",
  "abi-r1:cuda:navatala_graph_unpack_f64x6",
  5,
  kAbiArgs_cuda_navatala_graph_unpack_f64x6
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_pack_f64x9[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_pack_f64x9 = {
  1,
  "navatala_graph_pack_f64x9",
  "cuda",
  "navatala_graph_pack_f64x9",
  "kernel:cuda:navatala_graph_pack_f64x9",
  "abi-r1:cuda:navatala_graph_pack_f64x9",
  "abi-r1:cuda:navatala_graph_pack_f64x9",
  5,
  kAbiArgs_cuda_navatala_graph_pack_f64x9
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_unpack_f64x9[] = {
  { "indices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "src", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_unpack_f64x9 = {
  1,
  "navatala_graph_unpack_f64x9",
  "cuda",
  "navatala_graph_unpack_f64x9",
  "kernel:cuda:navatala_graph_unpack_f64x9",
  "abi-r1:cuda:navatala_graph_unpack_f64x9",
  "abi-r1:cuda:navatala_graph_unpack_f64x9",
  5,
  kAbiArgs_cuda_navatala_graph_unpack_f64x9
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_degree_out_u32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_degree_out_u32 = {
  1,
  "navatala_graph_degree_out_u32",
  "cuda",
  "navatala_graph_degree_out_u32",
  "kernel:cuda:navatala_graph_degree_out_u32",
  "abi-r1:cuda:navatala_graph_degree_out_u32",
  "abi-r1:cuda:navatala_graph_degree_out_u32",
  3,
  kAbiArgs_cuda_navatala_graph_degree_out_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_degree_in_u32[] = {
  { "offsets", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "numVertices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "degrees", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_degree_in_u32 = {
  1,
  "navatala_graph_degree_in_u32",
  "cuda",
  "navatala_graph_degree_in_u32",
  "kernel:cuda:navatala_graph_degree_in_u32",
  "abi-r1:cuda:navatala_graph_degree_in_u32",
  "abi-r1:cuda:navatala_graph_degree_in_u32",
  3,
  kAbiArgs_cuda_navatala_graph_degree_in_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_spmv_weighted_f32[] = {
  { "offsets", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_spmv_weighted_f32 = {
  1,
  "navatala_graph_spmv_weighted_f32",
  "cuda",
  "navatala_graph_spmv_weighted_f32",
  "kernel:cuda:navatala_graph_spmv_weighted_f32",
  "abi-r1:cuda:navatala_graph_spmv_weighted_f32",
  "abi-r1:cuda:navatala_graph_spmv_weighted_f32",
  6,
  kAbiArgs_cuda_navatala_graph_spmv_weighted_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_spmv_weighted_subgroup_f32[] = {
  { "offsets", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "indices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "weights", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "x", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_spmv_weighted_subgroup_f32 = {
  1,
  "navatala_graph_spmv_weighted_subgroup_f32",
  "cuda",
  "navatala_graph_spmv_weighted_subgroup_f32",
  "kernel:cuda:navatala_graph_spmv_weighted_subgroup_f32",
  "abi-r1:cuda:navatala_graph_spmv_weighted_subgroup_f32",
  "abi-r1:cuda:navatala_graph_spmv_weighted_subgroup_f32",
  6,
  kAbiArgs_cuda_navatala_graph_spmv_weighted_subgroup_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_spmv_unweighted_f32[] = {
  { "offsets", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "indices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_spmv_unweighted_f32 = {
  1,
  "navatala_graph_spmv_unweighted_f32",
  "cuda",
  "navatala_graph_spmv_unweighted_f32",
  "kernel:cuda:navatala_graph_spmv_unweighted_f32",
  "abi-r1:cuda:navatala_graph_spmv_unweighted_f32",
  "abi-r1:cuda:navatala_graph_spmv_unweighted_f32",
  5,
  kAbiArgs_cuda_navatala_graph_spmv_unweighted_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_spmv_unweighted_subgroup_f32[] = {
  { "offsets", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "indices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "x", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "numVertices", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_spmv_unweighted_subgroup_f32 = {
  1,
  "navatala_graph_spmv_unweighted_subgroup_f32",
  "cuda",
  "navatala_graph_spmv_unweighted_subgroup_f32",
  "kernel:cuda:navatala_graph_spmv_unweighted_subgroup_f32",
  "abi-r1:cuda:navatala_graph_spmv_unweighted_subgroup_f32",
  "abi-r1:cuda:navatala_graph_spmv_unweighted_subgroup_f32",
  5,
  kAbiArgs_cuda_navatala_graph_spmv_unweighted_subgroup_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_axpy2_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_axpy2_f32 = {
  1,
  "navatala_graph_axpy2_f32",
  "cuda",
  "navatala_graph_axpy2_f32",
  "kernel:cuda:navatala_graph_axpy2_f32",
  "abi-r1:cuda:navatala_graph_axpy2_f32",
  "abi-r1:cuda:navatala_graph_axpy2_f32",
  6,
  kAbiArgs_cuda_navatala_graph_axpy2_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_scale_f32[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_scale_f32 = {
  1,
  "navatala_graph_scale_f32",
  "cuda",
  "navatala_graph_scale_f32",
  "kernel:cuda:navatala_graph_scale_f32",
  "abi-r1:cuda:navatala_graph_scale_f32",
  "abi-r1:cuda:navatala_graph_scale_f32",
  4,
  kAbiArgs_cuda_navatala_graph_scale_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_scale_add_bias_f32[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "alpha", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_scale_add_bias_f32 = {
  1,
  "navatala_graph_scale_add_bias_f32",
  "cuda",
  "navatala_graph_scale_add_bias_f32",
  "kernel:cuda:navatala_graph_scale_add_bias_f32",
  "abi-r1:cuda:navatala_graph_scale_add_bias_f32",
  "abi-r1:cuda:navatala_graph_scale_add_bias_f32",
  5,
  kAbiArgs_cuda_navatala_graph_scale_add_bias_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_l1norm_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_l1norm_f32 = {
  1,
  "navatala_graph_l1norm_f32",
  "cuda",
  "navatala_graph_l1norm_f32",
  "kernel:cuda:navatala_graph_l1norm_f32",
  "abi-r1:cuda:navatala_graph_l1norm_f32",
  "abi-r1:cuda:navatala_graph_l1norm_f32",
  3,
  kAbiArgs_cuda_navatala_graph_l1norm_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_recip_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_recip_f32 = {
  1,
  "navatala_graph_recip_f32",
  "cuda",
  "navatala_graph_recip_f32",
  "kernel:cuda:navatala_graph_recip_f32",
  "abi-r1:cuda:navatala_graph_recip_f32",
  "abi-r1:cuda:navatala_graph_recip_f32",
  2,
  kAbiArgs_cuda_navatala_graph_recip_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_l1_diff_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_l1_diff_f32 = {
  1,
  "navatala_graph_l1_diff_f32",
  "cuda",
  "navatala_graph_l1_diff_f32",
  "kernel:cuda:navatala_graph_l1_diff_f32",
  "abi-r1:cuda:navatala_graph_l1_diff_f32",
  "abi-r1:cuda:navatala_graph_l1_diff_f32",
  4,
  kAbiArgs_cuda_navatala_graph_l1_diff_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_count_diff_u32[] = {
  { "a", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "b", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "result", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_count_diff_u32 = {
  1,
  "navatala_graph_count_diff_u32",
  "cuda",
  "navatala_graph_count_diff_u32",
  "kernel:cuda:navatala_graph_count_diff_u32",
  "abi-r1:cuda:navatala_graph_count_diff_u32",
  "abi-r1:cuda:navatala_graph_count_diff_u32",
  4,
  kAbiArgs_cuda_navatala_graph_count_diff_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_copy_f32[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "y", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_copy_f32 = {
  1,
  "navatala_graph_copy_f32",
  "cuda",
  "navatala_graph_copy_f32",
  "kernel:cuda:navatala_graph_copy_f32",
  "abi-r1:cuda:navatala_graph_copy_f32",
  "abi-r1:cuda:navatala_graph_copy_f32",
  3,
  kAbiArgs_cuda_navatala_graph_copy_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_copy_u32[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "y", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_copy_u32 = {
  1,
  "navatala_graph_copy_u32",
  "cuda",
  "navatala_graph_copy_u32",
  "kernel:cuda:navatala_graph_copy_u32",
  "abi-r1:cuda:navatala_graph_copy_u32",
  "abi-r1:cuda:navatala_graph_copy_u32",
  3,
  kAbiArgs_cuda_navatala_graph_copy_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_relax_vertex_pull_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_relax_vertex_pull_f32 = {
  1,
  "navatala_graph_relax_vertex_pull_f32",
  "cuda",
  "navatala_graph_relax_vertex_pull_f32",
  "kernel:cuda:navatala_graph_relax_vertex_pull_f32",
  "abi-r1:cuda:navatala_graph_relax_vertex_pull_f32",
  "abi-r1:cuda:navatala_graph_relax_vertex_pull_f32",
  7,
  kAbiArgs_cuda_navatala_graph_relax_vertex_pull_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_label_propagate_edges_u32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_label_propagate_edges_u32 = {
  1,
  "navatala_graph_label_propagate_edges_u32",
  "cuda",
  "navatala_graph_label_propagate_edges_u32",
  "kernel:cuda:navatala_graph_label_propagate_edges_u32",
  "abi-r1:cuda:navatala_graph_label_propagate_edges_u32",
  "abi-r1:cuda:navatala_graph_label_propagate_edges_u32",
  5,
  kAbiArgs_cuda_navatala_graph_label_propagate_edges_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_symmetrize_reverse_u32[] = {
  { "srcs", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "dsts", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_symmetrize_reverse_u32 = {
  1,
  "navatala_graph_symmetrize_reverse_u32",
  "cuda",
  "navatala_graph_symmetrize_reverse_u32",
  "kernel:cuda:navatala_graph_symmetrize_reverse_u32",
  "abi-r1:cuda:navatala_graph_symmetrize_reverse_u32",
  "abi-r1:cuda:navatala_graph_symmetrize_reverse_u32",
  5,
  kAbiArgs_cuda_navatala_graph_symmetrize_reverse_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_apply_renumber_u32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_apply_renumber_u32 = {
  1,
  "navatala_graph_apply_renumber_u32",
  "cuda",
  "navatala_graph_apply_renumber_u32",
  "kernel:cuda:navatala_graph_apply_renumber_u32",
  "abi-r1:cuda:navatala_graph_apply_renumber_u32",
  "abi-r1:cuda:navatala_graph_apply_renumber_u32",
  3,
  kAbiArgs_cuda_navatala_graph_apply_renumber_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_peel_below_threshold_u32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_peel_below_threshold_u32 = {
  1,
  "navatala_graph_peel_below_threshold_u32",
  "cuda",
  "navatala_graph_peel_below_threshold_u32",
  "kernel:cuda:navatala_graph_peel_below_threshold_u32",
  "abi-r1:cuda:navatala_graph_peel_below_threshold_u32",
  "abi-r1:cuda:navatala_graph_peel_below_threshold_u32",
  5,
  kAbiArgs_cuda_navatala_graph_peel_below_threshold_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_pair_intersection_u32[] = {
  { "offsets", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "indices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_pair_intersection_u32 = {
  1,
  "navatala_graph_pair_intersection_u32",
  "cuda",
  "navatala_graph_pair_intersection_u32",
  "kernel:cuda:navatala_graph_pair_intersection_u32",
  "abi-r1:cuda:navatala_graph_pair_intersection_u32",
  "abi-r1:cuda:navatala_graph_pair_intersection_u32",
  6,
  kAbiArgs_cuda_navatala_graph_pair_intersection_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_jaccard_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_jaccard_f32 = {
  1,
  "navatala_graph_jaccard_f32",
  "cuda",
  "navatala_graph_jaccard_f32",
  "kernel:cuda:navatala_graph_jaccard_f32",
  "abi-r1:cuda:navatala_graph_jaccard_f32",
  "abi-r1:cuda:navatala_graph_jaccard_f32",
  6,
  kAbiArgs_cuda_navatala_graph_jaccard_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_overlap_f32[] = {
  { "inter", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "degrees", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pairsA", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pairsB", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_overlap_f32 = {
  1,
  "navatala_graph_overlap_f32",
  "cuda",
  "navatala_graph_overlap_f32",
  "kernel:cuda:navatala_graph_overlap_f32",
  "abi-r1:cuda:navatala_graph_overlap_f32",
  "abi-r1:cuda:navatala_graph_overlap_f32",
  6,
  kAbiArgs_cuda_navatala_graph_overlap_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_sorensen_f32[] = {
  { "inter", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "degrees", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pairsA", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pairsB", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_sorensen_f32 = {
  1,
  "navatala_graph_sorensen_f32",
  "cuda",
  "navatala_graph_sorensen_f32",
  "kernel:cuda:navatala_graph_sorensen_f32",
  "abi-r1:cuda:navatala_graph_sorensen_f32",
  "abi-r1:cuda:navatala_graph_sorensen_f32",
  6,
  kAbiArgs_cuda_navatala_graph_sorensen_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_cosine_f32[] = {
  { "inter", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "degrees", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pairsA", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "pairsB", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_cosine_f32 = {
  1,
  "navatala_graph_cosine_f32",
  "cuda",
  "navatala_graph_cosine_f32",
  "kernel:cuda:navatala_graph_cosine_f32",
  "abi-r1:cuda:navatala_graph_cosine_f32",
  "abi-r1:cuda:navatala_graph_cosine_f32",
  6,
  kAbiArgs_cuda_navatala_graph_cosine_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_uniform_random_walk_u32[] = {
  { "offsets", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "indices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_uniform_random_walk_u32 = {
  1,
  "navatala_graph_uniform_random_walk_u32",
  "cuda",
  "navatala_graph_uniform_random_walk_u32",
  "kernel:cuda:navatala_graph_uniform_random_walk_u32",
  "abi-r1:cuda:navatala_graph_uniform_random_walk_u32",
  "abi-r1:cuda:navatala_graph_uniform_random_walk_u32",
  7,
  kAbiArgs_cuda_navatala_graph_uniform_random_walk_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_out_degree_u32[] = {
  { "offsets", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "numVertices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "degrees", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_out_degree_u32 = {
  1,
  "navatala_graph_out_degree_u32",
  "cuda",
  "navatala_graph_out_degree_u32",
  "kernel:cuda:navatala_graph_out_degree_u32",
  "abi-r1:cuda:navatala_graph_out_degree_u32",
  "abi-r1:cuda:navatala_graph_out_degree_u32",
  3,
  kAbiArgs_cuda_navatala_graph_out_degree_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_in_degree_u32[] = {
  { "offsets", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "numVertices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "degrees", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_in_degree_u32 = {
  1,
  "navatala_graph_in_degree_u32",
  "cuda",
  "navatala_graph_in_degree_u32",
  "kernel:cuda:navatala_graph_in_degree_u32",
  "abi-r1:cuda:navatala_graph_in_degree_u32",
  "abi-r1:cuda:navatala_graph_in_degree_u32",
  3,
  kAbiArgs_cuda_navatala_graph_in_degree_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_rbf_affinity_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_rbf_affinity_f32 = {
  1,
  "navatala_graph_rbf_affinity_f32",
  "cuda",
  "navatala_graph_rbf_affinity_f32",
  "kernel:cuda:navatala_graph_rbf_affinity_f32",
  "abi-r1:cuda:navatala_graph_rbf_affinity_f32",
  "abi-r1:cuda:navatala_graph_rbf_affinity_f32",
  5,
  kAbiArgs_cuda_navatala_graph_rbf_affinity_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_rbf_affinity_f64[] = {
  { "data", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_rbf_affinity_f64 = {
  1,
  "navatala_graph_rbf_affinity_f64",
  "cuda",
  "navatala_graph_rbf_affinity_f64",
  "kernel:cuda:navatala_graph_rbf_affinity_f64",
  "abi-r1:cuda:navatala_graph_rbf_affinity_f64",
  "abi-r1:cuda:navatala_graph_rbf_affinity_f64",
  5,
  kAbiArgs_cuda_navatala_graph_rbf_affinity_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_compute_degree_matrix_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_compute_degree_matrix_f32 = {
  1,
  "navatala_graph_compute_degree_matrix_f32",
  "cuda",
  "navatala_graph_compute_degree_matrix_f32",
  "kernel:cuda:navatala_graph_compute_degree_matrix_f32",
  "abi-r1:cuda:navatala_graph_compute_degree_matrix_f32",
  "abi-r1:cuda:navatala_graph_compute_degree_matrix_f32",
  3,
  kAbiArgs_cuda_navatala_graph_compute_degree_matrix_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_compute_degree_matrix_f64[] = {
  { "W", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "D", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_compute_degree_matrix_f64 = {
  1,
  "navatala_graph_compute_degree_matrix_f64",
  "cuda",
  "navatala_graph_compute_degree_matrix_f64",
  "kernel:cuda:navatala_graph_compute_degree_matrix_f64",
  "abi-r1:cuda:navatala_graph_compute_degree_matrix_f64",
  "abi-r1:cuda:navatala_graph_compute_degree_matrix_f64",
  3,
  kAbiArgs_cuda_navatala_graph_compute_degree_matrix_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_compute_laplacian_f32[] = {
  { "W", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_compute_laplacian_f32 = {
  1,
  "navatala_graph_compute_laplacian_f32",
  "cuda",
  "navatala_graph_compute_laplacian_f32",
  "kernel:cuda:navatala_graph_compute_laplacian_f32",
  "abi-r1:cuda:navatala_graph_compute_laplacian_f32",
  "abi-r1:cuda:navatala_graph_compute_laplacian_f32",
  4,
  kAbiArgs_cuda_navatala_graph_compute_laplacian_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_compute_laplacian_f64[] = {
  { "W", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "D", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "L", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_compute_laplacian_f64 = {
  1,
  "navatala_graph_compute_laplacian_f64",
  "cuda",
  "navatala_graph_compute_laplacian_f64",
  "kernel:cuda:navatala_graph_compute_laplacian_f64",
  "abi-r1:cuda:navatala_graph_compute_laplacian_f64",
  "abi-r1:cuda:navatala_graph_compute_laplacian_f64",
  4,
  kAbiArgs_cuda_navatala_graph_compute_laplacian_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_normalized_laplacian_f32[] = {
  { "W", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "D", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "L_sym", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_normalized_laplacian_f32 = {
  1,
  "navatala_graph_normalized_laplacian_f32",
  "cuda",
  "navatala_graph_normalized_laplacian_f32",
  "kernel:cuda:navatala_graph_normalized_laplacian_f32",
  "abi-r1:cuda:navatala_graph_normalized_laplacian_f32",
  "abi-r1:cuda:navatala_graph_normalized_laplacian_f32",
  4,
  kAbiArgs_cuda_navatala_graph_normalized_laplacian_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_normalized_laplacian_f64[] = {
  { "W", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "D", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "L_sym", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_normalized_laplacian_f64 = {
  1,
  "navatala_graph_normalized_laplacian_f64",
  "cuda",
  "navatala_graph_normalized_laplacian_f64",
  "kernel:cuda:navatala_graph_normalized_laplacian_f64",
  "abi-r1:cuda:navatala_graph_normalized_laplacian_f64",
  "abi-r1:cuda:navatala_graph_normalized_laplacian_f64",
  4,
  kAbiArgs_cuda_navatala_graph_normalized_laplacian_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_normalize_eigenvector_rows_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_normalize_eigenvector_rows_f32 = {
  1,
  "navatala_graph_normalize_eigenvector_rows_f32",
  "cuda",
  "navatala_graph_normalize_eigenvector_rows_f32",
  "kernel:cuda:navatala_graph_normalize_eigenvector_rows_f32",
  "abi-r1:cuda:navatala_graph_normalize_eigenvector_rows_f32",
  "abi-r1:cuda:navatala_graph_normalize_eigenvector_rows_f32",
  4,
  kAbiArgs_cuda_navatala_graph_normalize_eigenvector_rows_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_normalize_eigenvector_rows_f64[] = {
  { "V", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "k", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "V_norm", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_normalize_eigenvector_rows_f64 = {
  1,
  "navatala_graph_normalize_eigenvector_rows_f64",
  "cuda",
  "navatala_graph_normalize_eigenvector_rows_f64",
  "kernel:cuda:navatala_graph_normalize_eigenvector_rows_f64",
  "abi-r1:cuda:navatala_graph_normalize_eigenvector_rows_f64",
  "abi-r1:cuda:navatala_graph_normalize_eigenvector_rows_f64",
  4,
  kAbiArgs_cuda_navatala_graph_normalize_eigenvector_rows_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_spectral_embedding_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_spectral_embedding_f32 = {
  1,
  "navatala_graph_spectral_embedding_f32",
  "cuda",
  "navatala_graph_spectral_embedding_f32",
  "kernel:cuda:navatala_graph_spectral_embedding_f32",
  "abi-r1:cuda:navatala_graph_spectral_embedding_f32",
  "abi-r1:cuda:navatala_graph_spectral_embedding_f32",
  4,
  kAbiArgs_cuda_navatala_graph_spectral_embedding_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_spectral_embedding_f64[] = {
  { "eigenvectors", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "k", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "embedding", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_spectral_embedding_f64 = {
  1,
  "navatala_graph_spectral_embedding_f64",
  "cuda",
  "navatala_graph_spectral_embedding_f64",
  "kernel:cuda:navatala_graph_spectral_embedding_f64",
  "abi-r1:cuda:navatala_graph_spectral_embedding_f64",
  "abi-r1:cuda:navatala_graph_spectral_embedding_f64",
  4,
  kAbiArgs_cuda_navatala_graph_spectral_embedding_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_rmat_generator_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_rmat_generator_f32 = {
  1,
  "navatala_graph_rmat_generator_f32",
  "cuda",
  "navatala_graph_rmat_generator_f32",
  "kernel:cuda:navatala_graph_rmat_generator_f32",
  "abi-r1:cuda:navatala_graph_rmat_generator_f32",
  "abi-r1:cuda:navatala_graph_rmat_generator_f32",
  13,
  kAbiArgs_cuda_navatala_graph_rmat_generator_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_rmat_generator_f64[] = {
  { "random", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "randomWeights", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_rmat_generator_f64 = {
  1,
  "navatala_graph_rmat_generator_f64",
  "cuda",
  "navatala_graph_rmat_generator_f64",
  "kernel:cuda:navatala_graph_rmat_generator_f64",
  "abi-r1:cuda:navatala_graph_rmat_generator_f64",
  "abi-r1:cuda:navatala_graph_rmat_generator_f64",
  13,
  kAbiArgs_cuda_navatala_graph_rmat_generator_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_erdos_renyi_f32[] = {
  { "random", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "randomWeights", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_erdos_renyi_f32 = {
  1,
  "navatala_graph_erdos_renyi_f32",
  "cuda",
  "navatala_graph_erdos_renyi_f32",
  "kernel:cuda:navatala_graph_erdos_renyi_f32",
  "abi-r1:cuda:navatala_graph_erdos_renyi_f32",
  "abi-r1:cuda:navatala_graph_erdos_renyi_f32",
  8,
  kAbiArgs_cuda_navatala_graph_erdos_renyi_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_erdos_renyi_f64[] = {
  { "random", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "randomWeights", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_erdos_renyi_f64 = {
  1,
  "navatala_graph_erdos_renyi_f64",
  "cuda",
  "navatala_graph_erdos_renyi_f64",
  "kernel:cuda:navatala_graph_erdos_renyi_f64",
  "abi-r1:cuda:navatala_graph_erdos_renyi_f64",
  "abi-r1:cuda:navatala_graph_erdos_renyi_f64",
  8,
  kAbiArgs_cuda_navatala_graph_erdos_renyi_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_barabasi_albert_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_barabasi_albert_f32 = {
  1,
  "navatala_graph_barabasi_albert_f32",
  "cuda",
  "navatala_graph_barabasi_albert_f32",
  "kernel:cuda:navatala_graph_barabasi_albert_f32",
  "abi-r1:cuda:navatala_graph_barabasi_albert_f32",
  "abi-r1:cuda:navatala_graph_barabasi_albert_f32",
  11,
  kAbiArgs_cuda_navatala_graph_barabasi_albert_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_barabasi_albert_f64[] = {
  { "cumDegree", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "random", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "randomWeights", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "newNode", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_barabasi_albert_f64 = {
  1,
  "navatala_graph_barabasi_albert_f64",
  "cuda",
  "navatala_graph_barabasi_albert_f64",
  "kernel:cuda:navatala_graph_barabasi_albert_f64",
  "abi-r1:cuda:navatala_graph_barabasi_albert_f64",
  "abi-r1:cuda:navatala_graph_barabasi_albert_f64",
  11,
  kAbiArgs_cuda_navatala_graph_barabasi_albert_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_compute_modularity_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_compute_modularity_f32 = {
  1,
  "navatala_graph_compute_modularity_f32",
  "cuda",
  "navatala_graph_compute_modularity_f32",
  "kernel:cuda:navatala_graph_compute_modularity_f32",
  "abi-r1:cuda:navatala_graph_compute_modularity_f32",
  "abi-r1:cuda:navatala_graph_compute_modularity_f32",
  8,
  kAbiArgs_cuda_navatala_graph_compute_modularity_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_compute_modularity_f64[] = {
  { "adjacencyValues", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rowPtr", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "colInd", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "clusters", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_compute_modularity_f64 = {
  1,
  "navatala_graph_compute_modularity_f64",
  "cuda",
  "navatala_graph_compute_modularity_f64",
  "kernel:cuda:navatala_graph_compute_modularity_f64",
  "abi-r1:cuda:navatala_graph_compute_modularity_f64",
  "abi-r1:cuda:navatala_graph_compute_modularity_f64",
  8,
  kAbiArgs_cuda_navatala_graph_compute_modularity_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_modularity_matrix_vec_f32[] = {
  { "adjacencyValues", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rowPtr", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "colInd", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "x", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_modularity_matrix_vec_f32 = {
  1,
  "navatala_graph_modularity_matrix_vec_f32",
  "cuda",
  "navatala_graph_modularity_matrix_vec_f32",
  "kernel:cuda:navatala_graph_modularity_matrix_vec_f32",
  "abi-r1:cuda:navatala_graph_modularity_matrix_vec_f32",
  "abi-r1:cuda:navatala_graph_modularity_matrix_vec_f32",
  9,
  kAbiArgs_cuda_navatala_graph_modularity_matrix_vec_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_modularity_matrix_vec_f64[] = {
  { "adjacencyValues", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rowPtr", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "colInd", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "x", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_modularity_matrix_vec_f64 = {
  1,
  "navatala_graph_modularity_matrix_vec_f64",
  "cuda",
  "navatala_graph_modularity_matrix_vec_f64",
  "kernel:cuda:navatala_graph_modularity_matrix_vec_f64",
  "abi-r1:cuda:navatala_graph_modularity_matrix_vec_f64",
  "abi-r1:cuda:navatala_graph_modularity_matrix_vec_f64",
  9,
  kAbiArgs_cuda_navatala_graph_modularity_matrix_vec_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_construct_indicator_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_construct_indicator_f32 = {
  1,
  "navatala_graph_construct_indicator_f32",
  "cuda",
  "navatala_graph_construct_indicator_f32",
  "kernel:cuda:navatala_graph_construct_indicator_f32",
  "abi-r1:cuda:navatala_graph_construct_indicator_f32",
  "abi-r1:cuda:navatala_graph_construct_indicator_f32",
  4,
  kAbiArgs_cuda_navatala_graph_construct_indicator_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_construct_indicator_f64[] = {
  { "clusters", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "clusterIndex", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "indicator", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_construct_indicator_f64 = {
  1,
  "navatala_graph_construct_indicator_f64",
  "cuda",
  "navatala_graph_construct_indicator_f64",
  "kernel:cuda:navatala_graph_construct_indicator_f64",
  "abi-r1:cuda:navatala_graph_construct_indicator_f64",
  "abi-r1:cuda:navatala_graph_construct_indicator_f64",
  4,
  kAbiArgs_cuda_navatala_graph_construct_indicator_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_compute_edge_cut_f32[] = {
  { "adjacencyValues", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rowPtr", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "colInd", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "clusters", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_compute_edge_cut_f32 = {
  1,
  "navatala_graph_compute_edge_cut_f32",
  "cuda",
  "navatala_graph_compute_edge_cut_f32",
  "kernel:cuda:navatala_graph_compute_edge_cut_f32",
  "abi-r1:cuda:navatala_graph_compute_edge_cut_f32",
  "abi-r1:cuda:navatala_graph_compute_edge_cut_f32",
  6,
  kAbiArgs_cuda_navatala_graph_compute_edge_cut_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_compute_edge_cut_f64[] = {
  { "adjacencyValues", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rowPtr", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "colInd", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "clusters", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_compute_edge_cut_f64 = {
  1,
  "navatala_graph_compute_edge_cut_f64",
  "cuda",
  "navatala_graph_compute_edge_cut_f64",
  "kernel:cuda:navatala_graph_compute_edge_cut_f64",
  "abi-r1:cuda:navatala_graph_compute_edge_cut_f64",
  "abi-r1:cuda:navatala_graph_compute_edge_cut_f64",
  6,
  kAbiArgs_cuda_navatala_graph_compute_edge_cut_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_compute_partition_cost_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_compute_partition_cost_f32 = {
  1,
  "navatala_graph_compute_partition_cost_f32",
  "cuda",
  "navatala_graph_compute_partition_cost_f32",
  "kernel:cuda:navatala_graph_compute_partition_cost_f32",
  "abi-r1:cuda:navatala_graph_compute_partition_cost_f32",
  "abi-r1:cuda:navatala_graph_compute_partition_cost_f32",
  4,
  kAbiArgs_cuda_navatala_graph_compute_partition_cost_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_compute_partition_cost_f64[] = {
  { "edgeCutPerCluster", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "clusterSizes", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "numClusters", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "cost", 3, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 8, 8, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_compute_partition_cost_f64 = {
  1,
  "navatala_graph_compute_partition_cost_f64",
  "cuda",
  "navatala_graph_compute_partition_cost_f64",
  "kernel:cuda:navatala_graph_compute_partition_cost_f64",
  "abi-r1:cuda:navatala_graph_compute_partition_cost_f64",
  "abi-r1:cuda:navatala_graph_compute_partition_cost_f64",
  4,
  kAbiArgs_cuda_navatala_graph_compute_partition_cost_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_analyze_partition_f32[] = {
  { "adjacencyValues", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rowPtr", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "colInd", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "clusters", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_analyze_partition_f32 = {
  1,
  "navatala_graph_analyze_partition_f32",
  "cuda",
  "navatala_graph_analyze_partition_f32",
  "kernel:cuda:navatala_graph_analyze_partition_f32",
  "abi-r1:cuda:navatala_graph_analyze_partition_f32",
  "abi-r1:cuda:navatala_graph_analyze_partition_f32",
  8,
  kAbiArgs_cuda_navatala_graph_analyze_partition_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_analyze_partition_f64[] = {
  { "adjacencyValues", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rowPtr", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "colInd", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "clusters", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_analyze_partition_f64 = {
  1,
  "navatala_graph_analyze_partition_f64",
  "cuda",
  "navatala_graph_analyze_partition_f64",
  "kernel:cuda:navatala_graph_analyze_partition_f64",
  "abi-r1:cuda:navatala_graph_analyze_partition_f64",
  "abi-r1:cuda:navatala_graph_analyze_partition_f64",
  8,
  kAbiArgs_cuda_navatala_graph_analyze_partition_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_transform_eigen_matrix_f32[] = {
  { "eigenvectors", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "k", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "transformed", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_transform_eigen_matrix_f32 = {
  1,
  "navatala_graph_transform_eigen_matrix_f32",
  "cuda",
  "navatala_graph_transform_eigen_matrix_f32",
  "kernel:cuda:navatala_graph_transform_eigen_matrix_f32",
  "abi-r1:cuda:navatala_graph_transform_eigen_matrix_f32",
  "abi-r1:cuda:navatala_graph_transform_eigen_matrix_f32",
  4,
  kAbiArgs_cuda_navatala_graph_transform_eigen_matrix_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_transform_eigen_matrix_f64[] = {
  { "eigenvectors", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "k", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "transformed", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_transform_eigen_matrix_f64 = {
  1,
  "navatala_graph_transform_eigen_matrix_f64",
  "cuda",
  "navatala_graph_transform_eigen_matrix_f64",
  "kernel:cuda:navatala_graph_transform_eigen_matrix_f64",
  "abi-r1:cuda:navatala_graph_transform_eigen_matrix_f64",
  "abi-r1:cuda:navatala_graph_transform_eigen_matrix_f64",
  4,
  kAbiArgs_cuda_navatala_graph_transform_eigen_matrix_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_compute_cluster_sizes_f32[] = {
  { "clusters", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "numClusters", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "sizes", 3, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_compute_cluster_sizes_f32 = {
  1,
  "navatala_graph_compute_cluster_sizes_f32",
  "cuda",
  "navatala_graph_compute_cluster_sizes_f32",
  "kernel:cuda:navatala_graph_compute_cluster_sizes_f32",
  "abi-r1:cuda:navatala_graph_compute_cluster_sizes_f32",
  "abi-r1:cuda:navatala_graph_compute_cluster_sizes_f32",
  4,
  kAbiArgs_cuda_navatala_graph_compute_cluster_sizes_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_compute_cluster_sizes_f64[] = {
  { "clusters", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "numClusters", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "sizes", 3, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_compute_cluster_sizes_f64 = {
  1,
  "navatala_graph_compute_cluster_sizes_f64",
  "cuda",
  "navatala_graph_compute_cluster_sizes_f64",
  "kernel:cuda:navatala_graph_compute_cluster_sizes_f64",
  "abi-r1:cuda:navatala_graph_compute_cluster_sizes_f64",
  "abi-r1:cuda:navatala_graph_compute_cluster_sizes_f64",
  4,
  kAbiArgs_cuda_navatala_graph_compute_cluster_sizes_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_laplacian_from_adjacency_f32[] = {
  { "adjacencyValues", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rowPtr", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "colInd", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_laplacian_from_adjacency_f32 = {
  1,
  "navatala_graph_laplacian_from_adjacency_f32",
  "cuda",
  "navatala_graph_laplacian_from_adjacency_f32",
  "kernel:cuda:navatala_graph_laplacian_from_adjacency_f32",
  "abi-r1:cuda:navatala_graph_laplacian_from_adjacency_f32",
  "abi-r1:cuda:navatala_graph_laplacian_from_adjacency_f32",
  6,
  kAbiArgs_cuda_navatala_graph_laplacian_from_adjacency_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_graph_laplacian_from_adjacency_f64[] = {
  { "adjacencyValues", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rowPtr", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "colInd", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_graph_laplacian_from_adjacency_f64 = {
  1,
  "navatala_graph_laplacian_from_adjacency_f64",
  "cuda",
  "navatala_graph_laplacian_from_adjacency_f64",
  "kernel:cuda:navatala_graph_laplacian_from_adjacency_f64",
  "abi-r1:cuda:navatala_graph_laplacian_from_adjacency_f64",
  "abi-r1:cuda:navatala_graph_laplacian_from_adjacency_f64",
  6,
  kAbiArgs_cuda_navatala_graph_laplacian_from_adjacency_f64
};

bool tryGetKernelAbiManifest_cuda_graph(const std::string& backend, const std::string& kernelName, const KernelAbiManifestInfo*& out) {
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f32") {
    out = &kAbiManifest_cuda_navatala_graph_pack_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f64") {
    out = &kAbiManifest_cuda_navatala_graph_pack_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_i32") {
    out = &kAbiManifest_cuda_navatala_graph_pack_i32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_u32") {
    out = &kAbiManifest_cuda_navatala_graph_pack_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f32") {
    out = &kAbiManifest_cuda_navatala_graph_unpack_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f64") {
    out = &kAbiManifest_cuda_navatala_graph_unpack_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_i32") {
    out = &kAbiManifest_cuda_navatala_graph_unpack_i32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_u32") {
    out = &kAbiManifest_cuda_navatala_graph_unpack_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f32x3") {
    out = &kAbiManifest_cuda_navatala_graph_pack_f32x3;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f32x3") {
    out = &kAbiManifest_cuda_navatala_graph_unpack_f32x3;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f32x6") {
    out = &kAbiManifest_cuda_navatala_graph_pack_f32x6;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f32x6") {
    out = &kAbiManifest_cuda_navatala_graph_unpack_f32x6;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f32x9") {
    out = &kAbiManifest_cuda_navatala_graph_pack_f32x9;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f32x9") {
    out = &kAbiManifest_cuda_navatala_graph_unpack_f32x9;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f64x3") {
    out = &kAbiManifest_cuda_navatala_graph_pack_f64x3;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f64x3") {
    out = &kAbiManifest_cuda_navatala_graph_unpack_f64x3;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f64x6") {
    out = &kAbiManifest_cuda_navatala_graph_pack_f64x6;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f64x6") {
    out = &kAbiManifest_cuda_navatala_graph_unpack_f64x6;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f64x9") {
    out = &kAbiManifest_cuda_navatala_graph_pack_f64x9;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f64x9") {
    out = &kAbiManifest_cuda_navatala_graph_unpack_f64x9;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_degree_out_u32") {
    out = &kAbiManifest_cuda_navatala_graph_degree_out_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_degree_in_u32") {
    out = &kAbiManifest_cuda_navatala_graph_degree_in_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_spmv_weighted_f32") {
    out = &kAbiManifest_cuda_navatala_graph_spmv_weighted_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_spmv_weighted_subgroup_f32") {
    out = &kAbiManifest_cuda_navatala_graph_spmv_weighted_subgroup_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_spmv_unweighted_f32") {
    out = &kAbiManifest_cuda_navatala_graph_spmv_unweighted_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_spmv_unweighted_subgroup_f32") {
    out = &kAbiManifest_cuda_navatala_graph_spmv_unweighted_subgroup_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_axpy2_f32") {
    out = &kAbiManifest_cuda_navatala_graph_axpy2_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_scale_f32") {
    out = &kAbiManifest_cuda_navatala_graph_scale_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_scale_add_bias_f32") {
    out = &kAbiManifest_cuda_navatala_graph_scale_add_bias_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_l1norm_f32") {
    out = &kAbiManifest_cuda_navatala_graph_l1norm_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_recip_f32") {
    out = &kAbiManifest_cuda_navatala_graph_recip_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_l1_diff_f32") {
    out = &kAbiManifest_cuda_navatala_graph_l1_diff_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_count_diff_u32") {
    out = &kAbiManifest_cuda_navatala_graph_count_diff_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_copy_f32") {
    out = &kAbiManifest_cuda_navatala_graph_copy_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_copy_u32") {
    out = &kAbiManifest_cuda_navatala_graph_copy_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_relax_vertex_pull_f32") {
    out = &kAbiManifest_cuda_navatala_graph_relax_vertex_pull_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_label_propagate_edges_u32") {
    out = &kAbiManifest_cuda_navatala_graph_label_propagate_edges_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_symmetrize_reverse_u32") {
    out = &kAbiManifest_cuda_navatala_graph_symmetrize_reverse_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_apply_renumber_u32") {
    out = &kAbiManifest_cuda_navatala_graph_apply_renumber_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_peel_below_threshold_u32") {
    out = &kAbiManifest_cuda_navatala_graph_peel_below_threshold_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pair_intersection_u32") {
    out = &kAbiManifest_cuda_navatala_graph_pair_intersection_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_jaccard_f32") {
    out = &kAbiManifest_cuda_navatala_graph_jaccard_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_overlap_f32") {
    out = &kAbiManifest_cuda_navatala_graph_overlap_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_sorensen_f32") {
    out = &kAbiManifest_cuda_navatala_graph_sorensen_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_cosine_f32") {
    out = &kAbiManifest_cuda_navatala_graph_cosine_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_uniform_random_walk_u32") {
    out = &kAbiManifest_cuda_navatala_graph_uniform_random_walk_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_out_degree_u32") {
    out = &kAbiManifest_cuda_navatala_graph_out_degree_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_in_degree_u32") {
    out = &kAbiManifest_cuda_navatala_graph_in_degree_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_rbf_affinity_f32") {
    out = &kAbiManifest_cuda_navatala_graph_rbf_affinity_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_rbf_affinity_f64") {
    out = &kAbiManifest_cuda_navatala_graph_rbf_affinity_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_degree_matrix_f32") {
    out = &kAbiManifest_cuda_navatala_graph_compute_degree_matrix_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_degree_matrix_f64") {
    out = &kAbiManifest_cuda_navatala_graph_compute_degree_matrix_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_laplacian_f32") {
    out = &kAbiManifest_cuda_navatala_graph_compute_laplacian_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_laplacian_f64") {
    out = &kAbiManifest_cuda_navatala_graph_compute_laplacian_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_normalized_laplacian_f32") {
    out = &kAbiManifest_cuda_navatala_graph_normalized_laplacian_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_normalized_laplacian_f64") {
    out = &kAbiManifest_cuda_navatala_graph_normalized_laplacian_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_normalize_eigenvector_rows_f32") {
    out = &kAbiManifest_cuda_navatala_graph_normalize_eigenvector_rows_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_normalize_eigenvector_rows_f64") {
    out = &kAbiManifest_cuda_navatala_graph_normalize_eigenvector_rows_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_spectral_embedding_f32") {
    out = &kAbiManifest_cuda_navatala_graph_spectral_embedding_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_spectral_embedding_f64") {
    out = &kAbiManifest_cuda_navatala_graph_spectral_embedding_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_rmat_generator_f32") {
    out = &kAbiManifest_cuda_navatala_graph_rmat_generator_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_rmat_generator_f64") {
    out = &kAbiManifest_cuda_navatala_graph_rmat_generator_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_erdos_renyi_f32") {
    out = &kAbiManifest_cuda_navatala_graph_erdos_renyi_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_erdos_renyi_f64") {
    out = &kAbiManifest_cuda_navatala_graph_erdos_renyi_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_barabasi_albert_f32") {
    out = &kAbiManifest_cuda_navatala_graph_barabasi_albert_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_barabasi_albert_f64") {
    out = &kAbiManifest_cuda_navatala_graph_barabasi_albert_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_modularity_f32") {
    out = &kAbiManifest_cuda_navatala_graph_compute_modularity_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_modularity_f64") {
    out = &kAbiManifest_cuda_navatala_graph_compute_modularity_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_modularity_matrix_vec_f32") {
    out = &kAbiManifest_cuda_navatala_graph_modularity_matrix_vec_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_modularity_matrix_vec_f64") {
    out = &kAbiManifest_cuda_navatala_graph_modularity_matrix_vec_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_construct_indicator_f32") {
    out = &kAbiManifest_cuda_navatala_graph_construct_indicator_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_construct_indicator_f64") {
    out = &kAbiManifest_cuda_navatala_graph_construct_indicator_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_edge_cut_f32") {
    out = &kAbiManifest_cuda_navatala_graph_compute_edge_cut_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_edge_cut_f64") {
    out = &kAbiManifest_cuda_navatala_graph_compute_edge_cut_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_partition_cost_f32") {
    out = &kAbiManifest_cuda_navatala_graph_compute_partition_cost_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_partition_cost_f64") {
    out = &kAbiManifest_cuda_navatala_graph_compute_partition_cost_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_analyze_partition_f32") {
    out = &kAbiManifest_cuda_navatala_graph_analyze_partition_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_analyze_partition_f64") {
    out = &kAbiManifest_cuda_navatala_graph_analyze_partition_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_transform_eigen_matrix_f32") {
    out = &kAbiManifest_cuda_navatala_graph_transform_eigen_matrix_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_transform_eigen_matrix_f64") {
    out = &kAbiManifest_cuda_navatala_graph_transform_eigen_matrix_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_cluster_sizes_f32") {
    out = &kAbiManifest_cuda_navatala_graph_compute_cluster_sizes_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_cluster_sizes_f64") {
    out = &kAbiManifest_cuda_navatala_graph_compute_cluster_sizes_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_laplacian_from_adjacency_f32") {
    out = &kAbiManifest_cuda_navatala_graph_laplacian_from_adjacency_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_laplacian_from_adjacency_f64") {
    out = &kAbiManifest_cuda_navatala_graph_laplacian_from_adjacency_f64;
    return true;
  }
  out = nullptr;
  return false;
...
bool tryGetKernelSource_cuda_graph(const std::string& backend, const std::string& kernelName, GpuRuntime::ProgramSource& out) {
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f32") {
    out.kind = GpuRuntime::ProgramSource::Kind::CudaCpp;
    out.entryPoint = "navatala_graph_pack_f32";
    std::string_view sv(k_cuda_navatala_graph_pack_f32);
  ...
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_pack_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_i32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_pack_i32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_pack_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_unpack_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_unpack_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_i32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_unpack_i32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_unpack_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f32x3") {
    ...
    std::string_view sv(k_cuda_navatala_graph_pack_f32x3);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f32x3") {
    ...
    std::string_view sv(k_cuda_navatala_graph_unpack_f32x3);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f32x6") {
    ...
    std::string_view sv(k_cuda_navatala_graph_pack_f32x6);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f32x6") {
    ...
    std::string_view sv(k_cuda_navatala_graph_unpack_f32x6);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f32x9") {
    ...
    std::string_view sv(k_cuda_navatala_graph_pack_f32x9);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f32x9") {
    ...
    std::string_view sv(k_cuda_navatala_graph_unpack_f32x9);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f64x3") {
    ...
    std::string_view sv(k_cuda_navatala_graph_pack_f64x3);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f64x3") {
    ...
    std::string_view sv(k_cuda_navatala_graph_unpack_f64x3);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f64x6") {
    ...
    std::string_view sv(k_cuda_navatala_graph_pack_f64x6);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f64x6") {
    ...
    std::string_view sv(k_cuda_navatala_graph_unpack_f64x6);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pack_f64x9") {
    ...
    std::string_view sv(k_cuda_navatala_graph_pack_f64x9);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_unpack_f64x9") {
    ...
    std::string_view sv(k_cuda_navatala_graph_unpack_f64x9);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_degree_out_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_degree_out_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_degree_in_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_degree_in_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_spmv_weighted_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_spmv_weighted_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_spmv_weighted_subgroup_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_spmv_weighted_subgroup_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_spmv_unweighted_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_spmv_unweighted_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_spmv_unweighted_subgroup_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_spmv_unweighted_subgroup_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_axpy2_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_axpy2_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_scale_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_scale_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_scale_add_bias_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_scale_add_bias_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_l1norm_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_l1norm_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_recip_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_recip_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_l1_diff_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_l1_diff_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_count_diff_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_count_diff_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_copy_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_copy_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_copy_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_copy_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_relax_vertex_pull_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_relax_vertex_pull_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_label_propagate_edges_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_label_propagate_edges_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_symmetrize_reverse_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_symmetrize_reverse_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_apply_renumber_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_apply_renumber_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_peel_below_threshold_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_peel_below_threshold_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_pair_intersection_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_pair_intersection_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_jaccard_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_jaccard_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_overlap_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_overlap_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_sorensen_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_sorensen_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_cosine_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_cosine_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_uniform_random_walk_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_uniform_random_walk_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_out_degree_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_out_degree_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_in_degree_u32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_in_degree_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_rbf_affinity_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_rbf_affinity_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_rbf_affinity_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_rbf_affinity_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_degree_matrix_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_compute_degree_matrix_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_degree_matrix_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_compute_degree_matrix_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_laplacian_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_compute_laplacian_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_laplacian_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_compute_laplacian_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_normalized_laplacian_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_normalized_laplacian_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_normalized_laplacian_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_normalized_laplacian_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_normalize_eigenvector_rows_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_normalize_eigenvector_rows_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_normalize_eigenvector_rows_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_normalize_eigenvector_rows_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_spectral_embedding_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_spectral_embedding_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_spectral_embedding_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_spectral_embedding_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_rmat_generator_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_rmat_generator_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_rmat_generator_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_rmat_generator_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_erdos_renyi_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_erdos_renyi_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_erdos_renyi_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_erdos_renyi_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_barabasi_albert_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_barabasi_albert_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_barabasi_albert_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_barabasi_albert_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_modularity_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_compute_modularity_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_modularity_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_compute_modularity_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_modularity_matrix_vec_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_modularity_matrix_vec_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_modularity_matrix_vec_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_modularity_matrix_vec_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_construct_indicator_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_construct_indicator_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_construct_indicator_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_construct_indicator_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_edge_cut_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_compute_edge_cut_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_edge_cut_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_compute_edge_cut_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_partition_cost_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_compute_partition_cost_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_partition_cost_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_compute_partition_cost_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_analyze_partition_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_analyze_partition_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_analyze_partition_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_analyze_partition_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_transform_eigen_matrix_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_transform_eigen_matrix_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_transform_eigen_matrix_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_transform_eigen_matrix_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_cluster_sizes_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_compute_cluster_sizes_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_compute_cluster_sizes_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_compute_cluster_sizes_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_laplacian_from_adjacency_f32") {
    ...
    std::string_view sv(k_cuda_navatala_graph_laplacian_from_adjacency_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_graph_laplacian_from_adjacency_f64") {
    ...
    std::string_view sv(k_cuda_navatala_graph_laplacian_from_adjacency_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  return false;
