...
// Kernel registry partition for the `hip_unmapped` bucket. Compiles
...
const char* k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_alphaIsoVerticalProbeF64 = R"kernel(
...
const char* k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_barthJespersenCellF64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullLaminarFaceTractionF64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPairwiseReductionLevelF64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPressureFaceTractionF64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullSstFaceTractionF64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullWindowStatisticsF64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marineInterfaceCompressionF64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marineMomentumDampingF64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marinePressureTargetF64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_Solver_CFD_StandaloneCfd03SstGpuKernels_sstProfilePointwiseFieldsF64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_Solver_CFD_StandaloneCfd03SstGpuKernels_sstSpaldingWallFacesF64 = R"kernel(
#include <hip/hip_runtime.h>
...
const KernelArgumentInfo kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_alphaIsoVerticalProbeF64[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_alphaIsoVerticalProbeF64 = {
  1,
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_alphaIsoVerticalProbeF64",
  "hip",
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_alphaIsoVerticalProbeF64",
  "kernel:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_alphaIsoVerticalProbeF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_alphaIsoVerticalProbeF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_alphaIsoVerticalProbeF64",
  9,
  kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_alphaIsoVerticalProbeF64
};

const KernelArgumentInfo kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_barthJespersenCellF64[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_barthJespersenCellF64 = {
  1,
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_barthJespersenCellF64",
  "hip",
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_barthJespersenCellF64",
  "kernel:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_barthJespersenCellF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_barthJespersenCellF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_barthJespersenCellF64",
  8,
  kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_barthJespersenCellF64
};

const KernelArgumentInfo kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullLaminarFaceTractionF64[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullLaminarFaceTractionF64 = {
  1,
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullLaminarFaceTractionF64",
  "hip",
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullLaminarFaceTractionF64",
  "kernel:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullLaminarFaceTractionF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullLaminarFaceTractionF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullLaminarFaceTractionF64",
  25,
  kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullLaminarFaceTractionF64
};

const KernelArgumentInfo kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPairwiseReductionLevelF64[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPairwiseReductionLevelF64 = {
  1,
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPairwiseReductionLevelF64",
  "hip",
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPairwiseReductionLevelF64",
  "kernel:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPairwiseReductionLevelF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPairwiseReductionLevelF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPairwiseReductionLevelF64",
  25,
  kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPairwiseReductionLevelF64
};

const KernelArgumentInfo kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPressureFaceTractionF64[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPressureFaceTractionF64 = {
  1,
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPressureFaceTractionF64",
  "hip",
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPressureFaceTractionF64",
  "kernel:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPressureFaceTractionF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPressureFaceTractionF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPressureFaceTractionF64",
  26,
  kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPressureFaceTractionF64
};

const KernelArgumentInfo kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullSstFaceTractionF64[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullSstFaceTractionF64 = {
  1,
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullSstFaceTractionF64",
  "hip",
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullSstFaceTractionF64",
  "kernel:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullSstFaceTractionF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullSstFaceTractionF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullSstFaceTractionF64",
  18,
  kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullSstFaceTractionF64
};

const KernelArgumentInfo kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullWindowStatisticsF64[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullWindowStatisticsF64 = {
  1,
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullWindowStatisticsF64",
  "hip",
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullWindowStatisticsF64",
  "kernel:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullWindowStatisticsF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullWindowStatisticsF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_hullWindowStatisticsF64",
  12,
  kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullWindowStatisticsF64
};

const KernelArgumentInfo kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marineInterfaceCompressionF64[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marineInterfaceCompressionF64 = {
  1,
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_marineInterfaceCompressionF64",
  "hip",
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_marineInterfaceCompressionF64",
  "kernel:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_marineInterfaceCompressionF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_marineInterfaceCompressionF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_marineInterfaceCompressionF64",
  10,
  kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marineInterfaceCompressionF64
};

const KernelArgumentInfo kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marineMomentumDampingF64[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marineMomentumDampingF64 = {
  1,
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_marineMomentumDampingF64",
  "hip",
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_marineMomentumDampingF64",
  "kernel:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_marineMomentumDampingF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_marineMomentumDampingF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_marineMomentumDampingF64",
  19,
  kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marineMomentumDampingF64
};

const KernelArgumentInfo kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marinePressureTargetF64[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marinePressureTargetF64 = {
  1,
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_marinePressureTargetF64",
  "hip",
  "Solver_CFD_StandaloneCfd03MarineGpuKernels_marinePressureTargetF64",
  "kernel:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_marinePressureTargetF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_marinePressureTargetF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03MarineGpuKernels_marinePressureTargetF64",
  9,
  kAbiArgs_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marinePressureTargetF64
};

const KernelArgumentInfo kAbiArgs_hip_Solver_CFD_StandaloneCfd03SstGpuKernels_sstProfilePointwiseFieldsF64[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_Solver_CFD_StandaloneCfd03SstGpuKernels_sstProfilePointwiseFieldsF64 = {
  1,
  "Solver_CFD_StandaloneCfd03SstGpuKernels_sstProfilePointwiseFieldsF64",
  "hip",
  "Solver_CFD_StandaloneCfd03SstGpuKernels_sstProfilePointwiseFieldsF64",
  "kernel:hip:Solver_CFD_StandaloneCfd03SstGpuKernels_sstProfilePointwiseFieldsF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03SstGpuKernels_sstProfilePointwiseFieldsF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03SstGpuKernels_sstProfilePointwiseFieldsF64",
  36,
  kAbiArgs_hip_Solver_CFD_StandaloneCfd03SstGpuKernels_sstProfilePointwiseFieldsF64
};

const KernelArgumentInfo kAbiArgs_hip_Solver_CFD_StandaloneCfd03SstGpuKernels_sstSpaldingWallFacesF64[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_Solver_CFD_StandaloneCfd03SstGpuKernels_sstSpaldingWallFacesF64 = {
  1,
  "Solver_CFD_StandaloneCfd03SstGpuKernels_sstSpaldingWallFacesF64",
  "hip",
  "Solver_CFD_StandaloneCfd03SstGpuKernels_sstSpaldingWallFacesF64",
  "kernel:hip:Solver_CFD_StandaloneCfd03SstGpuKernels_sstSpaldingWallFacesF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03SstGpuKernels_sstSpaldingWallFacesF64",
  "abi-r1:hip:Solver_CFD_StandaloneCfd03SstGpuKernels_sstSpaldingWallFacesF64",
  28,
  kAbiArgs_hip_Solver_CFD_StandaloneCfd03SstGpuKernels_sstSpaldingWallFacesF64
};

bool tryGetKernelAbiManifest_hip_unmapped(const std::string& backend, const std::string& kernelName, const KernelAbiManifestInfo*& out) {
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_alphaIsoVerticalProbeF64") {
    out = &kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_alphaIsoVerticalProbeF64;
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_barthJespersenCellF64") {
    out = &kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_barthJespersenCellF64;
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullLaminarFaceTractionF64") {
    out = &kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullLaminarFaceTractionF64;
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPairwiseReductionLevelF64") {
    out = &kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPairwiseReductionLevelF64;
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPressureFaceTractionF64") {
    out = &kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPressureFaceTractionF64;
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullSstFaceTractionF64") {
    out = &kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullSstFaceTractionF64;
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullWindowStatisticsF64") {
    out = &kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullWindowStatisticsF64;
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_marineInterfaceCompressionF64") {
    out = &kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marineInterfaceCompressionF64;
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_marineMomentumDampingF64") {
    out = &kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marineMomentumDampingF64;
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_marinePressureTargetF64") {
    out = &kAbiManifest_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marinePressureTargetF64;
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03SstGpuKernels_sstProfilePointwiseFieldsF64") {
    out = &kAbiManifest_hip_Solver_CFD_StandaloneCfd03SstGpuKernels_sstProfilePointwiseFieldsF64;
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03SstGpuKernels_sstSpaldingWallFacesF64") {
    out = &kAbiManifest_hip_Solver_CFD_StandaloneCfd03SstGpuKernels_sstSpaldingWallFacesF64;
    return true;
  }
  out = nullptr;
  return false;
...
bool tryGetKernelSource_hip_unmapped(const std::string& backend, const std::string& kernelName, GpuRuntime::ProgramSource& out) {
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_alphaIsoVerticalProbeF64") {
    ...
    std::string_view sv(k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_alphaIsoVerticalProbeF64);
  ...
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_barthJespersenCellF64") {
    ...
    std::string_view sv(k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_barthJespersenCellF64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullLaminarFaceTractionF64") {
    ...
    std::string_view sv(k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullLaminarFaceTractionF64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPairwiseReductionLevelF64") {
    ...
    std::string_view sv(k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPairwiseReductionLevelF64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPressureFaceTractionF64") {
    ...
    std::string_view sv(k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullPressureFaceTractionF64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullSstFaceTractionF64") {
    ...
    std::string_view sv(k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullSstFaceTractionF64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_hullWindowStatisticsF64") {
    ...
    std::string_view sv(k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_hullWindowStatisticsF64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_marineInterfaceCompressionF64") {
    ...
    std::string_view sv(k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marineInterfaceCompressionF64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_marineMomentumDampingF64") {
    ...
    std::string_view sv(k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marineMomentumDampingF64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03MarineGpuKernels_marinePressureTargetF64") {
    ...
    std::string_view sv(k_hip_Solver_CFD_StandaloneCfd03MarineGpuKernels_marinePressureTargetF64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03SstGpuKernels_sstProfilePointwiseFieldsF64") {
    ...
    std::string_view sv(k_hip_Solver_CFD_StandaloneCfd03SstGpuKernels_sstProfilePointwiseFieldsF64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "Solver_CFD_StandaloneCfd03SstGpuKernels_sstSpaldingWallFacesF64") {
    ...
    std::string_view sv(k_hip_Solver_CFD_StandaloneCfd03SstGpuKernels_sstSpaldingWallFacesF64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  return false;
