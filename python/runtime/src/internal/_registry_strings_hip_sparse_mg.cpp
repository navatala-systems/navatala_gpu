...
// Kernel registry partition for the `hip_sparse_mg` bucket. Compiles
...
const char* k_hip_navatala_sparse_mg_restrict_f32 = R"kernel(
...
const char* k_hip_navatala_sparse_mg_restrict_f64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_prolongate_f32 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_prolongate_f64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_convergence_absolute_f32 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_convergence_relative_f32 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_convergence_absolute_f64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_convergence_relative_f64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_compute_residual_f32 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_compute_residual_f64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_weighted_restrict_f32 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_weighted_restrict_f64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_error_norm_partials_f32 = R"kernel(
#include <hip/hip_runtime.h>
template <typename T>
...
const char* k_hip_navatala_sparse_mg_error_norm_partials_f64 = R"kernel(
#include <hip/hip_runtime.h>
template <typename T>
__device__ inline T gpu_warp_reduce_sum(T v) {
  for (int offset = warpSize / 2; offset > 0; offset >>= 1) {
...
const char* k_hip_navatala_sparse_mg_zero_vector_f32 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_zero_vector_f64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_prolongate_damped_f32 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_sparse_mg_prolongate_damped_f64 = R"kernel(
#include <hip/hip_runtime.h>
...
const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_restrict_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_restrict_f32 = {
  1,
  "navatala_sparse_mg_restrict_f32",
  "hip",
  "navatala_sparse_mg_restrict_f32",
  "kernel:hip:navatala_sparse_mg_restrict_f32",
  "abi-r1:hip:navatala_sparse_mg_restrict_f32",
  "abi-r1:hip:navatala_sparse_mg_restrict_f32",
  6,
  kAbiArgs_hip_navatala_sparse_mg_restrict_f32
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_restrict_f64[] = {
  { "RrowPtr", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "RcolIdx", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "Rvalues", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rFine", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_restrict_f64 = {
  1,
  "navatala_sparse_mg_restrict_f64",
  "hip",
  "navatala_sparse_mg_restrict_f64",
  "kernel:hip:navatala_sparse_mg_restrict_f64",
  "abi-r1:hip:navatala_sparse_mg_restrict_f64",
  "abi-r1:hip:navatala_sparse_mg_restrict_f64",
  6,
  kAbiArgs_hip_navatala_sparse_mg_restrict_f64
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_prolongate_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_prolongate_f32 = {
  1,
  "navatala_sparse_mg_prolongate_f32",
  "hip",
  "navatala_sparse_mg_prolongate_f32",
  "kernel:hip:navatala_sparse_mg_prolongate_f32",
  "abi-r1:hip:navatala_sparse_mg_prolongate_f32",
  "abi-r1:hip:navatala_sparse_mg_prolongate_f32",
  6,
  kAbiArgs_hip_navatala_sparse_mg_prolongate_f32
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_prolongate_f64[] = {
  { "ProwPtr", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "PcolIdx", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "Pvalues", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "eCoarse", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_prolongate_f64 = {
  1,
  "navatala_sparse_mg_prolongate_f64",
  "hip",
  "navatala_sparse_mg_prolongate_f64",
  "kernel:hip:navatala_sparse_mg_prolongate_f64",
  "abi-r1:hip:navatala_sparse_mg_prolongate_f64",
  "abi-r1:hip:navatala_sparse_mg_prolongate_f64",
  6,
  kAbiArgs_hip_navatala_sparse_mg_prolongate_f64
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_convergence_absolute_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_convergence_absolute_f32 = {
  1,
  "navatala_sparse_mg_convergence_absolute_f32",
  "hip",
  "navatala_sparse_mg_convergence_absolute_f32",
  "kernel:hip:navatala_sparse_mg_convergence_absolute_f32",
  "abi-r1:hip:navatala_sparse_mg_convergence_absolute_f32",
  "abi-r1:hip:navatala_sparse_mg_convergence_absolute_f32",
  3,
  kAbiArgs_hip_navatala_sparse_mg_convergence_absolute_f32
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_convergence_relative_f32[] = {
  { "residualNorm", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_convergence_relative_f32 = {
  1,
  "navatala_sparse_mg_convergence_relative_f32",
  "hip",
  "navatala_sparse_mg_convergence_relative_f32",
  "kernel:hip:navatala_sparse_mg_convergence_relative_f32",
  "abi-r1:hip:navatala_sparse_mg_convergence_relative_f32",
  "abi-r1:hip:navatala_sparse_mg_convergence_relative_f32",
  4,
  kAbiArgs_hip_navatala_sparse_mg_convergence_relative_f32
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_convergence_absolute_f64[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_convergence_absolute_f64 = {
  1,
  "navatala_sparse_mg_convergence_absolute_f64",
  "hip",
  "navatala_sparse_mg_convergence_absolute_f64",
  "kernel:hip:navatala_sparse_mg_convergence_absolute_f64",
  "abi-r1:hip:navatala_sparse_mg_convergence_absolute_f64",
  "abi-r1:hip:navatala_sparse_mg_convergence_absolute_f64",
  3,
  kAbiArgs_hip_navatala_sparse_mg_convergence_absolute_f64
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_convergence_relative_f64[] = {
  { "residualNorm", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 8, 8, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_convergence_relative_f64 = {
  1,
  "navatala_sparse_mg_convergence_relative_f64",
  "hip",
  "navatala_sparse_mg_convergence_relative_f64",
  "kernel:hip:navatala_sparse_mg_convergence_relative_f64",
  "abi-r1:hip:navatala_sparse_mg_convergence_relative_f64",
  "abi-r1:hip:navatala_sparse_mg_convergence_relative_f64",
  4,
  kAbiArgs_hip_navatala_sparse_mg_convergence_relative_f64
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_compute_residual_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_compute_residual_f32 = {
  1,
  "navatala_sparse_mg_compute_residual_f32",
  "hip",
  "navatala_sparse_mg_compute_residual_f32",
  "kernel:hip:navatala_sparse_mg_compute_residual_f32",
  "abi-r1:hip:navatala_sparse_mg_compute_residual_f32",
  "abi-r1:hip:navatala_sparse_mg_compute_residual_f32",
  4,
  kAbiArgs_hip_navatala_sparse_mg_compute_residual_f32
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_compute_residual_f64[] = {
  { "b", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "Ax", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "r", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_compute_residual_f64 = {
  1,
  "navatala_sparse_mg_compute_residual_f64",
  "hip",
  "navatala_sparse_mg_compute_residual_f64",
  "kernel:hip:navatala_sparse_mg_compute_residual_f64",
  "abi-r1:hip:navatala_sparse_mg_compute_residual_f64",
  "abi-r1:hip:navatala_sparse_mg_compute_residual_f64",
  4,
  kAbiArgs_hip_navatala_sparse_mg_compute_residual_f64
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_weighted_restrict_f32[] = {
  { "RrowPtr", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "RcolIdx", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "Rvalues", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rFine", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_weighted_restrict_f32 = {
  1,
  "navatala_sparse_mg_weighted_restrict_f32",
  "hip",
  "navatala_sparse_mg_weighted_restrict_f32",
  "kernel:hip:navatala_sparse_mg_weighted_restrict_f32",
  "abi-r1:hip:navatala_sparse_mg_weighted_restrict_f32",
  "abi-r1:hip:navatala_sparse_mg_weighted_restrict_f32",
  7,
  kAbiArgs_hip_navatala_sparse_mg_weighted_restrict_f32
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_weighted_restrict_f64[] = {
  { "RrowPtr", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "RcolIdx", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "Rvalues", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rFine", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_weighted_restrict_f64 = {
  1,
  "navatala_sparse_mg_weighted_restrict_f64",
  "hip",
  "navatala_sparse_mg_weighted_restrict_f64",
  "kernel:hip:navatala_sparse_mg_weighted_restrict_f64",
  "abi-r1:hip:navatala_sparse_mg_weighted_restrict_f64",
  "abi-r1:hip:navatala_sparse_mg_weighted_restrict_f64",
  7,
  kAbiArgs_hip_navatala_sparse_mg_weighted_restrict_f64
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_error_norm_partials_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_error_norm_partials_f32 = {
  1,
  "navatala_sparse_mg_error_norm_partials_f32",
  "hip",
  "navatala_sparse_mg_error_norm_partials_f32",
  "kernel:hip:navatala_sparse_mg_error_norm_partials_f32",
  "abi-r1:hip:navatala_sparse_mg_error_norm_partials_f32",
  "abi-r1:hip:navatala_sparse_mg_error_norm_partials_f32",
  3,
  kAbiArgs_hip_navatala_sparse_mg_error_norm_partials_f32
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_error_norm_partials_f64[] = {
  { "error", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "partials", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_error_norm_partials_f64 = {
  1,
  "navatala_sparse_mg_error_norm_partials_f64",
  "hip",
  "navatala_sparse_mg_error_norm_partials_f64",
  "kernel:hip:navatala_sparse_mg_error_norm_partials_f64",
  "abi-r1:hip:navatala_sparse_mg_error_norm_partials_f64",
  "abi-r1:hip:navatala_sparse_mg_error_norm_partials_f64",
  3,
  kAbiArgs_hip_navatala_sparse_mg_error_norm_partials_f64
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_zero_vector_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_zero_vector_f32 = {
  1,
  "navatala_sparse_mg_zero_vector_f32",
  "hip",
  "navatala_sparse_mg_zero_vector_f32",
  "kernel:hip:navatala_sparse_mg_zero_vector_f32",
  "abi-r1:hip:navatala_sparse_mg_zero_vector_f32",
  "abi-r1:hip:navatala_sparse_mg_zero_vector_f32",
  2,
  kAbiArgs_hip_navatala_sparse_mg_zero_vector_f32
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_zero_vector_f64[] = {
  { "n", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "v", 1, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_zero_vector_f64 = {
  1,
  "navatala_sparse_mg_zero_vector_f64",
  "hip",
  "navatala_sparse_mg_zero_vector_f64",
  "kernel:hip:navatala_sparse_mg_zero_vector_f64",
  "abi-r1:hip:navatala_sparse_mg_zero_vector_f64",
  "abi-r1:hip:navatala_sparse_mg_zero_vector_f64",
  2,
  kAbiArgs_hip_navatala_sparse_mg_zero_vector_f64
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_prolongate_damped_f32[] = {
  { "ProwPtr", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "PcolIdx", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "Pvalues", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "eCoarse", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_prolongate_damped_f32 = {
  1,
  "navatala_sparse_mg_prolongate_damped_f32",
  "hip",
  "navatala_sparse_mg_prolongate_damped_f32",
  "kernel:hip:navatala_sparse_mg_prolongate_damped_f32",
  "abi-r1:hip:navatala_sparse_mg_prolongate_damped_f32",
  "abi-r1:hip:navatala_sparse_mg_prolongate_damped_f32",
  7,
  kAbiArgs_hip_navatala_sparse_mg_prolongate_damped_f32
};

const KernelArgumentInfo kAbiArgs_hip_navatala_sparse_mg_prolongate_damped_f64[] = {
  { "ProwPtr", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "PcolIdx", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "Pvalues", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "eCoarse", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_sparse_mg_prolongate_damped_f64 = {
  1,
  "navatala_sparse_mg_prolongate_damped_f64",
  "hip",
  "navatala_sparse_mg_prolongate_damped_f64",
  "kernel:hip:navatala_sparse_mg_prolongate_damped_f64",
  "abi-r1:hip:navatala_sparse_mg_prolongate_damped_f64",
  "abi-r1:hip:navatala_sparse_mg_prolongate_damped_f64",
  7,
  kAbiArgs_hip_navatala_sparse_mg_prolongate_damped_f64
};
...
bool tryGetKernelAbiManifest_hip_sparse_mg(const std::string& backend, const std::string& kernelName, const KernelAbiManifestInfo*& out) {
  if (backend == "hip" && kernelName == "navatala_sparse_mg_restrict_f32") {
    out = &kAbiManifest_hip_navatala_sparse_mg_restrict_f32;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_restrict_f64") {
    out = &kAbiManifest_hip_navatala_sparse_mg_restrict_f64;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_prolongate_f32") {
    out = &kAbiManifest_hip_navatala_sparse_mg_prolongate_f32;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_prolongate_f64") {
    out = &kAbiManifest_hip_navatala_sparse_mg_prolongate_f64;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_convergence_absolute_f32") {
    out = &kAbiManifest_hip_navatala_sparse_mg_convergence_absolute_f32;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_convergence_relative_f32") {
    out = &kAbiManifest_hip_navatala_sparse_mg_convergence_relative_f32;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_convergence_absolute_f64") {
    out = &kAbiManifest_hip_navatala_sparse_mg_convergence_absolute_f64;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_convergence_relative_f64") {
    out = &kAbiManifest_hip_navatala_sparse_mg_convergence_relative_f64;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_compute_residual_f32") {
    out = &kAbiManifest_hip_navatala_sparse_mg_compute_residual_f32;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_compute_residual_f64") {
    out = &kAbiManifest_hip_navatala_sparse_mg_compute_residual_f64;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_weighted_restrict_f32") {
    out = &kAbiManifest_hip_navatala_sparse_mg_weighted_restrict_f32;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_weighted_restrict_f64") {
    out = &kAbiManifest_hip_navatala_sparse_mg_weighted_restrict_f64;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_error_norm_partials_f32") {
    out = &kAbiManifest_hip_navatala_sparse_mg_error_norm_partials_f32;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_error_norm_partials_f64") {
    out = &kAbiManifest_hip_navatala_sparse_mg_error_norm_partials_f64;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_zero_vector_f32") {
    out = &kAbiManifest_hip_navatala_sparse_mg_zero_vector_f32;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_zero_vector_f64") {
    out = &kAbiManifest_hip_navatala_sparse_mg_zero_vector_f64;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_prolongate_damped_f32") {
    out = &kAbiManifest_hip_navatala_sparse_mg_prolongate_damped_f32;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_prolongate_damped_f64") {
    out = &kAbiManifest_hip_navatala_sparse_mg_prolongate_damped_f64;
    return true;
  }
  out = nullptr;
  return false;
...
bool tryGetKernelSource_hip_sparse_mg(const std::string& backend, const std::string& kernelName, GpuRuntime::ProgramSource& out) {
  if (backend == "hip" && kernelName == "navatala_sparse_mg_restrict_f32") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_restrict_f32);
  ...
  if (backend == "hip" && kernelName == "navatala_sparse_mg_restrict_f64") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_restrict_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_prolongate_f32") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_prolongate_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_prolongate_f64") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_prolongate_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_convergence_absolute_f32") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_convergence_absolute_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_convergence_relative_f32") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_convergence_relative_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_convergence_absolute_f64") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_convergence_absolute_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_convergence_relative_f64") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_convergence_relative_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_compute_residual_f32") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_compute_residual_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_compute_residual_f64") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_compute_residual_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_weighted_restrict_f32") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_weighted_restrict_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_weighted_restrict_f64") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_weighted_restrict_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_error_norm_partials_f32") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_error_norm_partials_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_error_norm_partials_f64") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_error_norm_partials_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_zero_vector_f32") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_zero_vector_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_zero_vector_f64") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_zero_vector_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_prolongate_damped_f32") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_prolongate_damped_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_sparse_mg_prolongate_damped_f64") {
    ...
    std::string_view sv(k_hip_navatala_sparse_mg_prolongate_damped_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  return false;
