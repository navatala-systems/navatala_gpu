...
// Kernel registry partition for the `cuda_sparse_knn` bucket. Compiles
...
const char* k_cuda_navatala_sparse_knn_sparse_k_n_n_distance_f32 = R"kernel(
...
const char* k_cuda_navatala_sparse_knn_sparse_k_n_n_distance_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_sparse_knn_sparse_inner_product_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_sparse_knn_sparse_inner_product_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_sparse_knn_sparse_top_k_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_sparse_knn_sparse_top_k_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_sparse_knn_csr_row_distance_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_sparse_knn_csr_row_distance_f64 = R"kernel(
#include <cuda_runtime.h>
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_sparse_knn_sparse_k_n_n_distance_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_sparse_knn_sparse_k_n_n_distance_f32 = {
  1,
  "navatala_sparse_knn_sparse_k_n_n_distance_f32",
  "cuda",
  "navatala_sparse_knn_sparse_k_n_n_distance_f32",
  "kernel:cuda:navatala_sparse_knn_sparse_k_n_n_distance_f32",
  "abi-r1:cuda:navatala_sparse_knn_sparse_k_n_n_distance_f32",
  "abi-r1:cuda:navatala_sparse_knn_sparse_k_n_n_distance_f32",
  9,
  kAbiArgs_cuda_navatala_sparse_knn_sparse_k_n_n_distance_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_sparse_knn_sparse_k_n_n_distance_f64[] = {
  { "queryData", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "queryIndices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "queryStart", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "queryEnd", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_sparse_knn_sparse_k_n_n_distance_f64 = {
  1,
  "navatala_sparse_knn_sparse_k_n_n_distance_f64",
  "cuda",
  "navatala_sparse_knn_sparse_k_n_n_distance_f64",
  "kernel:cuda:navatala_sparse_knn_sparse_k_n_n_distance_f64",
  "abi-r1:cuda:navatala_sparse_knn_sparse_k_n_n_distance_f64",
  "abi-r1:cuda:navatala_sparse_knn_sparse_k_n_n_distance_f64",
  9,
  kAbiArgs_cuda_navatala_sparse_knn_sparse_k_n_n_distance_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_sparse_knn_sparse_inner_product_f32[] = {
  { "queryData", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "queryIndices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "queryStart", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "queryEnd", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_sparse_knn_sparse_inner_product_f32 = {
  1,
  "navatala_sparse_knn_sparse_inner_product_f32",
  "cuda",
  "navatala_sparse_knn_sparse_inner_product_f32",
  "kernel:cuda:navatala_sparse_knn_sparse_inner_product_f32",
  "abi-r1:cuda:navatala_sparse_knn_sparse_inner_product_f32",
  "abi-r1:cuda:navatala_sparse_knn_sparse_inner_product_f32",
  9,
  kAbiArgs_cuda_navatala_sparse_knn_sparse_inner_product_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_sparse_knn_sparse_inner_product_f64[] = {
  { "queryData", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "queryIndices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "queryStart", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "queryEnd", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_sparse_knn_sparse_inner_product_f64 = {
  1,
  "navatala_sparse_knn_sparse_inner_product_f64",
  "cuda",
  "navatala_sparse_knn_sparse_inner_product_f64",
  "kernel:cuda:navatala_sparse_knn_sparse_inner_product_f64",
  "abi-r1:cuda:navatala_sparse_knn_sparse_inner_product_f64",
  "abi-r1:cuda:navatala_sparse_knn_sparse_inner_product_f64",
  9,
  kAbiArgs_cuda_navatala_sparse_knn_sparse_inner_product_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_sparse_knn_sparse_top_k_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_sparse_knn_sparse_top_k_f32 = {
  1,
  "navatala_sparse_knn_sparse_top_k_f32",
  "cuda",
  "navatala_sparse_knn_sparse_top_k_f32",
  "kernel:cuda:navatala_sparse_knn_sparse_top_k_f32",
  "abi-r1:cuda:navatala_sparse_knn_sparse_top_k_f32",
  "abi-r1:cuda:navatala_sparse_knn_sparse_top_k_f32",
  5,
  kAbiArgs_cuda_navatala_sparse_knn_sparse_top_k_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_sparse_knn_sparse_top_k_f64[] = {
  { "distances", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "nIdxRows", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "k", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "outDistances", 3, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_sparse_knn_sparse_top_k_f64 = {
  1,
  "navatala_sparse_knn_sparse_top_k_f64",
  "cuda",
  "navatala_sparse_knn_sparse_top_k_f64",
  "kernel:cuda:navatala_sparse_knn_sparse_top_k_f64",
  "abi-r1:cuda:navatala_sparse_knn_sparse_top_k_f64",
  "abi-r1:cuda:navatala_sparse_knn_sparse_top_k_f64",
  5,
  kAbiArgs_cuda_navatala_sparse_knn_sparse_top_k_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_sparse_knn_csr_row_distance_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_sparse_knn_csr_row_distance_f32 = {
  1,
  "navatala_sparse_knn_csr_row_distance_f32",
  "cuda",
  "navatala_sparse_knn_csr_row_distance_f32",
  "kernel:cuda:navatala_sparse_knn_csr_row_distance_f32",
  "abi-r1:cuda:navatala_sparse_knn_csr_row_distance_f32",
  "abi-r1:cuda:navatala_sparse_knn_csr_row_distance_f32",
  7,
  kAbiArgs_cuda_navatala_sparse_knn_csr_row_distance_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_sparse_knn_csr_row_distance_f64[] = {
  { "sparseData", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "sparseIndices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "sparseStart", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "sparseEnd", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_sparse_knn_csr_row_distance_f64 = {
  1,
  "navatala_sparse_knn_csr_row_distance_f64",
  "cuda",
  "navatala_sparse_knn_csr_row_distance_f64",
  "kernel:cuda:navatala_sparse_knn_csr_row_distance_f64",
  "abi-r1:cuda:navatala_sparse_knn_csr_row_distance_f64",
  "abi-r1:cuda:navatala_sparse_knn_csr_row_distance_f64",
  7,
  kAbiArgs_cuda_navatala_sparse_knn_csr_row_distance_f64
};

bool tryGetKernelAbiManifest_cuda_sparse_knn(const std::string& backend, const std::string& kernelName, const KernelAbiManifestInfo*& out) {
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_sparse_k_n_n_distance_f32") {
    out = &kAbiManifest_cuda_navatala_sparse_knn_sparse_k_n_n_distance_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_sparse_k_n_n_distance_f64") {
    out = &kAbiManifest_cuda_navatala_sparse_knn_sparse_k_n_n_distance_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_sparse_inner_product_f32") {
    out = &kAbiManifest_cuda_navatala_sparse_knn_sparse_inner_product_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_sparse_inner_product_f64") {
    out = &kAbiManifest_cuda_navatala_sparse_knn_sparse_inner_product_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_sparse_top_k_f32") {
    out = &kAbiManifest_cuda_navatala_sparse_knn_sparse_top_k_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_sparse_top_k_f64") {
    out = &kAbiManifest_cuda_navatala_sparse_knn_sparse_top_k_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_csr_row_distance_f32") {
    out = &kAbiManifest_cuda_navatala_sparse_knn_csr_row_distance_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_csr_row_distance_f64") {
    out = &kAbiManifest_cuda_navatala_sparse_knn_csr_row_distance_f64;
    return true;
  }
  out = nullptr;
  return false;
...
bool tryGetKernelSource_cuda_sparse_knn(const std::string& backend, const std::string& kernelName, GpuRuntime::ProgramSource& out) {
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_sparse_k_n_n_distance_f32") {
    out.kind = GpuRuntime::ProgramSource::Kind::CudaCpp;
    out.entryPoint = "navatala_sparse_knn_sparse_k_n_n_distance_f32";
    std::string_view sv(k_cuda_navatala_sparse_knn_sparse_k_n_n_distance_f32);
  ...
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_sparse_k_n_n_distance_f64") {
    ...
    std::string_view sv(k_cuda_navatala_sparse_knn_sparse_k_n_n_distance_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_sparse_inner_product_f32") {
    ...
    std::string_view sv(k_cuda_navatala_sparse_knn_sparse_inner_product_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_sparse_inner_product_f64") {
    ...
    std::string_view sv(k_cuda_navatala_sparse_knn_sparse_inner_product_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_sparse_top_k_f32") {
    ...
    std::string_view sv(k_cuda_navatala_sparse_knn_sparse_top_k_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_sparse_top_k_f64") {
    ...
    std::string_view sv(k_cuda_navatala_sparse_knn_sparse_top_k_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_csr_row_distance_f32") {
    ...
    std::string_view sv(k_cuda_navatala_sparse_knn_csr_row_distance_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_sparse_knn_csr_row_distance_f64") {
    ...
    std::string_view sv(k_cuda_navatala_sparse_knn_csr_row_distance_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  return false;
