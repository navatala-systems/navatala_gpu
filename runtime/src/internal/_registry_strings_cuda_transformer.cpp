...
// Kernel registry partition for the `cuda_transformer` bucket. Compiles
...
const char* k_cuda_navatala_transformer_gelu_f32 = R"kernel(
...
const char* k_cuda_navatala_transformer_gelu_tanh_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_silu_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_relu_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_quick_gelu_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_squared_relu_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_bias_gelu_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_gelu_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_gelu_f16(const __half* _input, const unsigned int* count, __half* _output) {
  ...
  if (inBounds) {
    ...
    __half x2 = (x * x);
    __half x3 = (x2 * x);
    __half cubeTerm = (__float2half_rn(0.044715f) * x3);
    __half inner = (x + cubeTerm);
    __half tanhArg = (__float2half_rn(0.797885f) * inner);
    __half tanhVal = tanh(tanhArg);
    __half onePlusTanh = (__float2half_rn(1.000000f) + tanhVal);
    __half halfX = (__float2half_rn(0.500000f) * x);
...
const char* k_cuda_navatala_transformer_silu_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_silu_f16(const __half* _input, const unsigned int* count, __half* _output) {
  ...
  if (inBounds) {
    ...
    __half denom = (__float2half_rn(1.000000f) + expNegX);
...
const char* k_cuda_navatala_transformer_relu_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_relu_f16(const __half* _input, const unsigned int* count, __half* _output) {
  ...
  if (inBounds) {
    __half x = _input[gid];
    bool isPositive = (x > __float2half_rn(0.000000f));
    __half result = ((isPositive) ? (x) : (__float2half_rn(0.000000f)));
    _output[gid] = result;
  }
}

)kernel";
const char* k_cuda_navatala_transformer_quick_gelu_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_quick_gelu_f16(const __half* _input, const unsigned int* count, __half* _output) {
  ...
  if (inBounds) {
    __half x = _input[gid];
    __half scaled = (__float2half_rn(1.702000f) * x);
    __half negScaled = (-scaled);
    __half expNegScaled = exp(negScaled);
    __half denom = (__float2half_rn(1.000000f) + expNegScaled);
    __half sigmoid = (__float2half_rn(1.000000f) / denom);
...
const char* k_cuda_navatala_transformer_squared_relu_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_squared_relu_f16(const __half* _input, const unsigned int* count, __half* _output) {
  ...
  if (inBounds) {
    __half x = _input[gid];
    bool isPositive = (x > __float2half_rn(0.000000f));
    __half relu = ((isPositive) ? (x) : (__float2half_rn(0.000000f)));
...
const char* k_cuda_navatala_transformer_gelu_bf16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_bf16.h>
...
const char* k_cuda_navatala_transformer_silu_bf16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_bf16.h>
extern "C" __global__ void navatala_transformer_silu_bf16(const __nv_bfloat16* _input, const unsigned int* count, __nv_bfloat16* _output) {
  int gid0 = (int)(blockIdx.x * blockDim.x + threadIdx.x);
  unsigned int gid = ((unsigned int)((int)(blockIdx.x * blockDim.x + threadIdx.x)));
  unsigned int n = count[0u];
  bool inBounds = (gid < n);
...
const char* k_cuda_navatala_transformer_geglu_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_swiglu_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_reglu_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_geglu_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_geglu_f16(const __half* _input, const unsigned int* count, __half* _output) {
  ...
  if (inBounds) {
    ...
    __half cubeTerm = (__float2half_rn(0.044715f) * gate3);
    __half inner = (gate + cubeTerm);
    __half tanhArg = (__float2half_rn(0.797885f) * inner);
    __half tanhVal = tanh(tanhArg);
    __half onePlusTanh = (__float2half_rn(1.000000f) + tanhVal);
    __half halfGate = (__float2half_rn(0.500000f) * gate);
...
const char* k_cuda_navatala_transformer_swiglu_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_swiglu_f16(const __half* _input, const unsigned int* count, __half* _output) {
  ...
  if (inBounds) {
    ...
    __half denom = (__float2half_rn(1.000000f) + expNegGate);
...
const char* k_cuda_navatala_transformer_reglu_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_reglu_f16(const __half* _input, const unsigned int* count, __half* _output) {
  ...
  if (inBounds) {
    ...
    unsigned int valueIdx = (gid + hidden);
    __half value = _input[valueIdx];
    bool isPositive = (gate > __float2half_rn(0.000000f));
    __half reluGate = ((isPositive) ? (gate) : (__float2half_rn(0.000000f)));
...
const char* k_cuda_navatala_transformer_gelu_backward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_silu_backward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_relu_backward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_quick_gelu_backward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_gelu_backward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_silu_backward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_relu_backward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_relu_backward_f16(const __half* _input, const __half* gradOutput, const unsigned int* count, __half* gradInput) {
  ...
  if (inBounds) {
    ...
    __half dy = gradOutput[gid];
    bool isPositive = (x > __float2half_rn(0.000000f));
    __half dx = ((isPositive) ? (dy) : (__float2half_rn(0.000000f)));
    gradInput[gid] = dx;
  }
}

)kernel";
const char* k_cuda_navatala_transformer_quick_gelu_backward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_rms_norm_forward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_rms_norm_forward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_rms_norm_forward_bf16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_bf16.h>
extern "C" __global__ void navatala_transformer_rms_norm_forward_bf16(const __nv_bfloat16* _input, const __nv_bfloat16* gamma, const float* epsilon, const unsigned int* batchSize, const unsigned int* hiddenSize, __nv_bfloat16* _output) {
  int gid0 = (int)(blockIdx.x * blockDim.x + threadIdx.x);
  unsigned int lid = ((unsigned int)((int)(threadIdx.x)));
  unsigned int batchIdx = ((unsigned int)((int)(blockIdx.x)));
  unsigned int bs = batchSize[0u];
  ...
  bool hiddenValid = (lid < hs);
  unsigned int globalIdx = ((batchIdx * hs) + lid);
  __nv_bfloat16 xBF16 = (((batchValid && hiddenValid)) ? (_input[globalIdx]) : (__float2bfloat16(0.000000f)));
  float x = ((float)(xBF16));
  float xSq = (x * x);
  sumSq[lid] = ((hiddenValid) ? (xSq) : (__uint_as_float(0x00000000u)));
  __syncthreads();
...
const char* k_cuda_navatala_transformer_layer_norm_forward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_layer_norm_forward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_layer_norm_forward_bf16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_bf16.h>
extern "C" __global__ void navatala_transformer_layer_norm_forward_bf16(const __nv_bfloat16* _input, const __nv_bfloat16* gamma, const __nv_bfloat16* beta, const float* epsilon, const unsigned int* batchSize, const unsigned int* hiddenSize, __nv_bfloat16* _output) {
  int gid0 = (int)(blockIdx.x * blockDim.x + threadIdx.x);
  unsigned int lid = ((unsigned int)((int)(threadIdx.x)));
  unsigned int batchIdx = ((unsigned int)((int)(blockIdx.x)));
  unsigned int bs = batchSize[0u];
...
const char* k_cuda_navatala_transformer_layer_norm_backward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_layer_norm_backward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_rms_norm_backward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_rms_norm_backward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_layer_norm_multi_pass_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_layer_norm_multi_pass_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_rms_norm_multi_pass_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_rms_norm_multi_pass_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_softmax_forward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_softmax_forward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_softmax_forward_f16(const __half* _input, const unsigned int* batchSize, const unsigned int* seqLen, __half* _output) {
  ...
  bool seqValid = (lid < sl);
  unsigned int globalIdx = ((batchIdx * sl) + lid);
  __half xF16 = (((batchValid && seqValid)) ? (_input[globalIdx]) : (__float2half_rn(0.000000f)));
...
const char* k_cuda_navatala_transformer_softmax_forward_bf16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_bf16.h>
extern "C" __global__ void navatala_transformer_softmax_forward_bf16(const __nv_bfloat16* _input, const unsigned int* batchSize, const unsigned int* seqLen, __nv_bfloat16* _output) {
  int gid0 = (int)(blockIdx.x * blockDim.x + threadIdx.x);
  unsigned int lid = ((unsigned int)((int)(threadIdx.x)));
  unsigned int batchIdx = ((unsigned int)((int)(blockIdx.x)));
  unsigned int bs = batchSize[0u];
  ...
  bool seqValid = (lid < sl);
  unsigned int globalIdx = ((batchIdx * sl) + lid);
  __nv_bfloat16 xBF16 = (((batchValid && seqValid)) ? (_input[globalIdx]) : (__float2bfloat16(0.000000f)));
...
const char* k_cuda_navatala_transformer_softmax_backward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_softmax_backward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_softmax_backward_f16(const __half* _output, const __half* gradOutput, const unsigned int* batchSize, const unsigned int* seqLen, __half* gradInput) {
  ...
  bool seqValid = (lid < sl);
  unsigned int globalIdx = ((batchIdx * sl) + lid);
  __half yF16 = (((batchValid && seqValid)) ? (_output[globalIdx]) : (__float2half_rn(0.000000f)));
  __half dyF16 = (((batchValid && seqValid)) ? (gradOutput[globalIdx]) : (__float2half_rn(0.000000f)));
  float y = ((float)(yF16));
  float dy = ((float)(dyF16));
  float yDy = (y * dy);
  dotBuf[lid] = yDy;
...
const char* k_cuda_navatala_transformer_softmax_with_mask_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_softmax_with_mask_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_softmax_with_mask_f16(const __half* _input, const unsigned int* batchSize, const unsigned int* seqLen, const bool* isCausal, __half* _output) {
  ...
  unsigned int row = (rowIdx % sl);
  unsigned int globalIdx = ((rowIdx * sl) + lid);
  __half rawXF16 = ((valid) ? (_input[globalIdx]) : (__float2half_rn(0.000000f)));
...
const char* k_cuda_navatala_transformer_softmax_with_mask_backward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_softmax_with_mask_backward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_softmax_with_mask_backward_f16(const __half* _output, const __half* gradOutput, const unsigned int* batchSize, const unsigned int* seqLen, const bool* isCausal, __half* gradInput) {
  ...
  bool isMasked = (causal && (col > row));
  unsigned int globalIdx = ((rowIdx * sl) + lid);
  __half yF16 = ((valid) ? (_output[globalIdx]) : (__float2half_rn(0.000000f)));
  __half dyF16 = ((valid) ? (gradOutput[globalIdx]) : (__float2half_rn(0.000000f)));
  float y = ((float)(yF16));
  float dy = ((float)(dyF16));
  float yDy = ((isMasked) ? (__uint_as_float(0x00000000u)) : ((y * dy)));
  dotBuf[lid] = yDy;
...
const char* k_cuda_navatala_transformer_softmax_multi_pass_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_softmax_multi_pass_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_cast_f32_to_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_cast_f16_to_f32 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_cast_f32_to_bf16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_bf16.h>
extern "C" __global__ void navatala_transformer_cast_f32_to_bf16(const float* _input, const unsigned int* count, __nv_bfloat16* _output) {
  int gid0 = (int)(blockIdx.x * blockDim.x + threadIdx.x);
  unsigned int gid = ((unsigned int)((int)(blockIdx.x * blockDim.x + threadIdx.x)));
  unsigned int n = count[0u];
  bool inBounds = (gid < n);
  if (inBounds) {
    float x = _input[gid];
    __nv_bfloat16 result = ((__nv_bfloat16)(x));
    _output[gid] = result;
  }
}

)kernel";
const char* k_cuda_navatala_transformer_cast_b_f16_to_f32 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_bf16.h>
extern "C" __global__ void navatala_transformer_cast_b_f16_to_f32(const __nv_bfloat16* _input, const unsigned int* count, float* _output) {
  int gid0 = (int)(blockIdx.x * blockDim.x + threadIdx.x);
  unsigned int gid = ((unsigned int)((int)(blockIdx.x * blockDim.x + threadIdx.x)));
  unsigned int n = count[0u];
  bool inBounds = (gid < n);
...
const char* k_cuda_navatala_transformer_transpose_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_transpose_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_fused_cast_transpose_f32_to_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_cast_f32_to_f_p8_e4_m3 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_cast_f_p8_e4_m3_to_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_cast_f32_to_f_p8_e5_m2 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_cast_f_p8_e5_m2_to_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_fused_cast_transpose_f_p8 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_transpose4_d_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_transpose4_d_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_dropout_forward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_dropout_forward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_dropout_backward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_dropout_backward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_rope_forward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_rope_forward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_rope_forward_bf16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_bf16.h>
extern "C" __global__ void navatala_transformer_rope_forward_bf16(const __nv_bfloat16* _input, const unsigned int* positions, const unsigned int* batchSize, const unsigned int* seqLen, const unsigned int* headDim, const float* base, __nv_bfloat16* _output) {
  int gid0 = (int)(blockIdx.x * blockDim.x + threadIdx.x);
  unsigned int gid = ((unsigned int)((int)(blockIdx.x * blockDim.x + threadIdx.x)));
  unsigned int bs = batchSize[0u];
  unsigned int sl = seqLen[0u];
  ...
  if (inBounds) {
    ...
    unsigned int idx0 = (baseOffset + (seqOffset + dim0));
    unsigned int idx1 = (baseOffset + (seqOffset + dim1));
    __nv_bfloat16 x0BF16 = _input[idx0];
    __nv_bfloat16 x1BF16 = _input[idx1];
    ...
    float x1Cos = (x1 * cosTheta);
    float y1F32 = (x0Sin + x1Cos);
    __nv_bfloat16 y0 = ((__nv_bfloat16)(y0F32));
    __nv_bfloat16 y1 = ((__nv_bfloat16)(y1F32));
    _output[idx0] = y0;
    _output[idx1] = y1;
  }
}
...
const char* k_cuda_navatala_transformer_rope_with_cache_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_rope_backward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_rope_backward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_rope_backward_bf16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_bf16.h>
extern "C" __global__ void navatala_transformer_rope_backward_bf16(const __nv_bfloat16* gradOutput, const unsigned int* positions, const unsigned int* batchSize, const unsigned int* seqLen, const unsigned int* headDim, const float* base, __nv_bfloat16* gradInput) {
  int gid0 = (int)(blockIdx.x * blockDim.x + threadIdx.x);
  unsigned int gid = ((unsigned int)((int)(blockIdx.x * blockDim.x + threadIdx.x)));
  unsigned int bs = batchSize[0u];
  unsigned int sl = seqLen[0u];
  ...
  if (inBounds) {
    ...
    unsigned int idx0 = (baseOffset + (seqOffset + dim0));
    unsigned int idx1 = (baseOffset + (seqOffset + dim1));
    __nv_bfloat16 dy0BF16 = gradOutput[idx0];
    __nv_bfloat16 dy1BF16 = gradOutput[idx1];
    ...
    float negDy0Sin = (__uint_as_float(0x00000000u) - dy0Sin);
    float dx1F32 = (negDy0Sin + dy1Cos);
    __nv_bfloat16 dx0 = ((__nv_bfloat16)(dx0F32));
    __nv_bfloat16 dx1 = ((__nv_bfloat16)(dx1F32));
    gradInput[idx0] = dx0;
    gradInput[idx1] = dx1;
  }
}
...
const char* k_cuda_navatala_transformer_rope_interleaved_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_rope_interleaved_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_rope_interleaved_bf16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_bf16.h>
extern "C" __global__ void navatala_transformer_rope_interleaved_bf16(const __nv_bfloat16* _input, const unsigned int* positions, const unsigned int* batchSize, const unsigned int* seqLen, const unsigned int* headDim, const float* base, __nv_bfloat16* _output) {
  int gid0 = (int)(blockIdx.x * blockDim.x + threadIdx.x);
  unsigned int gid = ((unsigned int)((int)(blockIdx.x * blockDim.x + threadIdx.x)));
  unsigned int bs = batchSize[0u];
  unsigned int sl = seqLen[0u];
...
const char* k_cuda_navatala_transformer_simple_attention_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_simple_attention_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_paged_attention_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_simple_attention_with_mask_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_simple_attention_with_mask_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_simple_attention_with_padding_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_simple_attention_with_padding_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_simple_attention_backward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_simple_attention_backward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_kv_cache_append_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_kv_cache_append_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_kv_cache_rotate_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_tiled_gemm_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_tiled_gemm_f16(const __half* a, const __half* b, const unsigned int* m, const unsigned int* n, const unsigned int* k, const float* alpha, const float* beta, __half* c) {
  ...
  for (int tileIter = 0; tileIter < (int)(tileCount); ++tileIter) {
    ...
    __half aValF16 = ((aLoadValid) ? (a[aIdx]) : (__float2half_rn(0.000000f)));
    __half bValF16 = ((bLoadValid) ? (b[bIdx]) : (__float2half_rn(0.000000f)));
...
const char* k_cuda_navatala_transformer_tiled_gemm_f16_f32_out = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_tiled_gemm_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_tiled_gemm_backward_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_tiled_gemm_backward_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_multi_tensor_scale_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_multi_tensor_scale_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_multi_tensor_add_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_multi_tensor_add_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_multi_tensor_copy_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_multi_tensor_copy_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_multi_tensor_l2_norm_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_multi_tensor_l2_norm_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_multi_tensor_clip_grad_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_multi_tensor_clip_grad_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_top_k_gating_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_top_k_gating_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_top_k_gating_f16(const __half* routerLogits, const unsigned int* numTokens, const unsigned int* numExperts, const unsigned int* topK, int* expertIndices, __half* expertWeights) {
  ...
  bool valid = (tokenValid && expertValid);
  unsigned int globalIdx = ((tokenIdx * ne) + lid);
  __half logitF16 = ((valid) ? (routerLogits[globalIdx]) : (__float2half_rn(0.000000f)));
  ...
  __syncthreads();
  float maxLogit = logitsBuf[0u];
  __half originalLogitF16 = ((valid) ? (routerLogits[globalIdx]) : (__float2half_rn(0.000000f)));
...
const char* k_cuda_navatala_transformer_expert_capacity_mask_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_expert_capacity_mask_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_expert_capacity_mask_f16(const int* expertIndices, const unsigned int* numTokens, const unsigned int* numExperts, const unsigned int* topK, const unsigned int* capacity, __half* mask) {
  ...
  if (valid) {
    ...
    if (expertIdxValid) {
      unsigned int prevCount = atomicAdd(&(expertCounts[expertIdxU32]), 1u);
      bool withinCapacity = (prevCount < cap);
      __half maskVal = ((withinCapacity) ? (__float2half_rn(1.000000f)) : (__float2half_rn(0.000000f)));
      mask[gid] = maskVal;
    } else {
      mask[gid] = __float2half_rn(0.000000f);
    }
  }
}

)kernel";
const char* k_cuda_navatala_transformer_permute_tokens_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_permute_tokens_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_unpermute_tokens_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_unpermute_tokens_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_pad_sequence_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_pad_sequence_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_pad_sequence_f16(const __half* _input, const unsigned int* seqLengths, const unsigned int* seqOffsets, const unsigned int* batchSize, const unsigned int* maxSeqLen, const unsigned int* hiddenSize, __half* _output) {
  ...
  if (inBounds) {
    ...
    if (isValid) {
      ...
      _output[gid] = __float2half_rn(0.000000f);
    }
  }
}

)kernel";
const char* k_cuda_navatala_transformer_unpad_sequence_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_unpad_sequence_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_swizzle_layout_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_swizzle_layout_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_hadamard_transform_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_hadamard_transform_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_permute_axes_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_permute_axes_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_pack_sequences_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_pack_sequences_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_unpack_sequences_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_unpack_sequences_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_transformer_generate_position_ids_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_generate_position_ids_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_generate_causal_mask_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_generate_causal_mask_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
extern "C" __global__ void navatala_transformer_generate_causal_mask_f16(const unsigned int* seqLen, __half* _output) {
  ...
  if (inBounds) {
    ...
    if (canAttend) {
      ...
      _output[gid] = __float2half_rn(-65000.000000f);
    }
  }
}

)kernel";
const char* k_cuda_navatala_transformer_precompute_rotary_emb_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_transformer_precompute_rotary_emb_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_gelu_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_gelu_f32 = {
  1,
  "navatala_transformer_gelu_f32",
  "cuda",
  "navatala_transformer_gelu_f32",
  "kernel:cuda:navatala_transformer_gelu_f32",
  "abi-r1:cuda:navatala_transformer_gelu_f32",
  "abi-r1:cuda:navatala_transformer_gelu_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_gelu_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_gelu_tanh_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_gelu_tanh_f32 = {
  1,
  "navatala_transformer_gelu_tanh_f32",
  "cuda",
  "navatala_transformer_gelu_tanh_f32",
  "kernel:cuda:navatala_transformer_gelu_tanh_f32",
  "abi-r1:cuda:navatala_transformer_gelu_tanh_f32",
  "abi-r1:cuda:navatala_transformer_gelu_tanh_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_gelu_tanh_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_silu_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_silu_f32 = {
  1,
  "navatala_transformer_silu_f32",
  "cuda",
  "navatala_transformer_silu_f32",
  "kernel:cuda:navatala_transformer_silu_f32",
  "abi-r1:cuda:navatala_transformer_silu_f32",
  "abi-r1:cuda:navatala_transformer_silu_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_silu_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_relu_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_relu_f32 = {
  1,
  "navatala_transformer_relu_f32",
  "cuda",
  "navatala_transformer_relu_f32",
  "kernel:cuda:navatala_transformer_relu_f32",
  "abi-r1:cuda:navatala_transformer_relu_f32",
  "abi-r1:cuda:navatala_transformer_relu_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_relu_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_quick_gelu_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_quick_gelu_f32 = {
  1,
  "navatala_transformer_quick_gelu_f32",
  "cuda",
  "navatala_transformer_quick_gelu_f32",
  "kernel:cuda:navatala_transformer_quick_gelu_f32",
  "abi-r1:cuda:navatala_transformer_quick_gelu_f32",
  "abi-r1:cuda:navatala_transformer_quick_gelu_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_quick_gelu_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_squared_relu_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_squared_relu_f32 = {
  1,
  "navatala_transformer_squared_relu_f32",
  "cuda",
  "navatala_transformer_squared_relu_f32",
  "kernel:cuda:navatala_transformer_squared_relu_f32",
  "abi-r1:cuda:navatala_transformer_squared_relu_f32",
  "abi-r1:cuda:navatala_transformer_squared_relu_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_squared_relu_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_bias_gelu_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_bias_gelu_f32 = {
  1,
  "navatala_transformer_bias_gelu_f32",
  "cuda",
  "navatala_transformer_bias_gelu_f32",
  "kernel:cuda:navatala_transformer_bias_gelu_f32",
  "abi-r1:cuda:navatala_transformer_bias_gelu_f32",
  "abi-r1:cuda:navatala_transformer_bias_gelu_f32",
  5,
  kAbiArgs_cuda_navatala_transformer_bias_gelu_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_gelu_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_gelu_f16 = {
  1,
  "navatala_transformer_gelu_f16",
  "cuda",
  "navatala_transformer_gelu_f16",
  "kernel:cuda:navatala_transformer_gelu_f16",
  "abi-r1:cuda:navatala_transformer_gelu_f16",
  "abi-r1:cuda:navatala_transformer_gelu_f16",
  3,
  kAbiArgs_cuda_navatala_transformer_gelu_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_silu_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_silu_f16 = {
  1,
  "navatala_transformer_silu_f16",
  "cuda",
  "navatala_transformer_silu_f16",
  "kernel:cuda:navatala_transformer_silu_f16",
  "abi-r1:cuda:navatala_transformer_silu_f16",
  "abi-r1:cuda:navatala_transformer_silu_f16",
  3,
  kAbiArgs_cuda_navatala_transformer_silu_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_relu_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_relu_f16 = {
  1,
  "navatala_transformer_relu_f16",
  "cuda",
  "navatala_transformer_relu_f16",
  "kernel:cuda:navatala_transformer_relu_f16",
  "abi-r1:cuda:navatala_transformer_relu_f16",
  "abi-r1:cuda:navatala_transformer_relu_f16",
  3,
  kAbiArgs_cuda_navatala_transformer_relu_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_quick_gelu_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_quick_gelu_f16 = {
  1,
  "navatala_transformer_quick_gelu_f16",
  "cuda",
  "navatala_transformer_quick_gelu_f16",
  "kernel:cuda:navatala_transformer_quick_gelu_f16",
  "abi-r1:cuda:navatala_transformer_quick_gelu_f16",
  "abi-r1:cuda:navatala_transformer_quick_gelu_f16",
  3,
  kAbiArgs_cuda_navatala_transformer_quick_gelu_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_squared_relu_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_squared_relu_f16 = {
  1,
  "navatala_transformer_squared_relu_f16",
  "cuda",
  "navatala_transformer_squared_relu_f16",
  "kernel:cuda:navatala_transformer_squared_relu_f16",
  "abi-r1:cuda:navatala_transformer_squared_relu_f16",
  "abi-r1:cuda:navatala_transformer_squared_relu_f16",
  3,
  kAbiArgs_cuda_navatala_transformer_squared_relu_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_gelu_bf16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_gelu_bf16 = {
  1,
  "navatala_transformer_gelu_bf16",
  "cuda",
  "navatala_transformer_gelu_bf16",
  "kernel:cuda:navatala_transformer_gelu_bf16",
  "abi-r1:cuda:navatala_transformer_gelu_bf16",
  "abi-r1:cuda:navatala_transformer_gelu_bf16",
  3,
  kAbiArgs_cuda_navatala_transformer_gelu_bf16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_silu_bf16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_silu_bf16 = {
  1,
  "navatala_transformer_silu_bf16",
  "cuda",
  "navatala_transformer_silu_bf16",
  "kernel:cuda:navatala_transformer_silu_bf16",
  "abi-r1:cuda:navatala_transformer_silu_bf16",
  "abi-r1:cuda:navatala_transformer_silu_bf16",
  3,
  kAbiArgs_cuda_navatala_transformer_silu_bf16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_geglu_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_geglu_f32 = {
  1,
  "navatala_transformer_geglu_f32",
  "cuda",
  "navatala_transformer_geglu_f32",
  "kernel:cuda:navatala_transformer_geglu_f32",
  "abi-r1:cuda:navatala_transformer_geglu_f32",
  "abi-r1:cuda:navatala_transformer_geglu_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_geglu_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_swiglu_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_swiglu_f32 = {
  1,
  "navatala_transformer_swiglu_f32",
  "cuda",
  "navatala_transformer_swiglu_f32",
  "kernel:cuda:navatala_transformer_swiglu_f32",
  "abi-r1:cuda:navatala_transformer_swiglu_f32",
  "abi-r1:cuda:navatala_transformer_swiglu_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_swiglu_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_reglu_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_reglu_f32 = {
  1,
  "navatala_transformer_reglu_f32",
  "cuda",
  "navatala_transformer_reglu_f32",
  "kernel:cuda:navatala_transformer_reglu_f32",
  "abi-r1:cuda:navatala_transformer_reglu_f32",
  "abi-r1:cuda:navatala_transformer_reglu_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_reglu_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_geglu_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_geglu_f16 = {
  1,
  "navatala_transformer_geglu_f16",
  "cuda",
  "navatala_transformer_geglu_f16",
  "kernel:cuda:navatala_transformer_geglu_f16",
  "abi-r1:cuda:navatala_transformer_geglu_f16",
  "abi-r1:cuda:navatala_transformer_geglu_f16",
  3,
  kAbiArgs_cuda_navatala_transformer_geglu_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_swiglu_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_swiglu_f16 = {
  1,
  "navatala_transformer_swiglu_f16",
  "cuda",
  "navatala_transformer_swiglu_f16",
  "kernel:cuda:navatala_transformer_swiglu_f16",
  "abi-r1:cuda:navatala_transformer_swiglu_f16",
  "abi-r1:cuda:navatala_transformer_swiglu_f16",
  3,
  kAbiArgs_cuda_navatala_transformer_swiglu_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_reglu_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_reglu_f16 = {
  1,
  "navatala_transformer_reglu_f16",
  "cuda",
  "navatala_transformer_reglu_f16",
  "kernel:cuda:navatala_transformer_reglu_f16",
  "abi-r1:cuda:navatala_transformer_reglu_f16",
  "abi-r1:cuda:navatala_transformer_reglu_f16",
  3,
  kAbiArgs_cuda_navatala_transformer_reglu_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_gelu_backward_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_gelu_backward_f32 = {
  1,
  "navatala_transformer_gelu_backward_f32",
  "cuda",
  "navatala_transformer_gelu_backward_f32",
  "kernel:cuda:navatala_transformer_gelu_backward_f32",
  "abi-r1:cuda:navatala_transformer_gelu_backward_f32",
  "abi-r1:cuda:navatala_transformer_gelu_backward_f32",
  4,
  kAbiArgs_cuda_navatala_transformer_gelu_backward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_silu_backward_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "gradInput", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_silu_backward_f32 = {
  1,
  "navatala_transformer_silu_backward_f32",
  "cuda",
  "navatala_transformer_silu_backward_f32",
  "kernel:cuda:navatala_transformer_silu_backward_f32",
  "abi-r1:cuda:navatala_transformer_silu_backward_f32",
  "abi-r1:cuda:navatala_transformer_silu_backward_f32",
  4,
  kAbiArgs_cuda_navatala_transformer_silu_backward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_relu_backward_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "gradInput", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_relu_backward_f32 = {
  1,
  "navatala_transformer_relu_backward_f32",
  "cuda",
  "navatala_transformer_relu_backward_f32",
  "kernel:cuda:navatala_transformer_relu_backward_f32",
  "abi-r1:cuda:navatala_transformer_relu_backward_f32",
  "abi-r1:cuda:navatala_transformer_relu_backward_f32",
  4,
  kAbiArgs_cuda_navatala_transformer_relu_backward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_quick_gelu_backward_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "gradInput", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_quick_gelu_backward_f32 = {
  1,
  "navatala_transformer_quick_gelu_backward_f32",
  "cuda",
  "navatala_transformer_quick_gelu_backward_f32",
  "kernel:cuda:navatala_transformer_quick_gelu_backward_f32",
  "abi-r1:cuda:navatala_transformer_quick_gelu_backward_f32",
  "abi-r1:cuda:navatala_transformer_quick_gelu_backward_f32",
  4,
  kAbiArgs_cuda_navatala_transformer_quick_gelu_backward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_gelu_backward_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "gradInput", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_gelu_backward_f16 = {
  1,
  "navatala_transformer_gelu_backward_f16",
  "cuda",
  "navatala_transformer_gelu_backward_f16",
  "kernel:cuda:navatala_transformer_gelu_backward_f16",
  "abi-r1:cuda:navatala_transformer_gelu_backward_f16",
  "abi-r1:cuda:navatala_transformer_gelu_backward_f16",
  4,
  kAbiArgs_cuda_navatala_transformer_gelu_backward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_silu_backward_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "gradInput", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_silu_backward_f16 = {
  1,
  "navatala_transformer_silu_backward_f16",
  "cuda",
  "navatala_transformer_silu_backward_f16",
  "kernel:cuda:navatala_transformer_silu_backward_f16",
  "abi-r1:cuda:navatala_transformer_silu_backward_f16",
  "abi-r1:cuda:navatala_transformer_silu_backward_f16",
  4,
  kAbiArgs_cuda_navatala_transformer_silu_backward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_relu_backward_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "gradInput", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_relu_backward_f16 = {
  1,
  "navatala_transformer_relu_backward_f16",
  "cuda",
  "navatala_transformer_relu_backward_f16",
  "kernel:cuda:navatala_transformer_relu_backward_f16",
  "abi-r1:cuda:navatala_transformer_relu_backward_f16",
  "abi-r1:cuda:navatala_transformer_relu_backward_f16",
  4,
  kAbiArgs_cuda_navatala_transformer_relu_backward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_quick_gelu_backward_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "gradInput", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_quick_gelu_backward_f16 = {
  1,
  "navatala_transformer_quick_gelu_backward_f16",
  "cuda",
  "navatala_transformer_quick_gelu_backward_f16",
  "kernel:cuda:navatala_transformer_quick_gelu_backward_f16",
  "abi-r1:cuda:navatala_transformer_quick_gelu_backward_f16",
  "abi-r1:cuda:navatala_transformer_quick_gelu_backward_f16",
  4,
  kAbiArgs_cuda_navatala_transformer_quick_gelu_backward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rms_norm_forward_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rms_norm_forward_f32 = {
  1,
  "navatala_transformer_rms_norm_forward_f32",
  "cuda",
  "navatala_transformer_rms_norm_forward_f32",
  "kernel:cuda:navatala_transformer_rms_norm_forward_f32",
  "abi-r1:cuda:navatala_transformer_rms_norm_forward_f32",
  "abi-r1:cuda:navatala_transformer_rms_norm_forward_f32",
  6,
  kAbiArgs_cuda_navatala_transformer_rms_norm_forward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rms_norm_forward_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gamma", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "epsilon", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rms_norm_forward_f16 = {
  1,
  "navatala_transformer_rms_norm_forward_f16",
  "cuda",
  "navatala_transformer_rms_norm_forward_f16",
  "kernel:cuda:navatala_transformer_rms_norm_forward_f16",
  "abi-r1:cuda:navatala_transformer_rms_norm_forward_f16",
  "abi-r1:cuda:navatala_transformer_rms_norm_forward_f16",
  6,
  kAbiArgs_cuda_navatala_transformer_rms_norm_forward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rms_norm_forward_bf16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gamma", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "epsilon", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rms_norm_forward_bf16 = {
  1,
  "navatala_transformer_rms_norm_forward_bf16",
  "cuda",
  "navatala_transformer_rms_norm_forward_bf16",
  "kernel:cuda:navatala_transformer_rms_norm_forward_bf16",
  "abi-r1:cuda:navatala_transformer_rms_norm_forward_bf16",
  "abi-r1:cuda:navatala_transformer_rms_norm_forward_bf16",
  6,
  kAbiArgs_cuda_navatala_transformer_rms_norm_forward_bf16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_layer_norm_forward_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gamma", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_layer_norm_forward_f32 = {
  1,
  "navatala_transformer_layer_norm_forward_f32",
  "cuda",
  "navatala_transformer_layer_norm_forward_f32",
  "kernel:cuda:navatala_transformer_layer_norm_forward_f32",
  "abi-r1:cuda:navatala_transformer_layer_norm_forward_f32",
  "abi-r1:cuda:navatala_transformer_layer_norm_forward_f32",
  7,
  kAbiArgs_cuda_navatala_transformer_layer_norm_forward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_layer_norm_forward_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gamma", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "beta", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "epsilon", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_layer_norm_forward_f16 = {
  1,
  "navatala_transformer_layer_norm_forward_f16",
  "cuda",
  "navatala_transformer_layer_norm_forward_f16",
  "kernel:cuda:navatala_transformer_layer_norm_forward_f16",
  "abi-r1:cuda:navatala_transformer_layer_norm_forward_f16",
  "abi-r1:cuda:navatala_transformer_layer_norm_forward_f16",
  7,
  kAbiArgs_cuda_navatala_transformer_layer_norm_forward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_layer_norm_forward_bf16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gamma", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "beta", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "epsilon", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_layer_norm_forward_bf16 = {
  1,
  "navatala_transformer_layer_norm_forward_bf16",
  "cuda",
  "navatala_transformer_layer_norm_forward_bf16",
  "kernel:cuda:navatala_transformer_layer_norm_forward_bf16",
  "abi-r1:cuda:navatala_transformer_layer_norm_forward_bf16",
  "abi-r1:cuda:navatala_transformer_layer_norm_forward_bf16",
  7,
  kAbiArgs_cuda_navatala_transformer_layer_norm_forward_bf16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_layer_norm_backward_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_layer_norm_backward_f32 = {
  1,
  "navatala_transformer_layer_norm_backward_f32",
  "cuda",
  "navatala_transformer_layer_norm_backward_f32",
  "kernel:cuda:navatala_transformer_layer_norm_backward_f32",
  "abi-r1:cuda:navatala_transformer_layer_norm_backward_f32",
  "abi-r1:cuda:navatala_transformer_layer_norm_backward_f32",
  10,
  kAbiArgs_cuda_navatala_transformer_layer_norm_backward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_layer_norm_backward_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gamma", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "mean", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_layer_norm_backward_f16 = {
  1,
  "navatala_transformer_layer_norm_backward_f16",
  "cuda",
  "navatala_transformer_layer_norm_backward_f16",
  "kernel:cuda:navatala_transformer_layer_norm_backward_f16",
  "abi-r1:cuda:navatala_transformer_layer_norm_backward_f16",
  "abi-r1:cuda:navatala_transformer_layer_norm_backward_f16",
  10,
  kAbiArgs_cuda_navatala_transformer_layer_norm_backward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rms_norm_backward_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gamma", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rms_norm_backward_f32 = {
  1,
  "navatala_transformer_rms_norm_backward_f32",
  "cuda",
  "navatala_transformer_rms_norm_backward_f32",
  "kernel:cuda:navatala_transformer_rms_norm_backward_f32",
  "abi-r1:cuda:navatala_transformer_rms_norm_backward_f32",
  "abi-r1:cuda:navatala_transformer_rms_norm_backward_f32",
  8,
  kAbiArgs_cuda_navatala_transformer_rms_norm_backward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rms_norm_backward_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gamma", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rsigma", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rms_norm_backward_f16 = {
  1,
  "navatala_transformer_rms_norm_backward_f16",
  "cuda",
  "navatala_transformer_rms_norm_backward_f16",
  "kernel:cuda:navatala_transformer_rms_norm_backward_f16",
  "abi-r1:cuda:navatala_transformer_rms_norm_backward_f16",
  "abi-r1:cuda:navatala_transformer_rms_norm_backward_f16",
  8,
  kAbiArgs_cuda_navatala_transformer_rms_norm_backward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_layer_norm_multi_pass_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gamma", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "beta", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "epsilon", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_layer_norm_multi_pass_f32 = {
  1,
  "navatala_transformer_layer_norm_multi_pass_f32",
  "cuda",
  "navatala_transformer_layer_norm_multi_pass_f32",
  "kernel:cuda:navatala_transformer_layer_norm_multi_pass_f32",
  "abi-r1:cuda:navatala_transformer_layer_norm_multi_pass_f32",
  "abi-r1:cuda:navatala_transformer_layer_norm_multi_pass_f32",
  7,
  kAbiArgs_cuda_navatala_transformer_layer_norm_multi_pass_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_layer_norm_multi_pass_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gamma", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "beta", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "epsilon", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_layer_norm_multi_pass_f16 = {
  1,
  "navatala_transformer_layer_norm_multi_pass_f16",
  "cuda",
  "navatala_transformer_layer_norm_multi_pass_f16",
  "kernel:cuda:navatala_transformer_layer_norm_multi_pass_f16",
  "abi-r1:cuda:navatala_transformer_layer_norm_multi_pass_f16",
  "abi-r1:cuda:navatala_transformer_layer_norm_multi_pass_f16",
  7,
  kAbiArgs_cuda_navatala_transformer_layer_norm_multi_pass_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rms_norm_multi_pass_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gamma", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "epsilon", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rms_norm_multi_pass_f32 = {
  1,
  "navatala_transformer_rms_norm_multi_pass_f32",
  "cuda",
  "navatala_transformer_rms_norm_multi_pass_f32",
  "kernel:cuda:navatala_transformer_rms_norm_multi_pass_f32",
  "abi-r1:cuda:navatala_transformer_rms_norm_multi_pass_f32",
  "abi-r1:cuda:navatala_transformer_rms_norm_multi_pass_f32",
  6,
  kAbiArgs_cuda_navatala_transformer_rms_norm_multi_pass_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rms_norm_multi_pass_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gamma", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "epsilon", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rms_norm_multi_pass_f16 = {
  1,
  "navatala_transformer_rms_norm_multi_pass_f16",
  "cuda",
  "navatala_transformer_rms_norm_multi_pass_f16",
  "kernel:cuda:navatala_transformer_rms_norm_multi_pass_f16",
  "abi-r1:cuda:navatala_transformer_rms_norm_multi_pass_f16",
  "abi-r1:cuda:navatala_transformer_rms_norm_multi_pass_f16",
  6,
  kAbiArgs_cuda_navatala_transformer_rms_norm_multi_pass_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_softmax_forward_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_softmax_forward_f32 = {
  1,
  "navatala_transformer_softmax_forward_f32",
  "cuda",
  "navatala_transformer_softmax_forward_f32",
  "kernel:cuda:navatala_transformer_softmax_forward_f32",
  "abi-r1:cuda:navatala_transformer_softmax_forward_f32",
  "abi-r1:cuda:navatala_transformer_softmax_forward_f32",
  4,
  kAbiArgs_cuda_navatala_transformer_softmax_forward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_softmax_forward_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_softmax_forward_f16 = {
  1,
  "navatala_transformer_softmax_forward_f16",
  "cuda",
  "navatala_transformer_softmax_forward_f16",
  "kernel:cuda:navatala_transformer_softmax_forward_f16",
  "abi-r1:cuda:navatala_transformer_softmax_forward_f16",
  "abi-r1:cuda:navatala_transformer_softmax_forward_f16",
  4,
  kAbiArgs_cuda_navatala_transformer_softmax_forward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_softmax_forward_bf16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_softmax_forward_bf16 = {
  1,
  "navatala_transformer_softmax_forward_bf16",
  "cuda",
  "navatala_transformer_softmax_forward_bf16",
  "kernel:cuda:navatala_transformer_softmax_forward_bf16",
  "abi-r1:cuda:navatala_transformer_softmax_forward_bf16",
  "abi-r1:cuda:navatala_transformer_softmax_forward_bf16",
  4,
  kAbiArgs_cuda_navatala_transformer_softmax_forward_bf16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_softmax_backward_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_softmax_backward_f32 = {
  1,
  "navatala_transformer_softmax_backward_f32",
  "cuda",
  "navatala_transformer_softmax_backward_f32",
  "kernel:cuda:navatala_transformer_softmax_backward_f32",
  "abi-r1:cuda:navatala_transformer_softmax_backward_f32",
  "abi-r1:cuda:navatala_transformer_softmax_backward_f32",
  5,
  kAbiArgs_cuda_navatala_transformer_softmax_backward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_softmax_backward_f16[] = {
  { "output", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_softmax_backward_f16 = {
  1,
  "navatala_transformer_softmax_backward_f16",
  "cuda",
  "navatala_transformer_softmax_backward_f16",
  "kernel:cuda:navatala_transformer_softmax_backward_f16",
  "abi-r1:cuda:navatala_transformer_softmax_backward_f16",
  "abi-r1:cuda:navatala_transformer_softmax_backward_f16",
  5,
  kAbiArgs_cuda_navatala_transformer_softmax_backward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_softmax_with_mask_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_softmax_with_mask_f32 = {
  1,
  "navatala_transformer_softmax_with_mask_f32",
  "cuda",
  "navatala_transformer_softmax_with_mask_f32",
  "kernel:cuda:navatala_transformer_softmax_with_mask_f32",
  "abi-r1:cuda:navatala_transformer_softmax_with_mask_f32",
  "abi-r1:cuda:navatala_transformer_softmax_with_mask_f32",
  5,
  kAbiArgs_cuda_navatala_transformer_softmax_with_mask_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_softmax_with_mask_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "isCausal", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_softmax_with_mask_f16 = {
  1,
  "navatala_transformer_softmax_with_mask_f16",
  "cuda",
  "navatala_transformer_softmax_with_mask_f16",
  "kernel:cuda:navatala_transformer_softmax_with_mask_f16",
  "abi-r1:cuda:navatala_transformer_softmax_with_mask_f16",
  "abi-r1:cuda:navatala_transformer_softmax_with_mask_f16",
  5,
  kAbiArgs_cuda_navatala_transformer_softmax_with_mask_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_softmax_with_mask_backward_f32[] = {
  { "output", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_softmax_with_mask_backward_f32 = {
  1,
  "navatala_transformer_softmax_with_mask_backward_f32",
  "cuda",
  "navatala_transformer_softmax_with_mask_backward_f32",
  "kernel:cuda:navatala_transformer_softmax_with_mask_backward_f32",
  "abi-r1:cuda:navatala_transformer_softmax_with_mask_backward_f32",
  "abi-r1:cuda:navatala_transformer_softmax_with_mask_backward_f32",
  6,
  kAbiArgs_cuda_navatala_transformer_softmax_with_mask_backward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_softmax_with_mask_backward_f16[] = {
  { "output", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "gradOutput", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_softmax_with_mask_backward_f16 = {
  1,
  "navatala_transformer_softmax_with_mask_backward_f16",
  "cuda",
  "navatala_transformer_softmax_with_mask_backward_f16",
  "kernel:cuda:navatala_transformer_softmax_with_mask_backward_f16",
  "abi-r1:cuda:navatala_transformer_softmax_with_mask_backward_f16",
  "abi-r1:cuda:navatala_transformer_softmax_with_mask_backward_f16",
  6,
  kAbiArgs_cuda_navatala_transformer_softmax_with_mask_backward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_softmax_multi_pass_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_softmax_multi_pass_f32 = {
  1,
  "navatala_transformer_softmax_multi_pass_f32",
  "cuda",
  "navatala_transformer_softmax_multi_pass_f32",
  "kernel:cuda:navatala_transformer_softmax_multi_pass_f32",
  "abi-r1:cuda:navatala_transformer_softmax_multi_pass_f32",
  "abi-r1:cuda:navatala_transformer_softmax_multi_pass_f32",
  4,
  kAbiArgs_cuda_navatala_transformer_softmax_multi_pass_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_softmax_multi_pass_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_softmax_multi_pass_f16 = {
  1,
  "navatala_transformer_softmax_multi_pass_f16",
  "cuda",
  "navatala_transformer_softmax_multi_pass_f16",
  "kernel:cuda:navatala_transformer_softmax_multi_pass_f16",
  "abi-r1:cuda:navatala_transformer_softmax_multi_pass_f16",
  "abi-r1:cuda:navatala_transformer_softmax_multi_pass_f16",
  4,
  kAbiArgs_cuda_navatala_transformer_softmax_multi_pass_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_cast_f32_to_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_cast_f32_to_f16 = {
  1,
  "navatala_transformer_cast_f32_to_f16",
  "cuda",
  "navatala_transformer_cast_f32_to_f16",
  "kernel:cuda:navatala_transformer_cast_f32_to_f16",
  "abi-r1:cuda:navatala_transformer_cast_f32_to_f16",
  "abi-r1:cuda:navatala_transformer_cast_f32_to_f16",
  3,
  kAbiArgs_cuda_navatala_transformer_cast_f32_to_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_cast_f16_to_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_cast_f16_to_f32 = {
  1,
  "navatala_transformer_cast_f16_to_f32",
  "cuda",
  "navatala_transformer_cast_f16_to_f32",
  "kernel:cuda:navatala_transformer_cast_f16_to_f32",
  "abi-r1:cuda:navatala_transformer_cast_f16_to_f32",
  "abi-r1:cuda:navatala_transformer_cast_f16_to_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_cast_f16_to_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_cast_f32_to_bf16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_cast_f32_to_bf16 = {
  1,
  "navatala_transformer_cast_f32_to_bf16",
  "cuda",
  "navatala_transformer_cast_f32_to_bf16",
  "kernel:cuda:navatala_transformer_cast_f32_to_bf16",
  "abi-r1:cuda:navatala_transformer_cast_f32_to_bf16",
  "abi-r1:cuda:navatala_transformer_cast_f32_to_bf16",
  3,
  kAbiArgs_cuda_navatala_transformer_cast_f32_to_bf16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_cast_b_f16_to_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_cast_b_f16_to_f32 = {
  1,
  "navatala_transformer_cast_b_f16_to_f32",
  "cuda",
  "navatala_transformer_cast_b_f16_to_f32",
  "kernel:cuda:navatala_transformer_cast_b_f16_to_f32",
  "abi-r1:cuda:navatala_transformer_cast_b_f16_to_f32",
  "abi-r1:cuda:navatala_transformer_cast_b_f16_to_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_cast_b_f16_to_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_transpose_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_transpose_f32 = {
  1,
  "navatala_transformer_transpose_f32",
  "cuda",
  "navatala_transformer_transpose_f32",
  "kernel:cuda:navatala_transformer_transpose_f32",
  "abi-r1:cuda:navatala_transformer_transpose_f32",
  "abi-r1:cuda:navatala_transformer_transpose_f32",
  4,
  kAbiArgs_cuda_navatala_transformer_transpose_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_transpose_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rows", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "cols", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_transpose_f16 = {
  1,
  "navatala_transformer_transpose_f16",
  "cuda",
  "navatala_transformer_transpose_f16",
  "kernel:cuda:navatala_transformer_transpose_f16",
  "abi-r1:cuda:navatala_transformer_transpose_f16",
  "abi-r1:cuda:navatala_transformer_transpose_f16",
  4,
  kAbiArgs_cuda_navatala_transformer_transpose_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_fused_cast_transpose_f32_to_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rows", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "cols", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_fused_cast_transpose_f32_to_f16 = {
  1,
  "navatala_transformer_fused_cast_transpose_f32_to_f16",
  "cuda",
  "navatala_transformer_fused_cast_transpose_f32_to_f16",
  "kernel:cuda:navatala_transformer_fused_cast_transpose_f32_to_f16",
  "abi-r1:cuda:navatala_transformer_fused_cast_transpose_f32_to_f16",
  "abi-r1:cuda:navatala_transformer_fused_cast_transpose_f32_to_f16",
  4,
  kAbiArgs_cuda_navatala_transformer_fused_cast_transpose_f32_to_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_cast_f32_to_f_p8_e4_m3[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "scale", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_cast_f32_to_f_p8_e4_m3 = {
  1,
  "navatala_transformer_cast_f32_to_f_p8_e4_m3",
  "cuda",
  "navatala_transformer_cast_f32_to_f_p8_e4_m3",
  "kernel:cuda:navatala_transformer_cast_f32_to_f_p8_e4_m3",
  "abi-r1:cuda:navatala_transformer_cast_f32_to_f_p8_e4_m3",
  "abi-r1:cuda:navatala_transformer_cast_f32_to_f_p8_e4_m3",
  4,
  kAbiArgs_cuda_navatala_transformer_cast_f32_to_f_p8_e4_m3
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_cast_f_p8_e4_m3_to_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "scale", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_cast_f_p8_e4_m3_to_f32 = {
  1,
  "navatala_transformer_cast_f_p8_e4_m3_to_f32",
  "cuda",
  "navatala_transformer_cast_f_p8_e4_m3_to_f32",
  "kernel:cuda:navatala_transformer_cast_f_p8_e4_m3_to_f32",
  "abi-r1:cuda:navatala_transformer_cast_f_p8_e4_m3_to_f32",
  "abi-r1:cuda:navatala_transformer_cast_f_p8_e4_m3_to_f32",
  4,
  kAbiArgs_cuda_navatala_transformer_cast_f_p8_e4_m3_to_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_cast_f32_to_f_p8_e5_m2[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "scale", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_cast_f32_to_f_p8_e5_m2 = {
  1,
  "navatala_transformer_cast_f32_to_f_p8_e5_m2",
  "cuda",
  "navatala_transformer_cast_f32_to_f_p8_e5_m2",
  "kernel:cuda:navatala_transformer_cast_f32_to_f_p8_e5_m2",
  "abi-r1:cuda:navatala_transformer_cast_f32_to_f_p8_e5_m2",
  "abi-r1:cuda:navatala_transformer_cast_f32_to_f_p8_e5_m2",
  4,
  kAbiArgs_cuda_navatala_transformer_cast_f32_to_f_p8_e5_m2
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_cast_f_p8_e5_m2_to_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "scale", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "count", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_cast_f_p8_e5_m2_to_f32 = {
  1,
  "navatala_transformer_cast_f_p8_e5_m2_to_f32",
  "cuda",
  "navatala_transformer_cast_f_p8_e5_m2_to_f32",
  "kernel:cuda:navatala_transformer_cast_f_p8_e5_m2_to_f32",
  "abi-r1:cuda:navatala_transformer_cast_f_p8_e5_m2_to_f32",
  "abi-r1:cuda:navatala_transformer_cast_f_p8_e5_m2_to_f32",
  4,
  kAbiArgs_cuda_navatala_transformer_cast_f_p8_e5_m2_to_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_fused_cast_transpose_f_p8[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "scale", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_fused_cast_transpose_f_p8 = {
  1,
  "navatala_transformer_fused_cast_transpose_f_p8",
  "cuda",
  "navatala_transformer_fused_cast_transpose_f_p8",
  "kernel:cuda:navatala_transformer_fused_cast_transpose_f_p8",
  "abi-r1:cuda:navatala_transformer_fused_cast_transpose_f_p8",
  "abi-r1:cuda:navatala_transformer_fused_cast_transpose_f_p8",
  5,
  kAbiArgs_cuda_navatala_transformer_fused_cast_transpose_f_p8
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_transpose4_d_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_transpose4_d_f32 = {
  1,
  "navatala_transformer_transpose4_d_f32",
  "cuda",
  "navatala_transformer_transpose4_d_f32",
  "kernel:cuda:navatala_transformer_transpose4_d_f32",
  "abi-r1:cuda:navatala_transformer_transpose4_d_f32",
  "abi-r1:cuda:navatala_transformer_transpose4_d_f32",
  10,
  kAbiArgs_cuda_navatala_transformer_transpose4_d_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_transpose4_d_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "dim0", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dim1", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dim2", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_transpose4_d_f16 = {
  1,
  "navatala_transformer_transpose4_d_f16",
  "cuda",
  "navatala_transformer_transpose4_d_f16",
  "kernel:cuda:navatala_transformer_transpose4_d_f16",
  "abi-r1:cuda:navatala_transformer_transpose4_d_f16",
  "abi-r1:cuda:navatala_transformer_transpose4_d_f16",
  10,
  kAbiArgs_cuda_navatala_transformer_transpose4_d_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_dropout_forward_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_dropout_forward_f32 = {
  1,
  "navatala_transformer_dropout_forward_f32",
  "cuda",
  "navatala_transformer_dropout_forward_f32",
  "kernel:cuda:navatala_transformer_dropout_forward_f32",
  "abi-r1:cuda:navatala_transformer_dropout_forward_f32",
  "abi-r1:cuda:navatala_transformer_dropout_forward_f32",
  5,
  kAbiArgs_cuda_navatala_transformer_dropout_forward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_dropout_forward_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "prob", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seed", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_dropout_forward_f16 = {
  1,
  "navatala_transformer_dropout_forward_f16",
  "cuda",
  "navatala_transformer_dropout_forward_f16",
  "kernel:cuda:navatala_transformer_dropout_forward_f16",
  "abi-r1:cuda:navatala_transformer_dropout_forward_f16",
  "abi-r1:cuda:navatala_transformer_dropout_forward_f16",
  5,
  kAbiArgs_cuda_navatala_transformer_dropout_forward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_dropout_backward_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_dropout_backward_f32 = {
  1,
  "navatala_transformer_dropout_backward_f32",
  "cuda",
  "navatala_transformer_dropout_backward_f32",
  "kernel:cuda:navatala_transformer_dropout_backward_f32",
  "abi-r1:cuda:navatala_transformer_dropout_backward_f32",
  "abi-r1:cuda:navatala_transformer_dropout_backward_f32",
  5,
  kAbiArgs_cuda_navatala_transformer_dropout_backward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_dropout_backward_f16[] = {
  { "gradOutput", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "prob", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seed", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_dropout_backward_f16 = {
  1,
  "navatala_transformer_dropout_backward_f16",
  "cuda",
  "navatala_transformer_dropout_backward_f16",
  "kernel:cuda:navatala_transformer_dropout_backward_f16",
  "abi-r1:cuda:navatala_transformer_dropout_backward_f16",
  "abi-r1:cuda:navatala_transformer_dropout_backward_f16",
  5,
  kAbiArgs_cuda_navatala_transformer_dropout_backward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rope_forward_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rope_forward_f32 = {
  1,
  "navatala_transformer_rope_forward_f32",
  "cuda",
  "navatala_transformer_rope_forward_f32",
  "kernel:cuda:navatala_transformer_rope_forward_f32",
  "abi-r1:cuda:navatala_transformer_rope_forward_f32",
  "abi-r1:cuda:navatala_transformer_rope_forward_f32",
  7,
  kAbiArgs_cuda_navatala_transformer_rope_forward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rope_forward_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "positions", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rope_forward_f16 = {
  1,
  "navatala_transformer_rope_forward_f16",
  "cuda",
  "navatala_transformer_rope_forward_f16",
  "kernel:cuda:navatala_transformer_rope_forward_f16",
  "abi-r1:cuda:navatala_transformer_rope_forward_f16",
  "abi-r1:cuda:navatala_transformer_rope_forward_f16",
  7,
  kAbiArgs_cuda_navatala_transformer_rope_forward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rope_forward_bf16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "positions", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rope_forward_bf16 = {
  1,
  "navatala_transformer_rope_forward_bf16",
  "cuda",
  "navatala_transformer_rope_forward_bf16",
  "kernel:cuda:navatala_transformer_rope_forward_bf16",
  "abi-r1:cuda:navatala_transformer_rope_forward_bf16",
  "abi-r1:cuda:navatala_transformer_rope_forward_bf16",
  7,
  kAbiArgs_cuda_navatala_transformer_rope_forward_bf16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rope_with_cache_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rope_with_cache_f32 = {
  1,
  "navatala_transformer_rope_with_cache_f32",
  "cuda",
  "navatala_transformer_rope_with_cache_f32",
  "kernel:cuda:navatala_transformer_rope_with_cache_f32",
  "abi-r1:cuda:navatala_transformer_rope_with_cache_f32",
  "abi-r1:cuda:navatala_transformer_rope_with_cache_f32",
  8,
  kAbiArgs_cuda_navatala_transformer_rope_with_cache_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rope_backward_f32[] = {
  { "gradOutput", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "positions", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rope_backward_f32 = {
  1,
  "navatala_transformer_rope_backward_f32",
  "cuda",
  "navatala_transformer_rope_backward_f32",
  "kernel:cuda:navatala_transformer_rope_backward_f32",
  "abi-r1:cuda:navatala_transformer_rope_backward_f32",
  "abi-r1:cuda:navatala_transformer_rope_backward_f32",
  7,
  kAbiArgs_cuda_navatala_transformer_rope_backward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rope_backward_f16[] = {
  { "gradOutput", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "positions", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rope_backward_f16 = {
  1,
  "navatala_transformer_rope_backward_f16",
  "cuda",
  "navatala_transformer_rope_backward_f16",
  "kernel:cuda:navatala_transformer_rope_backward_f16",
  "abi-r1:cuda:navatala_transformer_rope_backward_f16",
  "abi-r1:cuda:navatala_transformer_rope_backward_f16",
  7,
  kAbiArgs_cuda_navatala_transformer_rope_backward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rope_backward_bf16[] = {
  { "gradOutput", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "positions", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rope_backward_bf16 = {
  1,
  "navatala_transformer_rope_backward_bf16",
  "cuda",
  "navatala_transformer_rope_backward_bf16",
  "kernel:cuda:navatala_transformer_rope_backward_bf16",
  "abi-r1:cuda:navatala_transformer_rope_backward_bf16",
  "abi-r1:cuda:navatala_transformer_rope_backward_bf16",
  7,
  kAbiArgs_cuda_navatala_transformer_rope_backward_bf16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rope_interleaved_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "positions", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rope_interleaved_f32 = {
  1,
  "navatala_transformer_rope_interleaved_f32",
  "cuda",
  "navatala_transformer_rope_interleaved_f32",
  "kernel:cuda:navatala_transformer_rope_interleaved_f32",
  "abi-r1:cuda:navatala_transformer_rope_interleaved_f32",
  "abi-r1:cuda:navatala_transformer_rope_interleaved_f32",
  7,
  kAbiArgs_cuda_navatala_transformer_rope_interleaved_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rope_interleaved_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "positions", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rope_interleaved_f16 = {
  1,
  "navatala_transformer_rope_interleaved_f16",
  "cuda",
  "navatala_transformer_rope_interleaved_f16",
  "kernel:cuda:navatala_transformer_rope_interleaved_f16",
  "abi-r1:cuda:navatala_transformer_rope_interleaved_f16",
  "abi-r1:cuda:navatala_transformer_rope_interleaved_f16",
  7,
  kAbiArgs_cuda_navatala_transformer_rope_interleaved_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_rope_interleaved_bf16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "positions", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_rope_interleaved_bf16 = {
  1,
  "navatala_transformer_rope_interleaved_bf16",
  "cuda",
  "navatala_transformer_rope_interleaved_bf16",
  "kernel:cuda:navatala_transformer_rope_interleaved_bf16",
  "abi-r1:cuda:navatala_transformer_rope_interleaved_bf16",
  "abi-r1:cuda:navatala_transformer_rope_interleaved_bf16",
  7,
  kAbiArgs_cuda_navatala_transformer_rope_interleaved_bf16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_simple_attention_f16[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_simple_attention_f16 = {
  1,
  "navatala_transformer_simple_attention_f16",
  "cuda",
  "navatala_transformer_simple_attention_f16",
  "kernel:cuda:navatala_transformer_simple_attention_f16",
  "abi-r1:cuda:navatala_transformer_simple_attention_f16",
  "abi-r1:cuda:navatala_transformer_simple_attention_f16",
  8,
  kAbiArgs_cuda_navatala_transformer_simple_attention_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_simple_attention_f32[] = {
  { "query", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "key", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "value", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_simple_attention_f32 = {
  1,
  "navatala_transformer_simple_attention_f32",
  "cuda",
  "navatala_transformer_simple_attention_f32",
  "kernel:cuda:navatala_transformer_simple_attention_f32",
  "abi-r1:cuda:navatala_transformer_simple_attention_f32",
  "abi-r1:cuda:navatala_transformer_simple_attention_f32",
  8,
  kAbiArgs_cuda_navatala_transformer_simple_attention_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_paged_attention_f32[] = {
  { "query", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_paged_attention_f32 = {
  1,
  "navatala_transformer_paged_attention_f32",
  "cuda",
  "navatala_transformer_paged_attention_f32",
  "kernel:cuda:navatala_transformer_paged_attention_f32",
  "abi-r1:cuda:navatala_transformer_paged_attention_f32",
  "abi-r1:cuda:navatala_transformer_paged_attention_f32",
  9,
  kAbiArgs_cuda_navatala_transformer_paged_attention_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_simple_attention_with_mask_f32[] = {
  { "query", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "key", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "value", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_simple_attention_with_mask_f32 = {
  1,
  "navatala_transformer_simple_attention_with_mask_f32",
  "cuda",
  "navatala_transformer_simple_attention_with_mask_f32",
  "kernel:cuda:navatala_transformer_simple_attention_with_mask_f32",
  "abi-r1:cuda:navatala_transformer_simple_attention_with_mask_f32",
  "abi-r1:cuda:navatala_transformer_simple_attention_with_mask_f32",
  8,
  kAbiArgs_cuda_navatala_transformer_simple_attention_with_mask_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_simple_attention_with_mask_f16[] = {
  { "query", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "key", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "value", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_simple_attention_with_mask_f16 = {
  1,
  "navatala_transformer_simple_attention_with_mask_f16",
  "cuda",
  "navatala_transformer_simple_attention_with_mask_f16",
  "kernel:cuda:navatala_transformer_simple_attention_with_mask_f16",
  "abi-r1:cuda:navatala_transformer_simple_attention_with_mask_f16",
  "abi-r1:cuda:navatala_transformer_simple_attention_with_mask_f16",
  8,
  kAbiArgs_cuda_navatala_transformer_simple_attention_with_mask_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_simple_attention_with_padding_f32[] = {
  { "query", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "key", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "value", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_simple_attention_with_padding_f32 = {
  1,
  "navatala_transformer_simple_attention_with_padding_f32",
  "cuda",
  "navatala_transformer_simple_attention_with_padding_f32",
  "kernel:cuda:navatala_transformer_simple_attention_with_padding_f32",
  "abi-r1:cuda:navatala_transformer_simple_attention_with_padding_f32",
  "abi-r1:cuda:navatala_transformer_simple_attention_with_padding_f32",
  9,
  kAbiArgs_cuda_navatala_transformer_simple_attention_with_padding_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_simple_attention_with_padding_f16[] = {
  { "query", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "key", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "value", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqLengths", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_simple_attention_with_padding_f16 = {
  1,
  "navatala_transformer_simple_attention_with_padding_f16",
  "cuda",
  "navatala_transformer_simple_attention_with_padding_f16",
  "kernel:cuda:navatala_transformer_simple_attention_with_padding_f16",
  "abi-r1:cuda:navatala_transformer_simple_attention_with_padding_f16",
  "abi-r1:cuda:navatala_transformer_simple_attention_with_padding_f16",
  9,
  kAbiArgs_cuda_navatala_transformer_simple_attention_with_padding_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_simple_attention_backward_f32[] = {
  { "gradOutput", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_simple_attention_backward_f32 = {
  1,
  "navatala_transformer_simple_attention_backward_f32",
  "cuda",
  "navatala_transformer_simple_attention_backward_f32",
  "kernel:cuda:navatala_transformer_simple_attention_backward_f32",
  "abi-r1:cuda:navatala_transformer_simple_attention_backward_f32",
  "abi-r1:cuda:navatala_transformer_simple_attention_backward_f32",
  11,
  kAbiArgs_cuda_navatala_transformer_simple_attention_backward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_simple_attention_backward_f16[] = {
  { "gradOutput", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "query", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "key", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "value", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_simple_attention_backward_f16 = {
  1,
  "navatala_transformer_simple_attention_backward_f16",
  "cuda",
  "navatala_transformer_simple_attention_backward_f16",
  "kernel:cuda:navatala_transformer_simple_attention_backward_f16",
  "abi-r1:cuda:navatala_transformer_simple_attention_backward_f16",
  "abi-r1:cuda:navatala_transformer_simple_attention_backward_f16",
  11,
  kAbiArgs_cuda_navatala_transformer_simple_attention_backward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_kv_cache_append_f16[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_kv_cache_append_f16 = {
  1,
  "navatala_transformer_kv_cache_append_f16",
  "cuda",
  "navatala_transformer_kv_cache_append_f16",
  "kernel:cuda:navatala_transformer_kv_cache_append_f16",
  "abi-r1:cuda:navatala_transformer_kv_cache_append_f16",
  "abi-r1:cuda:navatala_transformer_kv_cache_append_f16",
  9,
  kAbiArgs_cuda_navatala_transformer_kv_cache_append_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_kv_cache_append_f32[] = {
  { "newK", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "newV", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "blockTables", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqPositions", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_kv_cache_append_f32 = {
  1,
  "navatala_transformer_kv_cache_append_f32",
  "cuda",
  "navatala_transformer_kv_cache_append_f32",
  "kernel:cuda:navatala_transformer_kv_cache_append_f32",
  "abi-r1:cuda:navatala_transformer_kv_cache_append_f32",
  "abi-r1:cuda:navatala_transformer_kv_cache_append_f32",
  9,
  kAbiArgs_cuda_navatala_transformer_kv_cache_append_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_kv_cache_rotate_f16[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_kv_cache_rotate_f16 = {
  1,
  "navatala_transformer_kv_cache_rotate_f16",
  "cuda",
  "navatala_transformer_kv_cache_rotate_f16",
  "kernel:cuda:navatala_transformer_kv_cache_rotate_f16",
  "abi-r1:cuda:navatala_transformer_kv_cache_rotate_f16",
  "abi-r1:cuda:navatala_transformer_kv_cache_rotate_f16",
  8,
  kAbiArgs_cuda_navatala_transformer_kv_cache_rotate_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_tiled_gemm_f16[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_tiled_gemm_f16 = {
  1,
  "navatala_transformer_tiled_gemm_f16",
  "cuda",
  "navatala_transformer_tiled_gemm_f16",
  "kernel:cuda:navatala_transformer_tiled_gemm_f16",
  "abi-r1:cuda:navatala_transformer_tiled_gemm_f16",
  "abi-r1:cuda:navatala_transformer_tiled_gemm_f16",
  8,
  kAbiArgs_cuda_navatala_transformer_tiled_gemm_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_tiled_gemm_f16_f32_out[] = {
  { "a", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "b", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "m", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_tiled_gemm_f16_f32_out = {
  1,
  "navatala_transformer_tiled_gemm_f16_f32_out",
  "cuda",
  "navatala_transformer_tiled_gemm_f16_f32_out",
  "kernel:cuda:navatala_transformer_tiled_gemm_f16_f32_out",
  "abi-r1:cuda:navatala_transformer_tiled_gemm_f16_f32_out",
  "abi-r1:cuda:navatala_transformer_tiled_gemm_f16_f32_out",
  8,
  kAbiArgs_cuda_navatala_transformer_tiled_gemm_f16_f32_out
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_tiled_gemm_f32[] = {
  { "a", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "b", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "m", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_tiled_gemm_f32 = {
  1,
  "navatala_transformer_tiled_gemm_f32",
  "cuda",
  "navatala_transformer_tiled_gemm_f32",
  "kernel:cuda:navatala_transformer_tiled_gemm_f32",
  "abi-r1:cuda:navatala_transformer_tiled_gemm_f32",
  "abi-r1:cuda:navatala_transformer_tiled_gemm_f32",
  8,
  kAbiArgs_cuda_navatala_transformer_tiled_gemm_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_tiled_gemm_backward_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_tiled_gemm_backward_f32 = {
  1,
  "navatala_transformer_tiled_gemm_backward_f32",
  "cuda",
  "navatala_transformer_tiled_gemm_backward_f32",
  "kernel:cuda:navatala_transformer_tiled_gemm_backward_f32",
  "abi-r1:cuda:navatala_transformer_tiled_gemm_backward_f32",
  "abi-r1:cuda:navatala_transformer_tiled_gemm_backward_f32",
  6,
  kAbiArgs_cuda_navatala_transformer_tiled_gemm_backward_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_tiled_gemm_backward_f16[] = {
  { "gradC", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "b", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "m", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_tiled_gemm_backward_f16 = {
  1,
  "navatala_transformer_tiled_gemm_backward_f16",
  "cuda",
  "navatala_transformer_tiled_gemm_backward_f16",
  "kernel:cuda:navatala_transformer_tiled_gemm_backward_f16",
  "abi-r1:cuda:navatala_transformer_tiled_gemm_backward_f16",
  "abi-r1:cuda:navatala_transformer_tiled_gemm_backward_f16",
  6,
  kAbiArgs_cuda_navatala_transformer_tiled_gemm_backward_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_multi_tensor_scale_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "scale", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "totalElements", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_multi_tensor_scale_f32 = {
  1,
  "navatala_transformer_multi_tensor_scale_f32",
  "cuda",
  "navatala_transformer_multi_tensor_scale_f32",
  "kernel:cuda:navatala_transformer_multi_tensor_scale_f32",
  "abi-r1:cuda:navatala_transformer_multi_tensor_scale_f32",
  "abi-r1:cuda:navatala_transformer_multi_tensor_scale_f32",
  4,
  kAbiArgs_cuda_navatala_transformer_multi_tensor_scale_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_multi_tensor_scale_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "scale", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "totalElements", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_multi_tensor_scale_f16 = {
  1,
  "navatala_transformer_multi_tensor_scale_f16",
  "cuda",
  "navatala_transformer_multi_tensor_scale_f16",
  "kernel:cuda:navatala_transformer_multi_tensor_scale_f16",
  "abi-r1:cuda:navatala_transformer_multi_tensor_scale_f16",
  "abi-r1:cuda:navatala_transformer_multi_tensor_scale_f16",
  4,
  kAbiArgs_cuda_navatala_transformer_multi_tensor_scale_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_multi_tensor_add_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "value", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "totalElements", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_multi_tensor_add_f32 = {
  1,
  "navatala_transformer_multi_tensor_add_f32",
  "cuda",
  "navatala_transformer_multi_tensor_add_f32",
  "kernel:cuda:navatala_transformer_multi_tensor_add_f32",
  "abi-r1:cuda:navatala_transformer_multi_tensor_add_f32",
  "abi-r1:cuda:navatala_transformer_multi_tensor_add_f32",
  4,
  kAbiArgs_cuda_navatala_transformer_multi_tensor_add_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_multi_tensor_add_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "value", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "totalElements", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_multi_tensor_add_f16 = {
  1,
  "navatala_transformer_multi_tensor_add_f16",
  "cuda",
  "navatala_transformer_multi_tensor_add_f16",
  "kernel:cuda:navatala_transformer_multi_tensor_add_f16",
  "abi-r1:cuda:navatala_transformer_multi_tensor_add_f16",
  "abi-r1:cuda:navatala_transformer_multi_tensor_add_f16",
  4,
  kAbiArgs_cuda_navatala_transformer_multi_tensor_add_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_multi_tensor_copy_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "totalElements", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_multi_tensor_copy_f32 = {
  1,
  "navatala_transformer_multi_tensor_copy_f32",
  "cuda",
  "navatala_transformer_multi_tensor_copy_f32",
  "kernel:cuda:navatala_transformer_multi_tensor_copy_f32",
  "abi-r1:cuda:navatala_transformer_multi_tensor_copy_f32",
  "abi-r1:cuda:navatala_transformer_multi_tensor_copy_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_multi_tensor_copy_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_multi_tensor_copy_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "totalElements", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_multi_tensor_copy_f16 = {
  1,
  "navatala_transformer_multi_tensor_copy_f16",
  "cuda",
  "navatala_transformer_multi_tensor_copy_f16",
  "kernel:cuda:navatala_transformer_multi_tensor_copy_f16",
  "abi-r1:cuda:navatala_transformer_multi_tensor_copy_f16",
  "abi-r1:cuda:navatala_transformer_multi_tensor_copy_f16",
  3,
  kAbiArgs_cuda_navatala_transformer_multi_tensor_copy_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_multi_tensor_l2_norm_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "totalElements", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "partialSums", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_multi_tensor_l2_norm_f32 = {
  1,
  "navatala_transformer_multi_tensor_l2_norm_f32",
  "cuda",
  "navatala_transformer_multi_tensor_l2_norm_f32",
  "kernel:cuda:navatala_transformer_multi_tensor_l2_norm_f32",
  "abi-r1:cuda:navatala_transformer_multi_tensor_l2_norm_f32",
  "abi-r1:cuda:navatala_transformer_multi_tensor_l2_norm_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_multi_tensor_l2_norm_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_multi_tensor_l2_norm_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "totalElements", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "partialSums", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_multi_tensor_l2_norm_f16 = {
  1,
  "navatala_transformer_multi_tensor_l2_norm_f16",
  "cuda",
  "navatala_transformer_multi_tensor_l2_norm_f16",
  "kernel:cuda:navatala_transformer_multi_tensor_l2_norm_f16",
  "abi-r1:cuda:navatala_transformer_multi_tensor_l2_norm_f16",
  "abi-r1:cuda:navatala_transformer_multi_tensor_l2_norm_f16",
  3,
  kAbiArgs_cuda_navatala_transformer_multi_tensor_l2_norm_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_multi_tensor_clip_grad_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_multi_tensor_clip_grad_f32 = {
  1,
  "navatala_transformer_multi_tensor_clip_grad_f32",
  "cuda",
  "navatala_transformer_multi_tensor_clip_grad_f32",
  "kernel:cuda:navatala_transformer_multi_tensor_clip_grad_f32",
  "abi-r1:cuda:navatala_transformer_multi_tensor_clip_grad_f32",
  "abi-r1:cuda:navatala_transformer_multi_tensor_clip_grad_f32",
  4,
  kAbiArgs_cuda_navatala_transformer_multi_tensor_clip_grad_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_multi_tensor_clip_grad_f16[] = {
  { "totalNorm", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "maxNorm", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "totalElements", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "grad", 3, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_multi_tensor_clip_grad_f16 = {
  1,
  "navatala_transformer_multi_tensor_clip_grad_f16",
  "cuda",
  "navatala_transformer_multi_tensor_clip_grad_f16",
  "kernel:cuda:navatala_transformer_multi_tensor_clip_grad_f16",
  "abi-r1:cuda:navatala_transformer_multi_tensor_clip_grad_f16",
  "abi-r1:cuda:navatala_transformer_multi_tensor_clip_grad_f16",
  4,
  kAbiArgs_cuda_navatala_transformer_multi_tensor_clip_grad_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_top_k_gating_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_top_k_gating_f32 = {
  1,
  "navatala_transformer_top_k_gating_f32",
  "cuda",
  "navatala_transformer_top_k_gating_f32",
  "kernel:cuda:navatala_transformer_top_k_gating_f32",
  "abi-r1:cuda:navatala_transformer_top_k_gating_f32",
  "abi-r1:cuda:navatala_transformer_top_k_gating_f32",
  6,
  kAbiArgs_cuda_navatala_transformer_top_k_gating_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_top_k_gating_f16[] = {
  { "routerLogits", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "numTokens", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "numExperts", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "topK", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_top_k_gating_f16 = {
  1,
  "navatala_transformer_top_k_gating_f16",
  "cuda",
  "navatala_transformer_top_k_gating_f16",
  "kernel:cuda:navatala_transformer_top_k_gating_f16",
  "abi-r1:cuda:navatala_transformer_top_k_gating_f16",
  "abi-r1:cuda:navatala_transformer_top_k_gating_f16",
  6,
  kAbiArgs_cuda_navatala_transformer_top_k_gating_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_expert_capacity_mask_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_expert_capacity_mask_f32 = {
  1,
  "navatala_transformer_expert_capacity_mask_f32",
  "cuda",
  "navatala_transformer_expert_capacity_mask_f32",
  "kernel:cuda:navatala_transformer_expert_capacity_mask_f32",
  "abi-r1:cuda:navatala_transformer_expert_capacity_mask_f32",
  "abi-r1:cuda:navatala_transformer_expert_capacity_mask_f32",
  6,
  kAbiArgs_cuda_navatala_transformer_expert_capacity_mask_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_expert_capacity_mask_f16[] = {
  { "expertIndices", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "numTokens", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "numExperts", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "topK", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_expert_capacity_mask_f16 = {
  1,
  "navatala_transformer_expert_capacity_mask_f16",
  "cuda",
  "navatala_transformer_expert_capacity_mask_f16",
  "kernel:cuda:navatala_transformer_expert_capacity_mask_f16",
  "abi-r1:cuda:navatala_transformer_expert_capacity_mask_f16",
  "abi-r1:cuda:navatala_transformer_expert_capacity_mask_f16",
  6,
  kAbiArgs_cuda_navatala_transformer_expert_capacity_mask_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_permute_tokens_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_permute_tokens_f32 = {
  1,
  "navatala_transformer_permute_tokens_f32",
  "cuda",
  "navatala_transformer_permute_tokens_f32",
  "kernel:cuda:navatala_transformer_permute_tokens_f32",
  "abi-r1:cuda:navatala_transformer_permute_tokens_f32",
  "abi-r1:cuda:navatala_transformer_permute_tokens_f32",
  9,
  kAbiArgs_cuda_navatala_transformer_permute_tokens_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_permute_tokens_f16[] = {
  { "hiddenStates", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "expertIndices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "expertOffsets", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "expertCounters", 3, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_permute_tokens_f16 = {
  1,
  "navatala_transformer_permute_tokens_f16",
  "cuda",
  "navatala_transformer_permute_tokens_f16",
  "kernel:cuda:navatala_transformer_permute_tokens_f16",
  "abi-r1:cuda:navatala_transformer_permute_tokens_f16",
  "abi-r1:cuda:navatala_transformer_permute_tokens_f16",
  9,
  kAbiArgs_cuda_navatala_transformer_permute_tokens_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_unpermute_tokens_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_unpermute_tokens_f32 = {
  1,
  "navatala_transformer_unpermute_tokens_f32",
  "cuda",
  "navatala_transformer_unpermute_tokens_f32",
  "kernel:cuda:navatala_transformer_unpermute_tokens_f32",
  "abi-r1:cuda:navatala_transformer_unpermute_tokens_f32",
  "abi-r1:cuda:navatala_transformer_unpermute_tokens_f32",
  5,
  kAbiArgs_cuda_navatala_transformer_unpermute_tokens_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_unpermute_tokens_f16[] = {
  { "permutedStates", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "tokenIndices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "numTokens", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "hiddenSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_unpermute_tokens_f16 = {
  1,
  "navatala_transformer_unpermute_tokens_f16",
  "cuda",
  "navatala_transformer_unpermute_tokens_f16",
  "kernel:cuda:navatala_transformer_unpermute_tokens_f16",
  "abi-r1:cuda:navatala_transformer_unpermute_tokens_f16",
  "abi-r1:cuda:navatala_transformer_unpermute_tokens_f16",
  5,
  kAbiArgs_cuda_navatala_transformer_unpermute_tokens_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_pad_sequence_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_pad_sequence_f32 = {
  1,
  "navatala_transformer_pad_sequence_f32",
  "cuda",
  "navatala_transformer_pad_sequence_f32",
  "kernel:cuda:navatala_transformer_pad_sequence_f32",
  "abi-r1:cuda:navatala_transformer_pad_sequence_f32",
  "abi-r1:cuda:navatala_transformer_pad_sequence_f32",
  7,
  kAbiArgs_cuda_navatala_transformer_pad_sequence_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_pad_sequence_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqLengths", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqOffsets", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_pad_sequence_f16 = {
  1,
  "navatala_transformer_pad_sequence_f16",
  "cuda",
  "navatala_transformer_pad_sequence_f16",
  "kernel:cuda:navatala_transformer_pad_sequence_f16",
  "abi-r1:cuda:navatala_transformer_pad_sequence_f16",
  "abi-r1:cuda:navatala_transformer_pad_sequence_f16",
  7,
  kAbiArgs_cuda_navatala_transformer_pad_sequence_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_unpad_sequence_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqLengths", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqOffsets", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_unpad_sequence_f32 = {
  1,
  "navatala_transformer_unpad_sequence_f32",
  "cuda",
  "navatala_transformer_unpad_sequence_f32",
  "kernel:cuda:navatala_transformer_unpad_sequence_f32",
  "abi-r1:cuda:navatala_transformer_unpad_sequence_f32",
  "abi-r1:cuda:navatala_transformer_unpad_sequence_f32",
  8,
  kAbiArgs_cuda_navatala_transformer_unpad_sequence_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_unpad_sequence_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqLengths", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqOffsets", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_unpad_sequence_f16 = {
  1,
  "navatala_transformer_unpad_sequence_f16",
  "cuda",
  "navatala_transformer_unpad_sequence_f16",
  "kernel:cuda:navatala_transformer_unpad_sequence_f16",
  "abi-r1:cuda:navatala_transformer_unpad_sequence_f16",
  "abi-r1:cuda:navatala_transformer_unpad_sequence_f16",
  8,
  kAbiArgs_cuda_navatala_transformer_unpad_sequence_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_swizzle_layout_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rows", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "cols", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_swizzle_layout_f32 = {
  1,
  "navatala_transformer_swizzle_layout_f32",
  "cuda",
  "navatala_transformer_swizzle_layout_f32",
  "kernel:cuda:navatala_transformer_swizzle_layout_f32",
  "abi-r1:cuda:navatala_transformer_swizzle_layout_f32",
  "abi-r1:cuda:navatala_transformer_swizzle_layout_f32",
  5,
  kAbiArgs_cuda_navatala_transformer_swizzle_layout_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_swizzle_layout_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rows", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "cols", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "tileSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_swizzle_layout_f16 = {
  1,
  "navatala_transformer_swizzle_layout_f16",
  "cuda",
  "navatala_transformer_swizzle_layout_f16",
  "kernel:cuda:navatala_transformer_swizzle_layout_f16",
  "abi-r1:cuda:navatala_transformer_swizzle_layout_f16",
  "abi-r1:cuda:navatala_transformer_swizzle_layout_f16",
  5,
  kAbiArgs_cuda_navatala_transformer_swizzle_layout_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_hadamard_transform_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "vectorSize", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_hadamard_transform_f32 = {
  1,
  "navatala_transformer_hadamard_transform_f32",
  "cuda",
  "navatala_transformer_hadamard_transform_f32",
  "kernel:cuda:navatala_transformer_hadamard_transform_f32",
  "abi-r1:cuda:navatala_transformer_hadamard_transform_f32",
  "abi-r1:cuda:navatala_transformer_hadamard_transform_f32",
  4,
  kAbiArgs_cuda_navatala_transformer_hadamard_transform_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_hadamard_transform_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "vectorSize", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_hadamard_transform_f16 = {
  1,
  "navatala_transformer_hadamard_transform_f16",
  "cuda",
  "navatala_transformer_hadamard_transform_f16",
  "kernel:cuda:navatala_transformer_hadamard_transform_f16",
  "abi-r1:cuda:navatala_transformer_hadamard_transform_f16",
  "abi-r1:cuda:navatala_transformer_hadamard_transform_f16",
  4,
  kAbiArgs_cuda_navatala_transformer_hadamard_transform_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_permute_axes_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "dim0", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dim1", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dim2", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_permute_axes_f32 = {
  1,
  "navatala_transformer_permute_axes_f32",
  "cuda",
  "navatala_transformer_permute_axes_f32",
  "kernel:cuda:navatala_transformer_permute_axes_f32",
  "abi-r1:cuda:navatala_transformer_permute_axes_f32",
  "abi-r1:cuda:navatala_transformer_permute_axes_f32",
  10,
  kAbiArgs_cuda_navatala_transformer_permute_axes_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_permute_axes_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "dim0", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dim1", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dim2", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_permute_axes_f16 = {
  1,
  "navatala_transformer_permute_axes_f16",
  "cuda",
  "navatala_transformer_permute_axes_f16",
  "kernel:cuda:navatala_transformer_permute_axes_f16",
  "abi-r1:cuda:navatala_transformer_permute_axes_f16",
  "abi-r1:cuda:navatala_transformer_permute_axes_f16",
  10,
  kAbiArgs_cuda_navatala_transformer_permute_axes_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_pack_sequences_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqLengths", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqOffsets", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_pack_sequences_f32 = {
  1,
  "navatala_transformer_pack_sequences_f32",
  "cuda",
  "navatala_transformer_pack_sequences_f32",
  "kernel:cuda:navatala_transformer_pack_sequences_f32",
  "abi-r1:cuda:navatala_transformer_pack_sequences_f32",
  "abi-r1:cuda:navatala_transformer_pack_sequences_f32",
  8,
  kAbiArgs_cuda_navatala_transformer_pack_sequences_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_pack_sequences_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqLengths", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqOffsets", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_pack_sequences_f16 = {
  1,
  "navatala_transformer_pack_sequences_f16",
  "cuda",
  "navatala_transformer_pack_sequences_f16",
  "kernel:cuda:navatala_transformer_pack_sequences_f16",
  "abi-r1:cuda:navatala_transformer_pack_sequences_f16",
  "abi-r1:cuda:navatala_transformer_pack_sequences_f16",
  8,
  kAbiArgs_cuda_navatala_transformer_pack_sequences_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_unpack_sequences_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqLengths", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqOffsets", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_unpack_sequences_f32 = {
  1,
  "navatala_transformer_unpack_sequences_f32",
  "cuda",
  "navatala_transformer_unpack_sequences_f32",
  "kernel:cuda:navatala_transformer_unpack_sequences_f32",
  "abi-r1:cuda:navatala_transformer_unpack_sequences_f32",
  "abi-r1:cuda:navatala_transformer_unpack_sequences_f32",
  7,
  kAbiArgs_cuda_navatala_transformer_unpack_sequences_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_unpack_sequences_f16[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqLengths", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "seqOffsets", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "batchSize", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_unpack_sequences_f16 = {
  1,
  "navatala_transformer_unpack_sequences_f16",
  "cuda",
  "navatala_transformer_unpack_sequences_f16",
  "kernel:cuda:navatala_transformer_unpack_sequences_f16",
  "abi-r1:cuda:navatala_transformer_unpack_sequences_f16",
  "abi-r1:cuda:navatala_transformer_unpack_sequences_f16",
  7,
  kAbiArgs_cuda_navatala_transformer_unpack_sequences_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_generate_position_ids_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_generate_position_ids_f32 = {
  1,
  "navatala_transformer_generate_position_ids_f32",
  "cuda",
  "navatala_transformer_generate_position_ids_f32",
  "kernel:cuda:navatala_transformer_generate_position_ids_f32",
  "abi-r1:cuda:navatala_transformer_generate_position_ids_f32",
  "abi-r1:cuda:navatala_transformer_generate_position_ids_f32",
  3,
  kAbiArgs_cuda_navatala_transformer_generate_position_ids_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_generate_position_ids_u32[] = {
  { "batchSize", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "seqLen", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_generate_position_ids_u32 = {
  1,
  "navatala_transformer_generate_position_ids_u32",
  "cuda",
  "navatala_transformer_generate_position_ids_u32",
  "kernel:cuda:navatala_transformer_generate_position_ids_u32",
  "abi-r1:cuda:navatala_transformer_generate_position_ids_u32",
  "abi-r1:cuda:navatala_transformer_generate_position_ids_u32",
  3,
  kAbiArgs_cuda_navatala_transformer_generate_position_ids_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_generate_causal_mask_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_generate_causal_mask_f32 = {
  1,
  "navatala_transformer_generate_causal_mask_f32",
  "cuda",
  "navatala_transformer_generate_causal_mask_f32",
  "kernel:cuda:navatala_transformer_generate_causal_mask_f32",
  "abi-r1:cuda:navatala_transformer_generate_causal_mask_f32",
  "abi-r1:cuda:navatala_transformer_generate_causal_mask_f32",
  2,
  kAbiArgs_cuda_navatala_transformer_generate_causal_mask_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_generate_causal_mask_f16[] = {
  { "seqLen", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "output", 1, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_generate_causal_mask_f16 = {
  1,
  "navatala_transformer_generate_causal_mask_f16",
  "cuda",
  "navatala_transformer_generate_causal_mask_f16",
  "kernel:cuda:navatala_transformer_generate_causal_mask_f16",
  "abi-r1:cuda:navatala_transformer_generate_causal_mask_f16",
  "abi-r1:cuda:navatala_transformer_generate_causal_mask_f16",
  2,
  kAbiArgs_cuda_navatala_transformer_generate_causal_mask_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_precompute_rotary_emb_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_precompute_rotary_emb_f32 = {
  1,
  "navatala_transformer_precompute_rotary_emb_f32",
  "cuda",
  "navatala_transformer_precompute_rotary_emb_f32",
  "kernel:cuda:navatala_transformer_precompute_rotary_emb_f32",
  "abi-r1:cuda:navatala_transformer_precompute_rotary_emb_f32",
  "abi-r1:cuda:navatala_transformer_precompute_rotary_emb_f32",
  5,
  kAbiArgs_cuda_navatala_transformer_precompute_rotary_emb_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_transformer_precompute_rotary_emb_f16[] = {
  { "maxSeqLen", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "headDim", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "base", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "cosOutput", 3, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_transformer_precompute_rotary_emb_f16 = {
  1,
  "navatala_transformer_precompute_rotary_emb_f16",
  "cuda",
  "navatala_transformer_precompute_rotary_emb_f16",
  "kernel:cuda:navatala_transformer_precompute_rotary_emb_f16",
  "abi-r1:cuda:navatala_transformer_precompute_rotary_emb_f16",
  "abi-r1:cuda:navatala_transformer_precompute_rotary_emb_f16",
  5,
  kAbiArgs_cuda_navatala_transformer_precompute_rotary_emb_f16
};

bool tryGetKernelAbiManifest_cuda_transformer(const std::string& backend, const std::string& kernelName, const KernelAbiManifestInfo*& out) {
  if (backend == "cuda" && kernelName == "navatala_transformer_gelu_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_gelu_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_gelu_tanh_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_gelu_tanh_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_silu_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_silu_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_relu_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_relu_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_quick_gelu_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_quick_gelu_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_squared_relu_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_squared_relu_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_bias_gelu_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_bias_gelu_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_gelu_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_gelu_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_silu_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_silu_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_relu_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_relu_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_quick_gelu_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_quick_gelu_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_squared_relu_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_squared_relu_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_gelu_bf16") {
    out = &kAbiManifest_cuda_navatala_transformer_gelu_bf16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_silu_bf16") {
    out = &kAbiManifest_cuda_navatala_transformer_silu_bf16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_geglu_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_geglu_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_swiglu_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_swiglu_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_reglu_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_reglu_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_geglu_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_geglu_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_swiglu_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_swiglu_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_reglu_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_reglu_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_gelu_backward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_gelu_backward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_silu_backward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_silu_backward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_relu_backward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_relu_backward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_quick_gelu_backward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_quick_gelu_backward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_gelu_backward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_gelu_backward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_silu_backward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_silu_backward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_relu_backward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_relu_backward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_quick_gelu_backward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_quick_gelu_backward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_forward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_rms_norm_forward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_forward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_rms_norm_forward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_forward_bf16") {
    out = &kAbiManifest_cuda_navatala_transformer_rms_norm_forward_bf16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_forward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_layer_norm_forward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_forward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_layer_norm_forward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_forward_bf16") {
    out = &kAbiManifest_cuda_navatala_transformer_layer_norm_forward_bf16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_backward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_layer_norm_backward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_backward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_layer_norm_backward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_backward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_rms_norm_backward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_backward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_rms_norm_backward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_multi_pass_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_layer_norm_multi_pass_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_multi_pass_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_layer_norm_multi_pass_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_multi_pass_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_rms_norm_multi_pass_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_multi_pass_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_rms_norm_multi_pass_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_forward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_softmax_forward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_forward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_softmax_forward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_forward_bf16") {
    out = &kAbiManifest_cuda_navatala_transformer_softmax_forward_bf16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_backward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_softmax_backward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_backward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_softmax_backward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_with_mask_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_softmax_with_mask_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_with_mask_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_softmax_with_mask_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_with_mask_backward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_softmax_with_mask_backward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_with_mask_backward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_softmax_with_mask_backward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_multi_pass_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_softmax_multi_pass_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_multi_pass_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_softmax_multi_pass_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f32_to_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_cast_f32_to_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f16_to_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_cast_f16_to_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f32_to_bf16") {
    out = &kAbiManifest_cuda_navatala_transformer_cast_f32_to_bf16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_b_f16_to_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_cast_b_f16_to_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_transpose_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_transpose_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_transpose_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_transpose_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_fused_cast_transpose_f32_to_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_fused_cast_transpose_f32_to_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f32_to_f_p8_e4_m3") {
    out = &kAbiManifest_cuda_navatala_transformer_cast_f32_to_f_p8_e4_m3;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f_p8_e4_m3_to_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_cast_f_p8_e4_m3_to_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f32_to_f_p8_e5_m2") {
    out = &kAbiManifest_cuda_navatala_transformer_cast_f32_to_f_p8_e5_m2;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f_p8_e5_m2_to_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_cast_f_p8_e5_m2_to_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_fused_cast_transpose_f_p8") {
    out = &kAbiManifest_cuda_navatala_transformer_fused_cast_transpose_f_p8;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_transpose4_d_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_transpose4_d_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_transpose4_d_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_transpose4_d_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_dropout_forward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_dropout_forward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_dropout_forward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_dropout_forward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_dropout_backward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_dropout_backward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_dropout_backward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_dropout_backward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_forward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_rope_forward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_forward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_rope_forward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_forward_bf16") {
    out = &kAbiManifest_cuda_navatala_transformer_rope_forward_bf16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_with_cache_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_rope_with_cache_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_backward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_rope_backward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_backward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_rope_backward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_backward_bf16") {
    out = &kAbiManifest_cuda_navatala_transformer_rope_backward_bf16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_interleaved_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_rope_interleaved_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_interleaved_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_rope_interleaved_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_interleaved_bf16") {
    out = &kAbiManifest_cuda_navatala_transformer_rope_interleaved_bf16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_simple_attention_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_simple_attention_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_paged_attention_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_paged_attention_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_with_mask_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_simple_attention_with_mask_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_with_mask_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_simple_attention_with_mask_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_with_padding_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_simple_attention_with_padding_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_with_padding_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_simple_attention_with_padding_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_backward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_simple_attention_backward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_backward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_simple_attention_backward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_kv_cache_append_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_kv_cache_append_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_kv_cache_append_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_kv_cache_append_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_kv_cache_rotate_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_kv_cache_rotate_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_tiled_gemm_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_tiled_gemm_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_tiled_gemm_f16_f32_out") {
    out = &kAbiManifest_cuda_navatala_transformer_tiled_gemm_f16_f32_out;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_tiled_gemm_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_tiled_gemm_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_tiled_gemm_backward_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_tiled_gemm_backward_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_tiled_gemm_backward_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_tiled_gemm_backward_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_scale_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_multi_tensor_scale_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_scale_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_multi_tensor_scale_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_add_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_multi_tensor_add_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_add_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_multi_tensor_add_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_copy_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_multi_tensor_copy_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_copy_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_multi_tensor_copy_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_l2_norm_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_multi_tensor_l2_norm_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_l2_norm_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_multi_tensor_l2_norm_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_clip_grad_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_multi_tensor_clip_grad_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_clip_grad_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_multi_tensor_clip_grad_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_top_k_gating_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_top_k_gating_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_top_k_gating_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_top_k_gating_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_expert_capacity_mask_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_expert_capacity_mask_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_expert_capacity_mask_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_expert_capacity_mask_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_permute_tokens_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_permute_tokens_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_permute_tokens_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_permute_tokens_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_unpermute_tokens_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_unpermute_tokens_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_unpermute_tokens_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_unpermute_tokens_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_pad_sequence_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_pad_sequence_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_pad_sequence_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_pad_sequence_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_unpad_sequence_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_unpad_sequence_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_unpad_sequence_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_unpad_sequence_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_swizzle_layout_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_swizzle_layout_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_swizzle_layout_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_swizzle_layout_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_hadamard_transform_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_hadamard_transform_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_hadamard_transform_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_hadamard_transform_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_permute_axes_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_permute_axes_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_permute_axes_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_permute_axes_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_pack_sequences_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_pack_sequences_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_pack_sequences_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_pack_sequences_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_unpack_sequences_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_unpack_sequences_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_unpack_sequences_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_unpack_sequences_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_generate_position_ids_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_generate_position_ids_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_generate_position_ids_u32") {
    out = &kAbiManifest_cuda_navatala_transformer_generate_position_ids_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_generate_causal_mask_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_generate_causal_mask_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_generate_causal_mask_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_generate_causal_mask_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_precompute_rotary_emb_f32") {
    out = &kAbiManifest_cuda_navatala_transformer_precompute_rotary_emb_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_precompute_rotary_emb_f16") {
    out = &kAbiManifest_cuda_navatala_transformer_precompute_rotary_emb_f16;
    return true;
  }
  out = nullptr;
  return false;
...
bool tryGetKernelSource_cuda_transformer(const std::string& backend, const std::string& kernelName, GpuRuntime::ProgramSource& out) {
  if (backend == "cuda" && kernelName == "navatala_transformer_gelu_f32") {
    out.kind = GpuRuntime::ProgramSource::Kind::CudaCpp;
    out.entryPoint = "navatala_transformer_gelu_f32";
    std::string_view sv(k_cuda_navatala_transformer_gelu_f32);
  ...
  if (backend == "cuda" && kernelName == "navatala_transformer_gelu_tanh_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_gelu_tanh_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_silu_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_silu_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_relu_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_relu_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_quick_gelu_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_quick_gelu_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_squared_relu_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_squared_relu_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_bias_gelu_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_bias_gelu_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_gelu_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_gelu_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_silu_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_silu_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_relu_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_relu_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_quick_gelu_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_quick_gelu_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_squared_relu_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_squared_relu_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_gelu_bf16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_gelu_bf16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_silu_bf16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_silu_bf16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_geglu_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_geglu_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_swiglu_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_swiglu_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_reglu_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_reglu_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_geglu_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_geglu_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_swiglu_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_swiglu_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_reglu_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_reglu_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_gelu_backward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_gelu_backward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_silu_backward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_silu_backward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_relu_backward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_relu_backward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_quick_gelu_backward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_quick_gelu_backward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_gelu_backward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_gelu_backward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_silu_backward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_silu_backward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_relu_backward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_relu_backward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_quick_gelu_backward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_quick_gelu_backward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_forward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rms_norm_forward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_forward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rms_norm_forward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_forward_bf16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rms_norm_forward_bf16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_forward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_layer_norm_forward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_forward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_layer_norm_forward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_forward_bf16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_layer_norm_forward_bf16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_backward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_layer_norm_backward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_backward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_layer_norm_backward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_backward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rms_norm_backward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_backward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rms_norm_backward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_multi_pass_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_layer_norm_multi_pass_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_layer_norm_multi_pass_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_layer_norm_multi_pass_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_multi_pass_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rms_norm_multi_pass_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rms_norm_multi_pass_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rms_norm_multi_pass_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_forward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_softmax_forward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_forward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_softmax_forward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_forward_bf16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_softmax_forward_bf16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_backward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_softmax_backward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_backward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_softmax_backward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_with_mask_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_softmax_with_mask_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_with_mask_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_softmax_with_mask_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_with_mask_backward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_softmax_with_mask_backward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_with_mask_backward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_softmax_with_mask_backward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_multi_pass_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_softmax_multi_pass_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_softmax_multi_pass_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_softmax_multi_pass_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f32_to_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_cast_f32_to_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f16_to_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_cast_f16_to_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f32_to_bf16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_cast_f32_to_bf16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_b_f16_to_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_cast_b_f16_to_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_transpose_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_transpose_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_transpose_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_transpose_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_fused_cast_transpose_f32_to_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_fused_cast_transpose_f32_to_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f32_to_f_p8_e4_m3") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_cast_f32_to_f_p8_e4_m3);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f_p8_e4_m3_to_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_cast_f_p8_e4_m3_to_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f32_to_f_p8_e5_m2") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_cast_f32_to_f_p8_e5_m2);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_cast_f_p8_e5_m2_to_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_cast_f_p8_e5_m2_to_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_fused_cast_transpose_f_p8") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_fused_cast_transpose_f_p8);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_transpose4_d_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_transpose4_d_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_transpose4_d_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_transpose4_d_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_dropout_forward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_dropout_forward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_dropout_forward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_dropout_forward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_dropout_backward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_dropout_backward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_dropout_backward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_dropout_backward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_forward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rope_forward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_forward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rope_forward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_forward_bf16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rope_forward_bf16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_with_cache_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rope_with_cache_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_backward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rope_backward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_backward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rope_backward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_backward_bf16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rope_backward_bf16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_interleaved_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rope_interleaved_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_interleaved_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rope_interleaved_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_rope_interleaved_bf16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_rope_interleaved_bf16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_simple_attention_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_simple_attention_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_paged_attention_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_paged_attention_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_with_mask_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_simple_attention_with_mask_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_with_mask_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_simple_attention_with_mask_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_with_padding_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_simple_attention_with_padding_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_with_padding_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_simple_attention_with_padding_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_backward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_simple_attention_backward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_simple_attention_backward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_simple_attention_backward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_kv_cache_append_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_kv_cache_append_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_kv_cache_append_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_kv_cache_append_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_kv_cache_rotate_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_kv_cache_rotate_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_tiled_gemm_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_tiled_gemm_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_tiled_gemm_f16_f32_out") {
  ...
  if (backend == "cuda" && kernelName == "navatala_transformer_tiled_gemm_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_tiled_gemm_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_tiled_gemm_backward_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_tiled_gemm_backward_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_tiled_gemm_backward_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_tiled_gemm_backward_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_scale_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_multi_tensor_scale_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_scale_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_multi_tensor_scale_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_add_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_multi_tensor_add_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_add_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_multi_tensor_add_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_copy_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_multi_tensor_copy_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_copy_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_multi_tensor_copy_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_l2_norm_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_multi_tensor_l2_norm_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_l2_norm_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_multi_tensor_l2_norm_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_clip_grad_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_multi_tensor_clip_grad_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_multi_tensor_clip_grad_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_multi_tensor_clip_grad_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_top_k_gating_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_top_k_gating_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_top_k_gating_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_top_k_gating_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_expert_capacity_mask_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_expert_capacity_mask_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_expert_capacity_mask_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_expert_capacity_mask_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_permute_tokens_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_permute_tokens_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_permute_tokens_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_permute_tokens_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_unpermute_tokens_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_unpermute_tokens_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_unpermute_tokens_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_unpermute_tokens_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_pad_sequence_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_pad_sequence_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_pad_sequence_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_pad_sequence_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_unpad_sequence_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_unpad_sequence_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_unpad_sequence_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_unpad_sequence_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_swizzle_layout_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_swizzle_layout_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_swizzle_layout_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_swizzle_layout_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_hadamard_transform_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_hadamard_transform_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_hadamard_transform_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_hadamard_transform_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_permute_axes_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_permute_axes_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_permute_axes_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_permute_axes_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_pack_sequences_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_pack_sequences_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_pack_sequences_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_pack_sequences_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_unpack_sequences_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_unpack_sequences_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_unpack_sequences_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_unpack_sequences_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_generate_position_ids_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_generate_position_ids_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_generate_position_ids_u32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_generate_position_ids_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_generate_causal_mask_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_generate_causal_mask_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_generate_causal_mask_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_generate_causal_mask_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_precompute_rotary_emb_f32") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_precompute_rotary_emb_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_precompute_rotary_emb_f16") {
    ...
    std::string_view sv(k_cuda_navatala_transformer_precompute_rotary_emb_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_transformer_tiled_gemm_f16") {
