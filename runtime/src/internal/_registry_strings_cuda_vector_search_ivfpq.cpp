...
// Kernel registry partition for the `cuda_vector_search_ivfpq` bucket. Compiles
...
const char* k_cuda_navatala_vector_search_ivfpq_compute_centroid_distances_f32 = R"kernel(
...
const char* k_cuda_navatala_vector_search_ivfpq_compute_p_q_lookup_table_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_ivfpq_compute_p_q_distances_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_ivfpq_encode_p_q_codes = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_ivfpq_compute_residuals_f32 = R"kernel(
#include <cuda_runtime.h>
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_ivfpq_compute_centroid_distances_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_ivfpq_compute_centroid_distances_f32 = {
  1,
  "navatala_vector_search_ivfpq_compute_centroid_distances_f32",
  "cuda",
  "navatala_vector_search_ivfpq_compute_centroid_distances_f32",
  "kernel:cuda:navatala_vector_search_ivfpq_compute_centroid_distances_f32",
  "abi-r1:cuda:navatala_vector_search_ivfpq_compute_centroid_distances_f32",
  "abi-r1:cuda:navatala_vector_search_ivfpq_compute_centroid_distances_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_ivfpq_compute_centroid_distances_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_ivfpq_compute_p_q_lookup_table_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_ivfpq_compute_p_q_lookup_table_f32 = {
  1,
  "navatala_vector_search_ivfpq_compute_p_q_lookup_table_f32",
  "cuda",
  "navatala_vector_search_ivfpq_compute_p_q_lookup_table_f32",
  "kernel:cuda:navatala_vector_search_ivfpq_compute_p_q_lookup_table_f32",
  "abi-r1:cuda:navatala_vector_search_ivfpq_compute_p_q_lookup_table_f32",
  "abi-r1:cuda:navatala_vector_search_ivfpq_compute_p_q_lookup_table_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_ivfpq_compute_p_q_lookup_table_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_ivfpq_compute_p_q_distances_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_ivfpq_compute_p_q_distances_f32 = {
  1,
  "navatala_vector_search_ivfpq_compute_p_q_distances_f32",
  "cuda",
  "navatala_vector_search_ivfpq_compute_p_q_distances_f32",
  "kernel:cuda:navatala_vector_search_ivfpq_compute_p_q_distances_f32",
  "abi-r1:cuda:navatala_vector_search_ivfpq_compute_p_q_distances_f32",
  "abi-r1:cuda:navatala_vector_search_ivfpq_compute_p_q_distances_f32",
  9,
  kAbiArgs_cuda_navatala_vector_search_ivfpq_compute_p_q_distances_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_ivfpq_encode_p_q_codes[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_ivfpq_encode_p_q_codes = {
  1,
  "navatala_vector_search_ivfpq_encode_p_q_codes",
  "cuda",
  "navatala_vector_search_ivfpq_encode_p_q_codes",
  "kernel:cuda:navatala_vector_search_ivfpq_encode_p_q_codes",
  "abi-r1:cuda:navatala_vector_search_ivfpq_encode_p_q_codes",
  "abi-r1:cuda:navatala_vector_search_ivfpq_encode_p_q_codes",
  7,
  kAbiArgs_cuda_navatala_vector_search_ivfpq_encode_p_q_codes
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_ivfpq_compute_residuals_f32[] = {
  { "vectors", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "centroids", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_ivfpq_compute_residuals_f32 = {
  1,
  "navatala_vector_search_ivfpq_compute_residuals_f32",
  "cuda",
  "navatala_vector_search_ivfpq_compute_residuals_f32",
  "kernel:cuda:navatala_vector_search_ivfpq_compute_residuals_f32",
  "abi-r1:cuda:navatala_vector_search_ivfpq_compute_residuals_f32",
  "abi-r1:cuda:navatala_vector_search_ivfpq_compute_residuals_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_ivfpq_compute_residuals_f32
};
...
bool tryGetKernelAbiManifest_cuda_vector_search_ivfpq(const std::string& backend, const std::string& kernelName, const KernelAbiManifestInfo*& out) {
  if (backend == "cuda" && kernelName == "navatala_vector_search_ivfpq_compute_centroid_distances_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_ivfpq_compute_centroid_distances_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_ivfpq_compute_p_q_lookup_table_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_ivfpq_compute_p_q_lookup_table_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_ivfpq_compute_p_q_distances_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_ivfpq_compute_p_q_distances_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_ivfpq_encode_p_q_codes") {
    out = &kAbiManifest_cuda_navatala_vector_search_ivfpq_encode_p_q_codes;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_ivfpq_compute_residuals_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_ivfpq_compute_residuals_f32;
    return true;
  }
  out = nullptr;
  return false;
...
bool tryGetKernelSource_cuda_vector_search_ivfpq(const std::string& backend, const std::string& kernelName, GpuRuntime::ProgramSource& out) {
  if (backend == "cuda" && kernelName == "navatala_vector_search_ivfpq_compute_centroid_distances_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_ivfpq_compute_centroid_distances_f32);
  ...
  if (backend == "cuda" && kernelName == "navatala_vector_search_ivfpq_compute_p_q_lookup_table_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_ivfpq_compute_p_q_lookup_table_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_ivfpq_compute_p_q_distances_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_ivfpq_compute_p_q_distances_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_ivfpq_encode_p_q_codes") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_ivfpq_encode_p_q_codes);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_ivfpq_compute_residuals_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_ivfpq_compute_residuals_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  return false;
