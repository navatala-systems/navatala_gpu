...
// Kernel registry partition for the `hip_cfd_primitives` bucket. Compiles
...
const char* k_hip_navatala_cfd_primitives_average_face_scalar_to_cell = R"kernel(
...
const char* k_hip_navatala_cfd_primitives_evaluate_scalar_bc = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_evaluate_vector_bc = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_div_face_flux_csr = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_div_face_flux_csr_f64 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_div_face_flux_vector_csr = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_div_mu_dev2_t_grad_u_from_grad_v2 = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_face_scalar_product = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_grad_vol_scalar_gauss = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_grad_vol_vector_gauss = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_interp_scalar_face = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_interp_scalar_face_all = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_interp_vector_face = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_linear_upwind_scalar_face = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_phi_from_u = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_phi_from_u_boundary = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_phi_from_u_internal = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_phig_gravity = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_r_a_u_from_dt_rho = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_integrated = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_sp = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_sp_integrated = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_r_a_u_from_u_eqn_approx = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_r_a_u_from_u_eqn_approx_sp = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_rho_from_alpha = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_rho_phi_from_rho_and_phi = R"kernel(
#include <hip/hip_runtime.h>
...
const char* k_hip_navatala_cfd_primitives_sn_grad_scalar = R"kernel(
#include <hip/hip_runtime.h>
...
const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_average_face_scalar_to_cell[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_average_face_scalar_to_cell = {
  1,
  "navatala_cfd_primitives_average_face_scalar_to_cell",
  "hip",
  "navatala_cfd_primitives_average_face_scalar_to_cell",
  "kernel:hip:navatala_cfd_primitives_average_face_scalar_to_cell",
  "abi-r1:hip:navatala_cfd_primitives_average_face_scalar_to_cell",
  "abi-r1:hip:navatala_cfd_primitives_average_face_scalar_to_cell",
  7,
  kAbiArgs_hip_navatala_cfd_primitives_average_face_scalar_to_cell
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_evaluate_scalar_bc[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_evaluate_scalar_bc = {
  1,
  "navatala_cfd_primitives_evaluate_scalar_bc",
  "hip",
  "navatala_cfd_primitives_evaluate_scalar_bc",
  "kernel:hip:navatala_cfd_primitives_evaluate_scalar_bc",
  "abi-r1:hip:navatala_cfd_primitives_evaluate_scalar_bc",
  "abi-r1:hip:navatala_cfd_primitives_evaluate_scalar_bc",
  6,
  kAbiArgs_hip_navatala_cfd_primitives_evaluate_scalar_bc
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_evaluate_vector_bc[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_evaluate_vector_bc = {
  1,
  "navatala_cfd_primitives_evaluate_vector_bc",
  "hip",
  "navatala_cfd_primitives_evaluate_vector_bc",
  "kernel:hip:navatala_cfd_primitives_evaluate_vector_bc",
  "abi-r1:hip:navatala_cfd_primitives_evaluate_vector_bc",
  "abi-r1:hip:navatala_cfd_primitives_evaluate_vector_bc",
  12,
  kAbiArgs_hip_navatala_cfd_primitives_evaluate_vector_bc
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_div_face_flux_csr[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_div_face_flux_csr = {
  1,
  "navatala_cfd_primitives_div_face_flux_csr",
  "hip",
  "navatala_cfd_primitives_div_face_flux_csr",
  "kernel:hip:navatala_cfd_primitives_div_face_flux_csr",
  "abi-r1:hip:navatala_cfd_primitives_div_face_flux_csr",
  "abi-r1:hip:navatala_cfd_primitives_div_face_flux_csr",
  7,
  kAbiArgs_hip_navatala_cfd_primitives_div_face_flux_csr
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_div_face_flux_csr_f64[] = {
  { "offsets", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "faceIdx", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "sign", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "faceFlux", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_div_face_flux_csr_f64 = {
  1,
  "navatala_cfd_primitives_div_face_flux_csr_f64",
  "hip",
  "navatala_cfd_primitives_div_face_flux_csr_f64",
  "kernel:hip:navatala_cfd_primitives_div_face_flux_csr_f64",
  "abi-r1:hip:navatala_cfd_primitives_div_face_flux_csr_f64",
  "abi-r1:hip:navatala_cfd_primitives_div_face_flux_csr_f64",
  7,
  kAbiArgs_hip_navatala_cfd_primitives_div_face_flux_csr_f64
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_div_face_flux_vector_csr[] = {
  { "offsets", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "faceIdx", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "sign", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_div_face_flux_vector_csr = {
  1,
  "navatala_cfd_primitives_div_face_flux_vector_csr",
  "hip",
  "navatala_cfd_primitives_div_face_flux_vector_csr",
  "kernel:hip:navatala_cfd_primitives_div_face_flux_vector_csr",
  "abi-r1:hip:navatala_cfd_primitives_div_face_flux_vector_csr",
  "abi-r1:hip:navatala_cfd_primitives_div_face_flux_vector_csr",
  11,
  kAbiArgs_hip_navatala_cfd_primitives_div_face_flux_vector_csr
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_div_mu_dev2_t_grad_u_from_grad_v2[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_div_mu_dev2_t_grad_u_from_grad_v2 = {
  1,
  "navatala_cfd_primitives_div_mu_dev2_t_grad_u_from_grad_v2",
  "hip",
  "navatala_cfd_primitives_div_mu_dev2_t_grad_u_from_grad_v2",
  "kernel:hip:navatala_cfd_primitives_div_mu_dev2_t_grad_u_from_grad_v2",
  "abi-r1:hip:navatala_cfd_primitives_div_mu_dev2_t_grad_u_from_grad_v2",
  "abi-r1:hip:navatala_cfd_primitives_div_mu_dev2_t_grad_u_from_grad_v2",
  25,
  kAbiArgs_hip_navatala_cfd_primitives_div_mu_dev2_t_grad_u_from_grad_v2
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_face_scalar_product[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_face_scalar_product = {
  1,
  "navatala_cfd_primitives_face_scalar_product",
  "hip",
  "navatala_cfd_primitives_face_scalar_product",
  "kernel:hip:navatala_cfd_primitives_face_scalar_product",
  "abi-r1:hip:navatala_cfd_primitives_face_scalar_product",
  "abi-r1:hip:navatala_cfd_primitives_face_scalar_product",
  4,
  kAbiArgs_hip_navatala_cfd_primitives_face_scalar_product
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_grad_vol_scalar_gauss[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_grad_vol_scalar_gauss = {
  1,
  "navatala_cfd_primitives_grad_vol_scalar_gauss",
  "hip",
  "navatala_cfd_primitives_grad_vol_scalar_gauss",
  "kernel:hip:navatala_cfd_primitives_grad_vol_scalar_gauss",
  "abi-r1:hip:navatala_cfd_primitives_grad_vol_scalar_gauss",
  "abi-r1:hip:navatala_cfd_primitives_grad_vol_scalar_gauss",
  17,
  kAbiArgs_hip_navatala_cfd_primitives_grad_vol_scalar_gauss
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_grad_vol_vector_gauss[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_grad_vol_vector_gauss = {
  1,
  "navatala_cfd_primitives_grad_vol_vector_gauss",
  "hip",
  "navatala_cfd_primitives_grad_vol_vector_gauss",
  "kernel:hip:navatala_cfd_primitives_grad_vol_vector_gauss",
  "abi-r1:hip:navatala_cfd_primitives_grad_vol_vector_gauss",
  "abi-r1:hip:navatala_cfd_primitives_grad_vol_vector_gauss",
  27,
  kAbiArgs_hip_navatala_cfd_primitives_grad_vol_vector_gauss
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_interp_scalar_face[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_interp_scalar_face = {
  1,
  "navatala_cfd_primitives_interp_scalar_face",
  "hip",
  "navatala_cfd_primitives_interp_scalar_face",
  "kernel:hip:navatala_cfd_primitives_interp_scalar_face",
  "abi-r1:hip:navatala_cfd_primitives_interp_scalar_face",
  "abi-r1:hip:navatala_cfd_primitives_interp_scalar_face",
  8,
  kAbiArgs_hip_navatala_cfd_primitives_interp_scalar_face
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_interp_scalar_face_all[] = {
  { "cellPhi", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_interp_scalar_face_all = {
  1,
  "navatala_cfd_primitives_interp_scalar_face_all",
  "hip",
  "navatala_cfd_primitives_interp_scalar_face_all",
  "kernel:hip:navatala_cfd_primitives_interp_scalar_face_all",
  "abi-r1:hip:navatala_cfd_primitives_interp_scalar_face_all",
  "abi-r1:hip:navatala_cfd_primitives_interp_scalar_face_all",
  7,
  kAbiArgs_hip_navatala_cfd_primitives_interp_scalar_face_all
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_interp_vector_face[] = {
  { "owner", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "neighbour", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "weights", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_interp_vector_face = {
  1,
  "navatala_cfd_primitives_interp_vector_face",
  "hip",
  "navatala_cfd_primitives_interp_vector_face",
  "kernel:hip:navatala_cfd_primitives_interp_vector_face",
  "abi-r1:hip:navatala_cfd_primitives_interp_vector_face",
  "abi-r1:hip:navatala_cfd_primitives_interp_vector_face",
  14,
  kAbiArgs_hip_navatala_cfd_primitives_interp_vector_face
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_linear_upwind_scalar_face[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_linear_upwind_scalar_face = {
  1,
  "navatala_cfd_primitives_linear_upwind_scalar_face",
  "hip",
  "navatala_cfd_primitives_linear_upwind_scalar_face",
  "kernel:hip:navatala_cfd_primitives_linear_upwind_scalar_face",
  "abi-r1:hip:navatala_cfd_primitives_linear_upwind_scalar_face",
  "abi-r1:hip:navatala_cfd_primitives_linear_upwind_scalar_face",
  18,
  kAbiArgs_hip_navatala_cfd_primitives_linear_upwind_scalar_face
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_phi_from_u[] = {
  { "owner", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "neighbour", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "weights", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_phi_from_u = {
  1,
  "navatala_cfd_primitives_phi_from_u",
  "hip",
  "navatala_cfd_primitives_phi_from_u",
  "kernel:hip:navatala_cfd_primitives_phi_from_u",
  "abi-r1:hip:navatala_cfd_primitives_phi_from_u",
  "abi-r1:hip:navatala_cfd_primitives_phi_from_u",
  15,
  kAbiArgs_hip_navatala_cfd_primitives_phi_from_u
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_phi_from_u_boundary[] = {
  { "owner", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_phi_from_u_boundary = {
  1,
  "navatala_cfd_primitives_phi_from_u_boundary",
  "hip",
  "navatala_cfd_primitives_phi_from_u_boundary",
  "kernel:hip:navatala_cfd_primitives_phi_from_u_boundary",
  "abi-r1:hip:navatala_cfd_primitives_phi_from_u_boundary",
  "abi-r1:hip:navatala_cfd_primitives_phi_from_u_boundary",
  14,
  kAbiArgs_hip_navatala_cfd_primitives_phi_from_u_boundary
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_phi_from_u_internal[] = {
  { "owner", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "neighbour", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "weights", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "sfX", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_phi_from_u_internal = {
  1,
  "navatala_cfd_primitives_phi_from_u_internal",
  "hip",
  "navatala_cfd_primitives_phi_from_u_internal",
  "kernel:hip:navatala_cfd_primitives_phi_from_u_internal",
  "abi-r1:hip:navatala_cfd_primitives_phi_from_u_internal",
  "abi-r1:hip:navatala_cfd_primitives_phi_from_u_internal",
  11,
  kAbiArgs_hip_navatala_cfd_primitives_phi_from_u_internal
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_phig_gravity[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_phig_gravity = {
  1,
  "navatala_cfd_primitives_phig_gravity",
  "hip",
  "navatala_cfd_primitives_phig_gravity",
  "kernel:hip:navatala_cfd_primitives_phig_gravity",
  "abi-r1:hip:navatala_cfd_primitives_phig_gravity",
  "abi-r1:hip:navatala_cfd_primitives_phig_gravity",
  6,
  kAbiArgs_hip_navatala_cfd_primitives_phig_gravity
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_r_a_u_from_dt_rho[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_r_a_u_from_dt_rho = {
  1,
  "navatala_cfd_primitives_r_a_u_from_dt_rho",
  "hip",
  "navatala_cfd_primitives_r_a_u_from_dt_rho",
  "kernel:hip:navatala_cfd_primitives_r_a_u_from_dt_rho",
  "abi-r1:hip:navatala_cfd_primitives_r_a_u_from_dt_rho",
  "abi-r1:hip:navatala_cfd_primitives_r_a_u_from_dt_rho",
  4,
  kAbiArgs_hip_navatala_cfd_primitives_r_a_u_from_dt_rho
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_integrated[] = {
  { "rho", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_integrated = {
  1,
  "navatala_cfd_primitives_r_a_u_from_dt_rho_integrated",
  "hip",
  "navatala_cfd_primitives_r_a_u_from_dt_rho_integrated",
  "kernel:hip:navatala_cfd_primitives_r_a_u_from_dt_rho_integrated",
  "abi-r1:hip:navatala_cfd_primitives_r_a_u_from_dt_rho_integrated",
  "abi-r1:hip:navatala_cfd_primitives_r_a_u_from_dt_rho_integrated",
  5,
  kAbiArgs_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_integrated
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_sp[] = {
  { "rho", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_sp = {
  1,
  "navatala_cfd_primitives_r_a_u_from_dt_rho_sp",
  "hip",
  "navatala_cfd_primitives_r_a_u_from_dt_rho_sp",
  "kernel:hip:navatala_cfd_primitives_r_a_u_from_dt_rho_sp",
  "abi-r1:hip:navatala_cfd_primitives_r_a_u_from_dt_rho_sp",
  "abi-r1:hip:navatala_cfd_primitives_r_a_u_from_dt_rho_sp",
  5,
  kAbiArgs_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_sp
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_sp_integrated[] = {
  { "rho", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "sp", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_sp_integrated = {
  1,
  "navatala_cfd_primitives_r_a_u_from_dt_rho_sp_integrated",
  "hip",
  "navatala_cfd_primitives_r_a_u_from_dt_rho_sp_integrated",
  "kernel:hip:navatala_cfd_primitives_r_a_u_from_dt_rho_sp_integrated",
  "abi-r1:hip:navatala_cfd_primitives_r_a_u_from_dt_rho_sp_integrated",
  "abi-r1:hip:navatala_cfd_primitives_r_a_u_from_dt_rho_sp_integrated",
  6,
  kAbiArgs_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_sp_integrated
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_r_a_u_from_u_eqn_approx[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_r_a_u_from_u_eqn_approx = {
  1,
  "navatala_cfd_primitives_r_a_u_from_u_eqn_approx",
  "hip",
  "navatala_cfd_primitives_r_a_u_from_u_eqn_approx",
  "kernel:hip:navatala_cfd_primitives_r_a_u_from_u_eqn_approx",
  "abi-r1:hip:navatala_cfd_primitives_r_a_u_from_u_eqn_approx",
  "abi-r1:hip:navatala_cfd_primitives_r_a_u_from_u_eqn_approx",
  19,
  kAbiArgs_hip_navatala_cfd_primitives_r_a_u_from_u_eqn_approx
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_r_a_u_from_u_eqn_approx_sp[] = {
  { "rhoCell", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "muCell", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "phiFaces", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "rhoBcVal", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_r_a_u_from_u_eqn_approx_sp = {
  1,
  "navatala_cfd_primitives_r_a_u_from_u_eqn_approx_sp",
  "hip",
  "navatala_cfd_primitives_r_a_u_from_u_eqn_approx_sp",
  "kernel:hip:navatala_cfd_primitives_r_a_u_from_u_eqn_approx_sp",
  "abi-r1:hip:navatala_cfd_primitives_r_a_u_from_u_eqn_approx_sp",
  "abi-r1:hip:navatala_cfd_primitives_r_a_u_from_u_eqn_approx_sp",
  20,
  kAbiArgs_hip_navatala_cfd_primitives_r_a_u_from_u_eqn_approx_sp
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_rho_from_alpha[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_rho_from_alpha = {
  1,
  "navatala_cfd_primitives_rho_from_alpha",
  "hip",
  "navatala_cfd_primitives_rho_from_alpha",
  "kernel:hip:navatala_cfd_primitives_rho_from_alpha",
  "abi-r1:hip:navatala_cfd_primitives_rho_from_alpha",
  "abi-r1:hip:navatala_cfd_primitives_rho_from_alpha",
  4,
  kAbiArgs_hip_navatala_cfd_primitives_rho_from_alpha
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_rho_phi_from_rho_and_phi[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_rho_phi_from_rho_and_phi = {
  1,
  "navatala_cfd_primitives_rho_phi_from_rho_and_phi",
  "hip",
  "navatala_cfd_primitives_rho_phi_from_rho_and_phi",
  "kernel:hip:navatala_cfd_primitives_rho_phi_from_rho_and_phi",
  "abi-r1:hip:navatala_cfd_primitives_rho_phi_from_rho_and_phi",
  "abi-r1:hip:navatala_cfd_primitives_rho_phi_from_rho_and_phi",
  9,
  kAbiArgs_hip_navatala_cfd_primitives_rho_phi_from_rho_and_phi
};

const KernelArgumentInfo kAbiArgs_hip_navatala_cfd_primitives_sn_grad_scalar[] = {
...
const KernelAbiManifestInfo kAbiManifest_hip_navatala_cfd_primitives_sn_grad_scalar = {
  1,
  "navatala_cfd_primitives_sn_grad_scalar",
  "hip",
  "navatala_cfd_primitives_sn_grad_scalar",
  "kernel:hip:navatala_cfd_primitives_sn_grad_scalar",
  "abi-r1:hip:navatala_cfd_primitives_sn_grad_scalar",
  "abi-r1:hip:navatala_cfd_primitives_sn_grad_scalar",
  8,
  kAbiArgs_hip_navatala_cfd_primitives_sn_grad_scalar
};

bool tryGetKernelAbiManifest_hip_cfd_primitives(const std::string& backend, const std::string& kernelName, const KernelAbiManifestInfo*& out) {
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_average_face_scalar_to_cell") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_average_face_scalar_to_cell;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_evaluate_scalar_bc") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_evaluate_scalar_bc;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_evaluate_vector_bc") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_evaluate_vector_bc;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_div_face_flux_csr") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_div_face_flux_csr;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_div_face_flux_csr_f64") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_div_face_flux_csr_f64;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_div_face_flux_vector_csr") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_div_face_flux_vector_csr;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_div_mu_dev2_t_grad_u_from_grad_v2") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_div_mu_dev2_t_grad_u_from_grad_v2;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_face_scalar_product") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_face_scalar_product;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_grad_vol_scalar_gauss") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_grad_vol_scalar_gauss;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_grad_vol_vector_gauss") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_grad_vol_vector_gauss;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_interp_scalar_face") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_interp_scalar_face;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_interp_scalar_face_all") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_interp_scalar_face_all;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_interp_vector_face") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_interp_vector_face;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_linear_upwind_scalar_face") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_linear_upwind_scalar_face;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_phi_from_u") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_phi_from_u;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_phi_from_u_boundary") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_phi_from_u_boundary;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_phi_from_u_internal") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_phi_from_u_internal;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_phig_gravity") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_phig_gravity;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_r_a_u_from_dt_rho") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_r_a_u_from_dt_rho;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_r_a_u_from_dt_rho_integrated") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_integrated;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_r_a_u_from_dt_rho_sp") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_sp;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_r_a_u_from_dt_rho_sp_integrated") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_sp_integrated;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_r_a_u_from_u_eqn_approx") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_r_a_u_from_u_eqn_approx;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_r_a_u_from_u_eqn_approx_sp") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_r_a_u_from_u_eqn_approx_sp;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_rho_from_alpha") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_rho_from_alpha;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_rho_phi_from_rho_and_phi") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_rho_phi_from_rho_and_phi;
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_sn_grad_scalar") {
    out = &kAbiManifest_hip_navatala_cfd_primitives_sn_grad_scalar;
    return true;
  }
  out = nullptr;
  return false;
...
bool tryGetKernelSource_hip_cfd_primitives(const std::string& backend, const std::string& kernelName, GpuRuntime::ProgramSource& out) {
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_average_face_scalar_to_cell") {
    out.kind = GpuRuntime::ProgramSource::Kind::HipCpp;
    out.entryPoint = "navatala_cfd_primitives_average_face_scalar_to_cell";
    std::string_view sv(k_hip_navatala_cfd_primitives_average_face_scalar_to_cell);
  ...
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_evaluate_scalar_bc") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_evaluate_scalar_bc);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_evaluate_vector_bc") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_evaluate_vector_bc);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_div_face_flux_csr") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_div_face_flux_csr);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_div_face_flux_csr_f64") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_div_face_flux_csr_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_div_face_flux_vector_csr") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_div_face_flux_vector_csr);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_div_mu_dev2_t_grad_u_from_grad_v2") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_div_mu_dev2_t_grad_u_from_grad_v2);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_face_scalar_product") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_face_scalar_product);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_grad_vol_scalar_gauss") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_grad_vol_scalar_gauss);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_grad_vol_vector_gauss") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_grad_vol_vector_gauss);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_interp_scalar_face") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_interp_scalar_face);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_interp_scalar_face_all") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_interp_scalar_face_all);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_interp_vector_face") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_interp_vector_face);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_linear_upwind_scalar_face") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_linear_upwind_scalar_face);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_phi_from_u") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_phi_from_u);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_phi_from_u_boundary") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_phi_from_u_boundary);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_phi_from_u_internal") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_phi_from_u_internal);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_phig_gravity") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_phig_gravity);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_r_a_u_from_dt_rho") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_r_a_u_from_dt_rho);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_r_a_u_from_dt_rho_integrated") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_integrated);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_r_a_u_from_dt_rho_sp") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_sp);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_r_a_u_from_dt_rho_sp_integrated") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_r_a_u_from_dt_rho_sp_integrated);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_r_a_u_from_u_eqn_approx") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_r_a_u_from_u_eqn_approx);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_r_a_u_from_u_eqn_approx_sp") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_r_a_u_from_u_eqn_approx_sp);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_rho_from_alpha") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_rho_from_alpha);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_rho_phi_from_rho_and_phi") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_rho_phi_from_rho_and_phi);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "hip" && kernelName == "navatala_cfd_primitives_sn_grad_scalar") {
    ...
    std::string_view sv(k_hip_navatala_cfd_primitives_sn_grad_scalar);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  return false;
