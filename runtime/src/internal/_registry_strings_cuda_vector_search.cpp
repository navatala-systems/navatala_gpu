...
// Kernel registry partition for the `cuda_vector_search` bucket. Compiles
...
const char* k_cuda_navatala_vector_search_init_seeds_f32 = R"kernel(
...
const char* k_cuda_navatala_vector_search_expand_neighbors_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_check_visited = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_clear_visited = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_extract_results_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_compute_distances_batch_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_search_layer_greedy_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_select_neighbors_simple_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_select_neighbors_heuristic_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_update_candidate_list_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_extract_layer_results_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_init_search_state_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_mark_visited_batch = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_check_visited_batch = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_merge_multi_query_results_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_compute_neighbor_distances_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_greedy_search_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_robust_prune_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_insert_vertex_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_update_neighbors_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_random_init_neighbors_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_extract_search_results_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_batched_greedy_search_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_compute_centroid_distances_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_select_probes_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_scan_inverted_list_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_merge_probe_results_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_assign_to_cluster_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_count_cluster_sizes = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_populate_inverted_lists_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_initialize_random_graph = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_compute_graph_distances_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_nn_descent_join_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_build_reverse_graph = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_prune_graph_r_n_g_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_compact_pruned_graph = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_compute_vertex_degrees = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_prune_excess_degree = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_reorder_vertices_by_degree = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_compact_graph_edges = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_validate_graph_integrity = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_prune_excess_degree_sorted = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_accumulate_p_q_codebook_i32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_normalize_p_q_codebook_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_train_p_q_codebook_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_l2_squared_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_inner_product_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_l1_distance_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_batch_l2_to_neighbors_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_l2_squared_f16 = R"kernel(
#include <cuda_runtime.h>
#include <cuda_fp16.h>
...
const char* k_cuda_navatala_vector_search_cosine_similarity_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_linf_distance_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_hamming_distance_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_correlation_distance_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_jaccard_distance_u32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_assign_labels_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_accumulate_cluster_sums_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_update_centroids_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_clear_cluster_sums_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_clear_cluster_counts = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_reduce_inertia_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_bitonic_sort_step_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_per_row_top_k_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_merge_sorted_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_rerank_with_exact_distances_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_filter_by_threshold_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_merge_search_results_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_compute_recall_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_scalar_quantize_f32_to_i8 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_scalar_dequantize_i8_to_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_compute_quantized_distances_i8 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_encode_p_q_vectors_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_vector_search_decode_p_q_vectors_f32 = R"kernel(
#include <cuda_runtime.h>
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_init_seeds_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_init_seeds_f32 = {
  1,
  "navatala_vector_search_init_seeds_f32",
  "cuda",
  "navatala_vector_search_init_seeds_f32",
  "kernel:cuda:navatala_vector_search_init_seeds_f32",
  "abi-r1:cuda:navatala_vector_search_init_seeds_f32",
  "abi-r1:cuda:navatala_vector_search_init_seeds_f32",
  9,
  kAbiArgs_cuda_navatala_vector_search_init_seeds_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_expand_neighbors_f32[] = {
  { "queries", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "dataset", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_expand_neighbors_f32 = {
  1,
  "navatala_vector_search_expand_neighbors_f32",
  "cuda",
  "navatala_vector_search_expand_neighbors_f32",
  "kernel:cuda:navatala_vector_search_expand_neighbors_f32",
  "abi-r1:cuda:navatala_vector_search_expand_neighbors_f32",
  "abi-r1:cuda:navatala_vector_search_expand_neighbors_f32",
  10,
  kAbiArgs_cuda_navatala_vector_search_expand_neighbors_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_check_visited[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_check_visited = {
  1,
  "navatala_vector_search_check_visited",
  "cuda",
  "navatala_vector_search_check_visited",
  "kernel:cuda:navatala_vector_search_check_visited",
  "abi-r1:cuda:navatala_vector_search_check_visited",
  "abi-r1:cuda:navatala_vector_search_check_visited",
  5,
  kAbiArgs_cuda_navatala_vector_search_check_visited
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_clear_visited[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_clear_visited = {
  1,
  "navatala_vector_search_clear_visited",
  "cuda",
  "navatala_vector_search_clear_visited",
  "kernel:cuda:navatala_vector_search_clear_visited",
  "abi-r1:cuda:navatala_vector_search_clear_visited",
  "abi-r1:cuda:navatala_vector_search_clear_visited",
  2,
  kAbiArgs_cuda_navatala_vector_search_clear_visited
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_extract_results_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_extract_results_f32 = {
  1,
  "navatala_vector_search_extract_results_f32",
  "cuda",
  "navatala_vector_search_extract_results_f32",
  "kernel:cuda:navatala_vector_search_extract_results_f32",
  "abi-r1:cuda:navatala_vector_search_extract_results_f32",
  "abi-r1:cuda:navatala_vector_search_extract_results_f32",
  7,
  kAbiArgs_cuda_navatala_vector_search_extract_results_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_compute_distances_batch_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_compute_distances_batch_f32 = {
  1,
  "navatala_vector_search_compute_distances_batch_f32",
  "cuda",
  "navatala_vector_search_compute_distances_batch_f32",
  "kernel:cuda:navatala_vector_search_compute_distances_batch_f32",
  "abi-r1:cuda:navatala_vector_search_compute_distances_batch_f32",
  "abi-r1:cuda:navatala_vector_search_compute_distances_batch_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_compute_distances_batch_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_search_layer_greedy_f32[] = {
  { "queries", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "dataset", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "graph", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_search_layer_greedy_f32 = {
  1,
  "navatala_vector_search_search_layer_greedy_f32",
  "cuda",
  "navatala_vector_search_search_layer_greedy_f32",
  "kernel:cuda:navatala_vector_search_search_layer_greedy_f32",
  "abi-r1:cuda:navatala_vector_search_search_layer_greedy_f32",
  "abi-r1:cuda:navatala_vector_search_search_layer_greedy_f32",
  12,
  kAbiArgs_cuda_navatala_vector_search_search_layer_greedy_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_select_neighbors_simple_f32[] = {
  { "candidates", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_select_neighbors_simple_f32 = {
  1,
  "navatala_vector_search_select_neighbors_simple_f32",
  "cuda",
  "navatala_vector_search_select_neighbors_simple_f32",
  "kernel:cuda:navatala_vector_search_select_neighbors_simple_f32",
  "abi-r1:cuda:navatala_vector_search_select_neighbors_simple_f32",
  "abi-r1:cuda:navatala_vector_search_select_neighbors_simple_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_select_neighbors_simple_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_select_neighbors_heuristic_f32[] = {
  { "query", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "candidates", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_select_neighbors_heuristic_f32 = {
  1,
  "navatala_vector_search_select_neighbors_heuristic_f32",
  "cuda",
  "navatala_vector_search_select_neighbors_heuristic_f32",
  "kernel:cuda:navatala_vector_search_select_neighbors_heuristic_f32",
  "abi-r1:cuda:navatala_vector_search_select_neighbors_heuristic_f32",
  "abi-r1:cuda:navatala_vector_search_select_neighbors_heuristic_f32",
  9,
  kAbiArgs_cuda_navatala_vector_search_select_neighbors_heuristic_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_update_candidate_list_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_update_candidate_list_f32 = {
  1,
  "navatala_vector_search_update_candidate_list_f32",
  "cuda",
  "navatala_vector_search_update_candidate_list_f32",
  "kernel:cuda:navatala_vector_search_update_candidate_list_f32",
  "abi-r1:cuda:navatala_vector_search_update_candidate_list_f32",
  "abi-r1:cuda:navatala_vector_search_update_candidate_list_f32",
  8,
  kAbiArgs_cuda_navatala_vector_search_update_candidate_list_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_extract_layer_results_f32[] = {
  { "candidates", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "distances", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_extract_layer_results_f32 = {
  1,
  "navatala_vector_search_extract_layer_results_f32",
  "cuda",
  "navatala_vector_search_extract_layer_results_f32",
  "kernel:cuda:navatala_vector_search_extract_layer_results_f32",
  "abi-r1:cuda:navatala_vector_search_extract_layer_results_f32",
  "abi-r1:cuda:navatala_vector_search_extract_layer_results_f32",
  7,
  kAbiArgs_cuda_navatala_vector_search_extract_layer_results_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_init_search_state_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_init_search_state_f32 = {
  1,
  "navatala_vector_search_init_search_state_f32",
  "cuda",
  "navatala_vector_search_init_search_state_f32",
  "kernel:cuda:navatala_vector_search_init_search_state_f32",
  "abi-r1:cuda:navatala_vector_search_init_search_state_f32",
  "abi-r1:cuda:navatala_vector_search_init_search_state_f32",
  5,
  kAbiArgs_cuda_navatala_vector_search_init_search_state_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_mark_visited_batch[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_mark_visited_batch = {
  1,
  "navatala_vector_search_mark_visited_batch",
  "cuda",
  "navatala_vector_search_mark_visited_batch",
  "kernel:cuda:navatala_vector_search_mark_visited_batch",
  "abi-r1:cuda:navatala_vector_search_mark_visited_batch",
  "abi-r1:cuda:navatala_vector_search_mark_visited_batch",
  5,
  kAbiArgs_cuda_navatala_vector_search_mark_visited_batch
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_check_visited_batch[] = {
  { "node_ids", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "query_ids", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_nodes", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "visited_stride", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_check_visited_batch = {
  1,
  "navatala_vector_search_check_visited_batch",
  "cuda",
  "navatala_vector_search_check_visited_batch",
  "kernel:cuda:navatala_vector_search_check_visited_batch",
  "abi-r1:cuda:navatala_vector_search_check_visited_batch",
  "abi-r1:cuda:navatala_vector_search_check_visited_batch",
  6,
  kAbiArgs_cuda_navatala_vector_search_check_visited_batch
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_merge_multi_query_results_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_merge_multi_query_results_f32 = {
  1,
  "navatala_vector_search_merge_multi_query_results_f32",
  "cuda",
  "navatala_vector_search_merge_multi_query_results_f32",
  "kernel:cuda:navatala_vector_search_merge_multi_query_results_f32",
  "abi-r1:cuda:navatala_vector_search_merge_multi_query_results_f32",
  "abi-r1:cuda:navatala_vector_search_merge_multi_query_results_f32",
  7,
  kAbiArgs_cuda_navatala_vector_search_merge_multi_query_results_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_compute_neighbor_distances_f32[] = {
  { "query", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "dataset", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_compute_neighbor_distances_f32 = {
  1,
  "navatala_vector_search_compute_neighbor_distances_f32",
  "cuda",
  "navatala_vector_search_compute_neighbor_distances_f32",
  "kernel:cuda:navatala_vector_search_compute_neighbor_distances_f32",
  "abi-r1:cuda:navatala_vector_search_compute_neighbor_distances_f32",
  "abi-r1:cuda:navatala_vector_search_compute_neighbor_distances_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_compute_neighbor_distances_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_greedy_search_f32[] = {
  { "queries", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "dataset", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "graph", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "graph_degrees", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_greedy_search_f32 = {
  1,
  "navatala_vector_search_greedy_search_f32",
  "cuda",
  "navatala_vector_search_greedy_search_f32",
  "kernel:cuda:navatala_vector_search_greedy_search_f32",
  "abi-r1:cuda:navatala_vector_search_greedy_search_f32",
  "abi-r1:cuda:navatala_vector_search_greedy_search_f32",
  12,
  kAbiArgs_cuda_navatala_vector_search_greedy_search_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_robust_prune_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_robust_prune_f32 = {
  1,
  "navatala_vector_search_robust_prune_f32",
  "cuda",
  "navatala_vector_search_robust_prune_f32",
  "kernel:cuda:navatala_vector_search_robust_prune_f32",
  "abi-r1:cuda:navatala_vector_search_robust_prune_f32",
  "abi-r1:cuda:navatala_vector_search_robust_prune_f32",
  10,
  kAbiArgs_cuda_navatala_vector_search_robust_prune_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_insert_vertex_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_insert_vertex_f32 = {
  1,
  "navatala_vector_search_insert_vertex_f32",
  "cuda",
  "navatala_vector_search_insert_vertex_f32",
  "kernel:cuda:navatala_vector_search_insert_vertex_f32",
  "abi-r1:cuda:navatala_vector_search_insert_vertex_f32",
  "abi-r1:cuda:navatala_vector_search_insert_vertex_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_insert_vertex_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_update_neighbors_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_update_neighbors_f32 = {
  1,
  "navatala_vector_search_update_neighbors_f32",
  "cuda",
  "navatala_vector_search_update_neighbors_f32",
  "kernel:cuda:navatala_vector_search_update_neighbors_f32",
  "abi-r1:cuda:navatala_vector_search_update_neighbors_f32",
  "abi-r1:cuda:navatala_vector_search_update_neighbors_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_update_neighbors_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_random_init_neighbors_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_random_init_neighbors_f32 = {
  1,
  "navatala_vector_search_random_init_neighbors_f32",
  "cuda",
  "navatala_vector_search_random_init_neighbors_f32",
  "kernel:cuda:navatala_vector_search_random_init_neighbors_f32",
  "abi-r1:cuda:navatala_vector_search_random_init_neighbors_f32",
  "abi-r1:cuda:navatala_vector_search_random_init_neighbors_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_random_init_neighbors_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_extract_search_results_f32[] = {
  { "candidates", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_extract_search_results_f32 = {
  1,
  "navatala_vector_search_extract_search_results_f32",
  "cuda",
  "navatala_vector_search_extract_search_results_f32",
  "kernel:cuda:navatala_vector_search_extract_search_results_f32",
  "abi-r1:cuda:navatala_vector_search_extract_search_results_f32",
  "abi-r1:cuda:navatala_vector_search_extract_search_results_f32",
  8,
  kAbiArgs_cuda_navatala_vector_search_extract_search_results_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_batched_greedy_search_f32[] = {
  { "queries", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "dataset", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "graph", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "graph_degrees", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_batched_greedy_search_f32 = {
  1,
  "navatala_vector_search_batched_greedy_search_f32",
  "cuda",
  "navatala_vector_search_batched_greedy_search_f32",
  "kernel:cuda:navatala_vector_search_batched_greedy_search_f32",
  "abi-r1:cuda:navatala_vector_search_batched_greedy_search_f32",
  "abi-r1:cuda:navatala_vector_search_batched_greedy_search_f32",
  12,
  kAbiArgs_cuda_navatala_vector_search_batched_greedy_search_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_compute_centroid_distances_f32[] = {
  { "queries", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_compute_centroid_distances_f32 = {
  1,
  "navatala_vector_search_compute_centroid_distances_f32",
  "cuda",
  "navatala_vector_search_compute_centroid_distances_f32",
  "kernel:cuda:navatala_vector_search_compute_centroid_distances_f32",
  "abi-r1:cuda:navatala_vector_search_compute_centroid_distances_f32",
  "abi-r1:cuda:navatala_vector_search_compute_centroid_distances_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_compute_centroid_distances_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_select_probes_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_select_probes_f32 = {
  1,
  "navatala_vector_search_select_probes_f32",
  "cuda",
  "navatala_vector_search_select_probes_f32",
  "kernel:cuda:navatala_vector_search_select_probes_f32",
  "abi-r1:cuda:navatala_vector_search_select_probes_f32",
  "abi-r1:cuda:navatala_vector_search_select_probes_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_select_probes_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_scan_inverted_list_f32[] = {
  { "queries", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_scan_inverted_list_f32 = {
  1,
  "navatala_vector_search_scan_inverted_list_f32",
  "cuda",
  "navatala_vector_search_scan_inverted_list_f32",
  "kernel:cuda:navatala_vector_search_scan_inverted_list_f32",
  "abi-r1:cuda:navatala_vector_search_scan_inverted_list_f32",
  "abi-r1:cuda:navatala_vector_search_scan_inverted_list_f32",
  12,
  kAbiArgs_cuda_navatala_vector_search_scan_inverted_list_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_merge_probe_results_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_merge_probe_results_f32 = {
  1,
  "navatala_vector_search_merge_probe_results_f32",
  "cuda",
  "navatala_vector_search_merge_probe_results_f32",
  "kernel:cuda:navatala_vector_search_merge_probe_results_f32",
  "abi-r1:cuda:navatala_vector_search_merge_probe_results_f32",
  "abi-r1:cuda:navatala_vector_search_merge_probe_results_f32",
  9,
  kAbiArgs_cuda_navatala_vector_search_merge_probe_results_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_assign_to_cluster_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_assign_to_cluster_f32 = {
  1,
  "navatala_vector_search_assign_to_cluster_f32",
  "cuda",
  "navatala_vector_search_assign_to_cluster_f32",
  "kernel:cuda:navatala_vector_search_assign_to_cluster_f32",
  "abi-r1:cuda:navatala_vector_search_assign_to_cluster_f32",
  "abi-r1:cuda:navatala_vector_search_assign_to_cluster_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_assign_to_cluster_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_count_cluster_sizes[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_count_cluster_sizes = {
  1,
  "navatala_vector_search_count_cluster_sizes",
  "cuda",
  "navatala_vector_search_count_cluster_sizes",
  "kernel:cuda:navatala_vector_search_count_cluster_sizes",
  "abi-r1:cuda:navatala_vector_search_count_cluster_sizes",
  "abi-r1:cuda:navatala_vector_search_count_cluster_sizes",
  4,
  kAbiArgs_cuda_navatala_vector_search_count_cluster_sizes
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_populate_inverted_lists_f32[] = {
  { "vectors", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_populate_inverted_lists_f32 = {
  1,
  "navatala_vector_search_populate_inverted_lists_f32",
  "cuda",
  "navatala_vector_search_populate_inverted_lists_f32",
  "kernel:cuda:navatala_vector_search_populate_inverted_lists_f32",
  "abi-r1:cuda:navatala_vector_search_populate_inverted_lists_f32",
  "abi-r1:cuda:navatala_vector_search_populate_inverted_lists_f32",
  8,
  kAbiArgs_cuda_navatala_vector_search_populate_inverted_lists_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_initialize_random_graph[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_initialize_random_graph = {
  1,
  "navatala_vector_search_initialize_random_graph",
  "cuda",
  "navatala_vector_search_initialize_random_graph",
  "kernel:cuda:navatala_vector_search_initialize_random_graph",
  "abi-r1:cuda:navatala_vector_search_initialize_random_graph",
  "abi-r1:cuda:navatala_vector_search_initialize_random_graph",
  5,
  kAbiArgs_cuda_navatala_vector_search_initialize_random_graph
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_compute_graph_distances_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_compute_graph_distances_f32 = {
  1,
  "navatala_vector_search_compute_graph_distances_f32",
  "cuda",
  "navatala_vector_search_compute_graph_distances_f32",
  "kernel:cuda:navatala_vector_search_compute_graph_distances_f32",
  "abi-r1:cuda:navatala_vector_search_compute_graph_distances_f32",
  "abi-r1:cuda:navatala_vector_search_compute_graph_distances_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_compute_graph_distances_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_nn_descent_join_f32[] = {
  { "dataset", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "graph", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_nn_descent_join_f32 = {
  1,
  "navatala_vector_search_nn_descent_join_f32",
  "cuda",
  "navatala_vector_search_nn_descent_join_f32",
  "kernel:cuda:navatala_vector_search_nn_descent_join_f32",
  "abi-r1:cuda:navatala_vector_search_nn_descent_join_f32",
  "abi-r1:cuda:navatala_vector_search_nn_descent_join_f32",
  9,
  kAbiArgs_cuda_navatala_vector_search_nn_descent_join_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_build_reverse_graph[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_build_reverse_graph = {
  1,
  "navatala_vector_search_build_reverse_graph",
  "cuda",
  "navatala_vector_search_build_reverse_graph",
  "kernel:cuda:navatala_vector_search_build_reverse_graph",
  "abi-r1:cuda:navatala_vector_search_build_reverse_graph",
  "abi-r1:cuda:navatala_vector_search_build_reverse_graph",
  5,
  kAbiArgs_cuda_navatala_vector_search_build_reverse_graph
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_prune_graph_r_n_g_f32[] = {
  { "dataset", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "graph", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "graph_distances", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_nodes", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_prune_graph_r_n_g_f32 = {
  1,
  "navatala_vector_search_prune_graph_r_n_g_f32",
  "cuda",
  "navatala_vector_search_prune_graph_r_n_g_f32",
  "kernel:cuda:navatala_vector_search_prune_graph_r_n_g_f32",
  "abi-r1:cuda:navatala_vector_search_prune_graph_r_n_g_f32",
  "abi-r1:cuda:navatala_vector_search_prune_graph_r_n_g_f32",
  8,
  kAbiArgs_cuda_navatala_vector_search_prune_graph_r_n_g_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_compact_pruned_graph[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_compact_pruned_graph = {
  1,
  "navatala_vector_search_compact_pruned_graph",
  "cuda",
  "navatala_vector_search_compact_pruned_graph",
  "kernel:cuda:navatala_vector_search_compact_pruned_graph",
  "abi-r1:cuda:navatala_vector_search_compact_pruned_graph",
  "abi-r1:cuda:navatala_vector_search_compact_pruned_graph",
  7,
  kAbiArgs_cuda_navatala_vector_search_compact_pruned_graph
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_compute_vertex_degrees[] = {
  { "graph", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_compute_vertex_degrees = {
  1,
  "navatala_vector_search_compute_vertex_degrees",
  "cuda",
  "navatala_vector_search_compute_vertex_degrees",
  "kernel:cuda:navatala_vector_search_compute_vertex_degrees",
  "abi-r1:cuda:navatala_vector_search_compute_vertex_degrees",
  "abi-r1:cuda:navatala_vector_search_compute_vertex_degrees",
  5,
  kAbiArgs_cuda_navatala_vector_search_compute_vertex_degrees
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_prune_excess_degree[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_prune_excess_degree = {
  1,
  "navatala_vector_search_prune_excess_degree",
  "cuda",
  "navatala_vector_search_prune_excess_degree",
  "kernel:cuda:navatala_vector_search_prune_excess_degree",
  "abi-r1:cuda:navatala_vector_search_prune_excess_degree",
  "abi-r1:cuda:navatala_vector_search_prune_excess_degree",
  7,
  kAbiArgs_cuda_navatala_vector_search_prune_excess_degree
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_reorder_vertices_by_degree[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_reorder_vertices_by_degree = {
  1,
  "navatala_vector_search_reorder_vertices_by_degree",
  "cuda",
  "navatala_vector_search_reorder_vertices_by_degree",
  "kernel:cuda:navatala_vector_search_reorder_vertices_by_degree",
  "abi-r1:cuda:navatala_vector_search_reorder_vertices_by_degree",
  "abi-r1:cuda:navatala_vector_search_reorder_vertices_by_degree",
  6,
  kAbiArgs_cuda_navatala_vector_search_reorder_vertices_by_degree
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_compact_graph_edges[] = {
  { "graph", 0, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_vertices", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "max_degree", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "invalid_id", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_compact_graph_edges = {
  1,
  "navatala_vector_search_compact_graph_edges",
  "cuda",
  "navatala_vector_search_compact_graph_edges",
  "kernel:cuda:navatala_vector_search_compact_graph_edges",
  "abi-r1:cuda:navatala_vector_search_compact_graph_edges",
  "abi-r1:cuda:navatala_vector_search_compact_graph_edges",
  5,
  kAbiArgs_cuda_navatala_vector_search_compact_graph_edges
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_validate_graph_integrity[] = {
  { "graph", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_validate_graph_integrity = {
  1,
  "navatala_vector_search_validate_graph_integrity",
  "cuda",
  "navatala_vector_search_validate_graph_integrity",
  "kernel:cuda:navatala_vector_search_validate_graph_integrity",
  "abi-r1:cuda:navatala_vector_search_validate_graph_integrity",
  "abi-r1:cuda:navatala_vector_search_validate_graph_integrity",
  5,
  kAbiArgs_cuda_navatala_vector_search_validate_graph_integrity
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_prune_excess_degree_sorted[] = {
  { "graph", 0, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "neighbor_distances", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "degrees", 2, KernelArgumentRole::InputOutput, KernelAccessMode::ReadWrite, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_vertices", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_prune_excess_degree_sorted = {
  1,
  "navatala_vector_search_prune_excess_degree_sorted",
  "cuda",
  "navatala_vector_search_prune_excess_degree_sorted",
  "kernel:cuda:navatala_vector_search_prune_excess_degree_sorted",
  "abi-r1:cuda:navatala_vector_search_prune_excess_degree_sorted",
  "abi-r1:cuda:navatala_vector_search_prune_excess_degree_sorted",
  7,
  kAbiArgs_cuda_navatala_vector_search_prune_excess_degree_sorted
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_accumulate_p_q_codebook_i32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_accumulate_p_q_codebook_i32 = {
  1,
  "navatala_vector_search_accumulate_p_q_codebook_i32",
  "cuda",
  "navatala_vector_search_accumulate_p_q_codebook_i32",
  "kernel:cuda:navatala_vector_search_accumulate_p_q_codebook_i32",
  "abi-r1:cuda:navatala_vector_search_accumulate_p_q_codebook_i32",
  "abi-r1:cuda:navatala_vector_search_accumulate_p_q_codebook_i32",
  6,
  kAbiArgs_cuda_navatala_vector_search_accumulate_p_q_codebook_i32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_normalize_p_q_codebook_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_normalize_p_q_codebook_f32 = {
  1,
  "navatala_vector_search_normalize_p_q_codebook_f32",
  "cuda",
  "navatala_vector_search_normalize_p_q_codebook_f32",
  "kernel:cuda:navatala_vector_search_normalize_p_q_codebook_f32",
  "abi-r1:cuda:navatala_vector_search_normalize_p_q_codebook_f32",
  "abi-r1:cuda:navatala_vector_search_normalize_p_q_codebook_f32",
  5,
  kAbiArgs_cuda_navatala_vector_search_normalize_p_q_codebook_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_train_p_q_codebook_f32[] = {
  { "subvectors", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "assignments", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_vectors", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_train_p_q_codebook_f32 = {
  1,
  "navatala_vector_search_train_p_q_codebook_f32",
  "cuda",
  "navatala_vector_search_train_p_q_codebook_f32",
  "kernel:cuda:navatala_vector_search_train_p_q_codebook_f32",
  "abi-r1:cuda:navatala_vector_search_train_p_q_codebook_f32",
  "abi-r1:cuda:navatala_vector_search_train_p_q_codebook_f32",
  7,
  kAbiArgs_cuda_navatala_vector_search_train_p_q_codebook_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_l2_squared_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_l2_squared_f32 = {
  1,
  "navatala_vector_search_l2_squared_f32",
  "cuda",
  "navatala_vector_search_l2_squared_f32",
  "kernel:cuda:navatala_vector_search_l2_squared_f32",
  "abi-r1:cuda:navatala_vector_search_l2_squared_f32",
  "abi-r1:cuda:navatala_vector_search_l2_squared_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_l2_squared_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_inner_product_f32[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "y", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_x", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n_y", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_inner_product_f32 = {
  1,
  "navatala_vector_search_inner_product_f32",
  "cuda",
  "navatala_vector_search_inner_product_f32",
  "kernel:cuda:navatala_vector_search_inner_product_f32",
  "abi-r1:cuda:navatala_vector_search_inner_product_f32",
  "abi-r1:cuda:navatala_vector_search_inner_product_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_inner_product_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_l1_distance_f32[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "y", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_x", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n_y", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_l1_distance_f32 = {
  1,
  "navatala_vector_search_l1_distance_f32",
  "cuda",
  "navatala_vector_search_l1_distance_f32",
  "kernel:cuda:navatala_vector_search_l1_distance_f32",
  "abi-r1:cuda:navatala_vector_search_l1_distance_f32",
  "abi-r1:cuda:navatala_vector_search_l1_distance_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_l1_distance_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_batch_l2_to_neighbors_f32[] = {
  { "query", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "dataset", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_batch_l2_to_neighbors_f32 = {
  1,
  "navatala_vector_search_batch_l2_to_neighbors_f32",
  "cuda",
  "navatala_vector_search_batch_l2_to_neighbors_f32",
  "kernel:cuda:navatala_vector_search_batch_l2_to_neighbors_f32",
  "abi-r1:cuda:navatala_vector_search_batch_l2_to_neighbors_f32",
  "abi-r1:cuda:navatala_vector_search_batch_l2_to_neighbors_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_batch_l2_to_neighbors_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_l2_squared_f16[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "y", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_x", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n_y", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_l2_squared_f16 = {
  1,
  "navatala_vector_search_l2_squared_f16",
  "cuda",
  "navatala_vector_search_l2_squared_f16",
  "kernel:cuda:navatala_vector_search_l2_squared_f16",
  "abi-r1:cuda:navatala_vector_search_l2_squared_f16",
  "abi-r1:cuda:navatala_vector_search_l2_squared_f16",
  6,
  kAbiArgs_cuda_navatala_vector_search_l2_squared_f16
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_cosine_similarity_f32[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "y", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_x", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n_y", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_cosine_similarity_f32 = {
  1,
  "navatala_vector_search_cosine_similarity_f32",
  "cuda",
  "navatala_vector_search_cosine_similarity_f32",
  "kernel:cuda:navatala_vector_search_cosine_similarity_f32",
  "abi-r1:cuda:navatala_vector_search_cosine_similarity_f32",
  "abi-r1:cuda:navatala_vector_search_cosine_similarity_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_cosine_similarity_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_linf_distance_f32[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "y", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_x", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n_y", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_linf_distance_f32 = {
  1,
  "navatala_vector_search_linf_distance_f32",
  "cuda",
  "navatala_vector_search_linf_distance_f32",
  "kernel:cuda:navatala_vector_search_linf_distance_f32",
  "abi-r1:cuda:navatala_vector_search_linf_distance_f32",
  "abi-r1:cuda:navatala_vector_search_linf_distance_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_linf_distance_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_hamming_distance_u32[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "y", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_x", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n_y", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_hamming_distance_u32 = {
  1,
  "navatala_vector_search_hamming_distance_u32",
  "cuda",
  "navatala_vector_search_hamming_distance_u32",
  "kernel:cuda:navatala_vector_search_hamming_distance_u32",
  "abi-r1:cuda:navatala_vector_search_hamming_distance_u32",
  "abi-r1:cuda:navatala_vector_search_hamming_distance_u32",
  6,
  kAbiArgs_cuda_navatala_vector_search_hamming_distance_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_correlation_distance_f32[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "y", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_x", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n_y", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_correlation_distance_f32 = {
  1,
  "navatala_vector_search_correlation_distance_f32",
  "cuda",
  "navatala_vector_search_correlation_distance_f32",
  "kernel:cuda:navatala_vector_search_correlation_distance_f32",
  "abi-r1:cuda:navatala_vector_search_correlation_distance_f32",
  "abi-r1:cuda:navatala_vector_search_correlation_distance_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_correlation_distance_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_jaccard_distance_u32[] = {
  { "x", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "y", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_x", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "n_y", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_jaccard_distance_u32 = {
  1,
  "navatala_vector_search_jaccard_distance_u32",
  "cuda",
  "navatala_vector_search_jaccard_distance_u32",
  "kernel:cuda:navatala_vector_search_jaccard_distance_u32",
  "abi-r1:cuda:navatala_vector_search_jaccard_distance_u32",
  "abi-r1:cuda:navatala_vector_search_jaccard_distance_u32",
  6,
  kAbiArgs_cuda_navatala_vector_search_jaccard_distance_u32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_assign_labels_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_assign_labels_f32 = {
  1,
  "navatala_vector_search_assign_labels_f32",
  "cuda",
  "navatala_vector_search_assign_labels_f32",
  "kernel:cuda:navatala_vector_search_assign_labels_f32",
  "abi-r1:cuda:navatala_vector_search_assign_labels_f32",
  "abi-r1:cuda:navatala_vector_search_assign_labels_f32",
  7,
  kAbiArgs_cuda_navatala_vector_search_assign_labels_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_accumulate_cluster_sums_f32[] = {
  { "data", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "labels", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_points", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "k", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_accumulate_cluster_sums_f32 = {
  1,
  "navatala_vector_search_accumulate_cluster_sums_f32",
  "cuda",
  "navatala_vector_search_accumulate_cluster_sums_f32",
  "kernel:cuda:navatala_vector_search_accumulate_cluster_sums_f32",
  "abi-r1:cuda:navatala_vector_search_accumulate_cluster_sums_f32",
  "abi-r1:cuda:navatala_vector_search_accumulate_cluster_sums_f32",
  7,
  kAbiArgs_cuda_navatala_vector_search_accumulate_cluster_sums_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_update_centroids_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_update_centroids_f32 = {
  1,
  "navatala_vector_search_update_centroids_f32",
  "cuda",
  "navatala_vector_search_update_centroids_f32",
  "kernel:cuda:navatala_vector_search_update_centroids_f32",
  "abi-r1:cuda:navatala_vector_search_update_centroids_f32",
  "abi-r1:cuda:navatala_vector_search_update_centroids_f32",
  5,
  kAbiArgs_cuda_navatala_vector_search_update_centroids_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_clear_cluster_sums_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_clear_cluster_sums_f32 = {
  1,
  "navatala_vector_search_clear_cluster_sums_f32",
  "cuda",
  "navatala_vector_search_clear_cluster_sums_f32",
  "kernel:cuda:navatala_vector_search_clear_cluster_sums_f32",
  "abi-r1:cuda:navatala_vector_search_clear_cluster_sums_f32",
  "abi-r1:cuda:navatala_vector_search_clear_cluster_sums_f32",
  2,
  kAbiArgs_cuda_navatala_vector_search_clear_cluster_sums_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_clear_cluster_counts[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_clear_cluster_counts = {
  1,
  "navatala_vector_search_clear_cluster_counts",
  "cuda",
  "navatala_vector_search_clear_cluster_counts",
  "kernel:cuda:navatala_vector_search_clear_cluster_counts",
  "abi-r1:cuda:navatala_vector_search_clear_cluster_counts",
  "abi-r1:cuda:navatala_vector_search_clear_cluster_counts",
  2,
  kAbiArgs_cuda_navatala_vector_search_clear_cluster_counts
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_reduce_inertia_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_reduce_inertia_f32 = {
  1,
  "navatala_vector_search_reduce_inertia_f32",
  "cuda",
  "navatala_vector_search_reduce_inertia_f32",
  "kernel:cuda:navatala_vector_search_reduce_inertia_f32",
  "abi-r1:cuda:navatala_vector_search_reduce_inertia_f32",
  "abi-r1:cuda:navatala_vector_search_reduce_inertia_f32",
  3,
  kAbiArgs_cuda_navatala_vector_search_reduce_inertia_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_bitonic_sort_step_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_bitonic_sort_step_f32 = {
  1,
  "navatala_vector_search_bitonic_sort_step_f32",
  "cuda",
  "navatala_vector_search_bitonic_sort_step_f32",
  "kernel:cuda:navatala_vector_search_bitonic_sort_step_f32",
  "abi-r1:cuda:navatala_vector_search_bitonic_sort_step_f32",
  "abi-r1:cuda:navatala_vector_search_bitonic_sort_step_f32",
  5,
  kAbiArgs_cuda_navatala_vector_search_bitonic_sort_step_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_per_row_top_k_f32[] = {
  { "data", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_per_row_top_k_f32 = {
  1,
  "navatala_vector_search_per_row_top_k_f32",
  "cuda",
  "navatala_vector_search_per_row_top_k_f32",
  "kernel:cuda:navatala_vector_search_per_row_top_k_f32",
  "abi-r1:cuda:navatala_vector_search_per_row_top_k_f32",
  "abi-r1:cuda:navatala_vector_search_per_row_top_k_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_per_row_top_k_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_merge_sorted_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_merge_sorted_f32 = {
  1,
  "navatala_vector_search_merge_sorted_f32",
  "cuda",
  "navatala_vector_search_merge_sorted_f32",
  "kernel:cuda:navatala_vector_search_merge_sorted_f32",
  "abi-r1:cuda:navatala_vector_search_merge_sorted_f32",
  "abi-r1:cuda:navatala_vector_search_merge_sorted_f32",
  8,
  kAbiArgs_cuda_navatala_vector_search_merge_sorted_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_rerank_with_exact_distances_f32[] = {
  { "queries", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "dataset", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "candidate_ids", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_queries", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_rerank_with_exact_distances_f32 = {
  1,
  "navatala_vector_search_rerank_with_exact_distances_f32",
  "cuda",
  "navatala_vector_search_rerank_with_exact_distances_f32",
  "kernel:cuda:navatala_vector_search_rerank_with_exact_distances_f32",
  "abi-r1:cuda:navatala_vector_search_rerank_with_exact_distances_f32",
  "abi-r1:cuda:navatala_vector_search_rerank_with_exact_distances_f32",
  7,
  kAbiArgs_cuda_navatala_vector_search_rerank_with_exact_distances_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_filter_by_threshold_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_filter_by_threshold_f32 = {
  1,
  "navatala_vector_search_filter_by_threshold_f32",
  "cuda",
  "navatala_vector_search_filter_by_threshold_f32",
  "kernel:cuda:navatala_vector_search_filter_by_threshold_f32",
  "abi-r1:cuda:navatala_vector_search_filter_by_threshold_f32",
  "abi-r1:cuda:navatala_vector_search_filter_by_threshold_f32",
  7,
  kAbiArgs_cuda_navatala_vector_search_filter_by_threshold_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_merge_search_results_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_merge_search_results_f32 = {
  1,
  "navatala_vector_search_merge_search_results_f32",
  "cuda",
  "navatala_vector_search_merge_search_results_f32",
  "kernel:cuda:navatala_vector_search_merge_search_results_f32",
  "abi-r1:cuda:navatala_vector_search_merge_search_results_f32",
  "abi-r1:cuda:navatala_vector_search_merge_search_results_f32",
  10,
  kAbiArgs_cuda_navatala_vector_search_merge_search_results_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_compute_recall_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_compute_recall_f32 = {
  1,
  "navatala_vector_search_compute_recall_f32",
  "cuda",
  "navatala_vector_search_compute_recall_f32",
  "kernel:cuda:navatala_vector_search_compute_recall_f32",
  "abi-r1:cuda:navatala_vector_search_compute_recall_f32",
  "abi-r1:cuda:navatala_vector_search_compute_recall_f32",
  5,
  kAbiArgs_cuda_navatala_vector_search_compute_recall_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_scalar_quantize_f32_to_i8[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_scalar_quantize_f32_to_i8 = {
  1,
  "navatala_vector_search_scalar_quantize_f32_to_i8",
  "cuda",
  "navatala_vector_search_scalar_quantize_f32_to_i8",
  "kernel:cuda:navatala_vector_search_scalar_quantize_f32_to_i8",
  "abi-r1:cuda:navatala_vector_search_scalar_quantize_f32_to_i8",
  "abi-r1:cuda:navatala_vector_search_scalar_quantize_f32_to_i8",
  6,
  kAbiArgs_cuda_navatala_vector_search_scalar_quantize_f32_to_i8
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_scalar_dequantize_i8_to_f32[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_vectors", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "dim", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "mins", 3, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_scalar_dequantize_i8_to_f32 = {
  1,
  "navatala_vector_search_scalar_dequantize_i8_to_f32",
  "cuda",
  "navatala_vector_search_scalar_dequantize_i8_to_f32",
  "kernel:cuda:navatala_vector_search_scalar_dequantize_i8_to_f32",
  "abi-r1:cuda:navatala_vector_search_scalar_dequantize_i8_to_f32",
  "abi-r1:cuda:navatala_vector_search_scalar_dequantize_i8_to_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_scalar_dequantize_i8_to_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_compute_quantized_distances_i8[] = {
  { "queries", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "dataset", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "n_queries", 2, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_compute_quantized_distances_i8 = {
  1,
  "navatala_vector_search_compute_quantized_distances_i8",
  "cuda",
  "navatala_vector_search_compute_quantized_distances_i8",
  "kernel:cuda:navatala_vector_search_compute_quantized_distances_i8",
  "abi-r1:cuda:navatala_vector_search_compute_quantized_distances_i8",
  "abi-r1:cuda:navatala_vector_search_compute_quantized_distances_i8",
  7,
  kAbiArgs_cuda_navatala_vector_search_compute_quantized_distances_i8
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_encode_p_q_vectors_f32[] = {
  { "subvectors", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_encode_p_q_vectors_f32 = {
  1,
  "navatala_vector_search_encode_p_q_vectors_f32",
  "cuda",
  "navatala_vector_search_encode_p_q_vectors_f32",
  "kernel:cuda:navatala_vector_search_encode_p_q_vectors_f32",
  "abi-r1:cuda:navatala_vector_search_encode_p_q_vectors_f32",
  "abi-r1:cuda:navatala_vector_search_encode_p_q_vectors_f32",
  6,
  kAbiArgs_cuda_navatala_vector_search_encode_p_q_vectors_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_vector_search_decode_p_q_vectors_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_vector_search_decode_p_q_vectors_f32 = {
  1,
  "navatala_vector_search_decode_p_q_vectors_f32",
  "cuda",
  "navatala_vector_search_decode_p_q_vectors_f32",
  "kernel:cuda:navatala_vector_search_decode_p_q_vectors_f32",
  "abi-r1:cuda:navatala_vector_search_decode_p_q_vectors_f32",
  "abi-r1:cuda:navatala_vector_search_decode_p_q_vectors_f32",
  5,
  kAbiArgs_cuda_navatala_vector_search_decode_p_q_vectors_f32
};

bool tryGetKernelAbiManifest_cuda_vector_search(const std::string& backend, const std::string& kernelName, const KernelAbiManifestInfo*& out) {
  if (backend == "cuda" && kernelName == "navatala_vector_search_init_seeds_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_init_seeds_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_expand_neighbors_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_expand_neighbors_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_check_visited") {
    out = &kAbiManifest_cuda_navatala_vector_search_check_visited;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_clear_visited") {
    out = &kAbiManifest_cuda_navatala_vector_search_clear_visited;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_extract_results_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_extract_results_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_distances_batch_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_compute_distances_batch_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_search_layer_greedy_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_search_layer_greedy_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_select_neighbors_simple_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_select_neighbors_simple_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_select_neighbors_heuristic_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_select_neighbors_heuristic_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_update_candidate_list_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_update_candidate_list_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_extract_layer_results_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_extract_layer_results_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_init_search_state_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_init_search_state_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_mark_visited_batch") {
    out = &kAbiManifest_cuda_navatala_vector_search_mark_visited_batch;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_check_visited_batch") {
    out = &kAbiManifest_cuda_navatala_vector_search_check_visited_batch;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_merge_multi_query_results_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_merge_multi_query_results_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_neighbor_distances_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_compute_neighbor_distances_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_greedy_search_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_greedy_search_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_robust_prune_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_robust_prune_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_insert_vertex_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_insert_vertex_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_update_neighbors_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_update_neighbors_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_random_init_neighbors_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_random_init_neighbors_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_extract_search_results_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_extract_search_results_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_batched_greedy_search_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_batched_greedy_search_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_centroid_distances_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_compute_centroid_distances_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_select_probes_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_select_probes_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_scan_inverted_list_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_scan_inverted_list_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_merge_probe_results_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_merge_probe_results_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_assign_to_cluster_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_assign_to_cluster_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_count_cluster_sizes") {
    out = &kAbiManifest_cuda_navatala_vector_search_count_cluster_sizes;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_populate_inverted_lists_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_populate_inverted_lists_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_initialize_random_graph") {
    out = &kAbiManifest_cuda_navatala_vector_search_initialize_random_graph;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_graph_distances_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_compute_graph_distances_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_nn_descent_join_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_nn_descent_join_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_build_reverse_graph") {
    out = &kAbiManifest_cuda_navatala_vector_search_build_reverse_graph;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_prune_graph_r_n_g_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_prune_graph_r_n_g_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compact_pruned_graph") {
    out = &kAbiManifest_cuda_navatala_vector_search_compact_pruned_graph;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_vertex_degrees") {
    out = &kAbiManifest_cuda_navatala_vector_search_compute_vertex_degrees;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_prune_excess_degree") {
    out = &kAbiManifest_cuda_navatala_vector_search_prune_excess_degree;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_reorder_vertices_by_degree") {
    out = &kAbiManifest_cuda_navatala_vector_search_reorder_vertices_by_degree;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compact_graph_edges") {
    out = &kAbiManifest_cuda_navatala_vector_search_compact_graph_edges;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_validate_graph_integrity") {
    out = &kAbiManifest_cuda_navatala_vector_search_validate_graph_integrity;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_prune_excess_degree_sorted") {
    out = &kAbiManifest_cuda_navatala_vector_search_prune_excess_degree_sorted;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_accumulate_p_q_codebook_i32") {
    out = &kAbiManifest_cuda_navatala_vector_search_accumulate_p_q_codebook_i32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_normalize_p_q_codebook_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_normalize_p_q_codebook_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_train_p_q_codebook_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_train_p_q_codebook_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_l2_squared_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_l2_squared_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_inner_product_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_inner_product_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_l1_distance_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_l1_distance_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_batch_l2_to_neighbors_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_batch_l2_to_neighbors_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_l2_squared_f16") {
    out = &kAbiManifest_cuda_navatala_vector_search_l2_squared_f16;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_cosine_similarity_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_cosine_similarity_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_linf_distance_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_linf_distance_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_hamming_distance_u32") {
    out = &kAbiManifest_cuda_navatala_vector_search_hamming_distance_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_correlation_distance_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_correlation_distance_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_jaccard_distance_u32") {
    out = &kAbiManifest_cuda_navatala_vector_search_jaccard_distance_u32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_assign_labels_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_assign_labels_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_accumulate_cluster_sums_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_accumulate_cluster_sums_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_update_centroids_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_update_centroids_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_clear_cluster_sums_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_clear_cluster_sums_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_clear_cluster_counts") {
    out = &kAbiManifest_cuda_navatala_vector_search_clear_cluster_counts;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_reduce_inertia_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_reduce_inertia_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_bitonic_sort_step_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_bitonic_sort_step_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_per_row_top_k_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_per_row_top_k_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_merge_sorted_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_merge_sorted_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_rerank_with_exact_distances_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_rerank_with_exact_distances_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_filter_by_threshold_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_filter_by_threshold_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_merge_search_results_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_merge_search_results_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_recall_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_compute_recall_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_scalar_quantize_f32_to_i8") {
    out = &kAbiManifest_cuda_navatala_vector_search_scalar_quantize_f32_to_i8;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_scalar_dequantize_i8_to_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_scalar_dequantize_i8_to_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_quantized_distances_i8") {
    out = &kAbiManifest_cuda_navatala_vector_search_compute_quantized_distances_i8;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_encode_p_q_vectors_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_encode_p_q_vectors_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_decode_p_q_vectors_f32") {
    out = &kAbiManifest_cuda_navatala_vector_search_decode_p_q_vectors_f32;
    return true;
  }
  out = nullptr;
  return false;
...
bool tryGetKernelSource_cuda_vector_search(const std::string& backend, const std::string& kernelName, GpuRuntime::ProgramSource& out) {
  if (backend == "cuda" && kernelName == "navatala_vector_search_init_seeds_f32") {
    out.kind = GpuRuntime::ProgramSource::Kind::CudaCpp;
    out.entryPoint = "navatala_vector_search_init_seeds_f32";
    std::string_view sv(k_cuda_navatala_vector_search_init_seeds_f32);
  ...
  if (backend == "cuda" && kernelName == "navatala_vector_search_expand_neighbors_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_expand_neighbors_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_check_visited") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_check_visited);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_clear_visited") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_clear_visited);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_extract_results_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_extract_results_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_distances_batch_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_compute_distances_batch_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_search_layer_greedy_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_search_layer_greedy_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_select_neighbors_simple_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_select_neighbors_simple_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_select_neighbors_heuristic_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_select_neighbors_heuristic_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_update_candidate_list_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_update_candidate_list_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_extract_layer_results_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_extract_layer_results_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_init_search_state_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_init_search_state_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_mark_visited_batch") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_mark_visited_batch);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_check_visited_batch") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_check_visited_batch);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_merge_multi_query_results_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_merge_multi_query_results_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_neighbor_distances_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_compute_neighbor_distances_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_greedy_search_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_greedy_search_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_robust_prune_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_robust_prune_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_insert_vertex_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_insert_vertex_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_update_neighbors_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_update_neighbors_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_random_init_neighbors_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_random_init_neighbors_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_extract_search_results_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_extract_search_results_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_batched_greedy_search_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_batched_greedy_search_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_centroid_distances_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_compute_centroid_distances_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_select_probes_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_select_probes_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_scan_inverted_list_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_scan_inverted_list_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_merge_probe_results_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_merge_probe_results_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_assign_to_cluster_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_assign_to_cluster_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_count_cluster_sizes") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_count_cluster_sizes);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_populate_inverted_lists_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_populate_inverted_lists_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_initialize_random_graph") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_initialize_random_graph);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_graph_distances_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_compute_graph_distances_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_nn_descent_join_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_nn_descent_join_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_build_reverse_graph") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_build_reverse_graph);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_prune_graph_r_n_g_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_prune_graph_r_n_g_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compact_pruned_graph") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_compact_pruned_graph);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_vertex_degrees") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_compute_vertex_degrees);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_prune_excess_degree") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_prune_excess_degree);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_reorder_vertices_by_degree") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_reorder_vertices_by_degree);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compact_graph_edges") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_compact_graph_edges);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_validate_graph_integrity") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_validate_graph_integrity);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_prune_excess_degree_sorted") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_prune_excess_degree_sorted);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_accumulate_p_q_codebook_i32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_accumulate_p_q_codebook_i32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_normalize_p_q_codebook_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_normalize_p_q_codebook_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_train_p_q_codebook_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_train_p_q_codebook_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_l2_squared_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_l2_squared_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_inner_product_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_inner_product_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_l1_distance_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_l1_distance_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_batch_l2_to_neighbors_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_batch_l2_to_neighbors_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_l2_squared_f16") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_l2_squared_f16);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_cosine_similarity_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_cosine_similarity_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_linf_distance_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_linf_distance_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_hamming_distance_u32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_hamming_distance_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_correlation_distance_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_correlation_distance_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_jaccard_distance_u32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_jaccard_distance_u32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_assign_labels_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_assign_labels_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_accumulate_cluster_sums_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_accumulate_cluster_sums_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_update_centroids_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_update_centroids_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_clear_cluster_sums_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_clear_cluster_sums_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_clear_cluster_counts") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_clear_cluster_counts);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_reduce_inertia_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_reduce_inertia_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_bitonic_sort_step_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_bitonic_sort_step_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_per_row_top_k_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_per_row_top_k_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_merge_sorted_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_merge_sorted_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_rerank_with_exact_distances_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_rerank_with_exact_distances_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_filter_by_threshold_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_filter_by_threshold_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_merge_search_results_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_merge_search_results_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_recall_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_compute_recall_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_scalar_quantize_f32_to_i8") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_scalar_quantize_f32_to_i8);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_scalar_dequantize_i8_to_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_scalar_dequantize_i8_to_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_compute_quantized_distances_i8") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_compute_quantized_distances_i8);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_encode_p_q_vectors_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_encode_p_q_vectors_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_vector_search_decode_p_q_vectors_f32") {
    ...
    std::string_view sv(k_cuda_navatala_vector_search_decode_p_q_vectors_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  return false;
