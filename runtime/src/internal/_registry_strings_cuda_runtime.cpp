...
// Kernel registry partition for the `cuda_runtime` bucket. Compiles
...
const char* k_cuda_navatala_runtime_deterministic_reduce_f32 = R"kernel(
...
const char* k_cuda_navatala_runtime_deterministic_reduce_f64 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_runtime_deterministic_histogram_f32 = R"kernel(
#include <cuda_runtime.h>
...
const char* k_cuda_navatala_runtime_deterministic_histogram_f64 = R"kernel(
#include <cuda_runtime.h>
...
const KernelArgumentInfo kAbiArgs_cuda_navatala_runtime_deterministic_reduce_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_runtime_deterministic_reduce_f32 = {
  1,
  "navatala_runtime_deterministic_reduce_f32",
  "cuda",
  "navatala_runtime_deterministic_reduce_f32",
  "kernel:cuda:navatala_runtime_deterministic_reduce_f32",
  "abi-r1:cuda:navatala_runtime_deterministic_reduce_f32",
  "abi-r1:cuda:navatala_runtime_deterministic_reduce_f32",
  3,
  kAbiArgs_cuda_navatala_runtime_deterministic_reduce_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_runtime_deterministic_reduce_f64[] = {
  { "input", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "count", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
  { "result", 2, KernelArgumentRole::Output, KernelAccessMode::WriteOnly, GpuRuntime::MemoryKind::Device, true, 8, 8, 256, nullptr, 0, 0 }
};
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_runtime_deterministic_reduce_f64 = {
  1,
  "navatala_runtime_deterministic_reduce_f64",
  "cuda",
  "navatala_runtime_deterministic_reduce_f64",
  "kernel:cuda:navatala_runtime_deterministic_reduce_f64",
  "abi-r1:cuda:navatala_runtime_deterministic_reduce_f64",
  "abi-r1:cuda:navatala_runtime_deterministic_reduce_f64",
  3,
  kAbiArgs_cuda_navatala_runtime_deterministic_reduce_f64
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_runtime_deterministic_histogram_f32[] = {
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_runtime_deterministic_histogram_f32 = {
  1,
  "navatala_runtime_deterministic_histogram_f32",
  "cuda",
  "navatala_runtime_deterministic_histogram_f32",
  "kernel:cuda:navatala_runtime_deterministic_histogram_f32",
  "abi-r1:cuda:navatala_runtime_deterministic_histogram_f32",
  "abi-r1:cuda:navatala_runtime_deterministic_histogram_f32",
  6,
  kAbiArgs_cuda_navatala_runtime_deterministic_histogram_f32
};

const KernelArgumentInfo kAbiArgs_cuda_navatala_runtime_deterministic_histogram_f64[] = {
  { "values", 0, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 0, 0, 256, nullptr, 0, 0 },
  { "numBins", 1, KernelArgumentRole::Input, KernelAccessMode::ReadOnly, GpuRuntime::MemoryKind::Device, true, 4, 4, 256, nullptr, 0, 0 },
...
const KernelAbiManifestInfo kAbiManifest_cuda_navatala_runtime_deterministic_histogram_f64 = {
  1,
  "navatala_runtime_deterministic_histogram_f64",
  "cuda",
  "navatala_runtime_deterministic_histogram_f64",
  "kernel:cuda:navatala_runtime_deterministic_histogram_f64",
  "abi-r1:cuda:navatala_runtime_deterministic_histogram_f64",
  "abi-r1:cuda:navatala_runtime_deterministic_histogram_f64",
  6,
  kAbiArgs_cuda_navatala_runtime_deterministic_histogram_f64
};

bool tryGetKernelAbiManifest_cuda_runtime(const std::string& backend, const std::string& kernelName, const KernelAbiManifestInfo*& out) {
  if (backend == "cuda" && kernelName == "navatala_runtime_deterministic_reduce_f32") {
    out = &kAbiManifest_cuda_navatala_runtime_deterministic_reduce_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_runtime_deterministic_reduce_f64") {
    out = &kAbiManifest_cuda_navatala_runtime_deterministic_reduce_f64;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_runtime_deterministic_histogram_f32") {
    out = &kAbiManifest_cuda_navatala_runtime_deterministic_histogram_f32;
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_runtime_deterministic_histogram_f64") {
    out = &kAbiManifest_cuda_navatala_runtime_deterministic_histogram_f64;
    return true;
  }
  out = nullptr;
  return false;
...
bool tryGetKernelSource_cuda_runtime(const std::string& backend, const std::string& kernelName, GpuRuntime::ProgramSource& out) {
  if (backend == "cuda" && kernelName == "navatala_runtime_deterministic_reduce_f32") {
    out.kind = GpuRuntime::ProgramSource::Kind::CudaCpp;
    out.entryPoint = "navatala_runtime_deterministic_reduce_f32";
    std::string_view sv(k_cuda_navatala_runtime_deterministic_reduce_f32);
  ...
  if (backend == "cuda" && kernelName == "navatala_runtime_deterministic_reduce_f64") {
    ...
    std::string_view sv(k_cuda_navatala_runtime_deterministic_reduce_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_runtime_deterministic_histogram_f32") {
    ...
    std::string_view sv(k_cuda_navatala_runtime_deterministic_histogram_f32);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  if (backend == "cuda" && kernelName == "navatala_runtime_deterministic_histogram_f64") {
    ...
    std::string_view sv(k_cuda_navatala_runtime_deterministic_histogram_f64);
    out.bytes.assign(sv.begin(), sv.end());
    return true;
  }
  return false;
