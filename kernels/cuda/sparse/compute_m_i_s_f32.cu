...
extern "C" __global__ void navatala_sparse_compute_m_i_s_f32(const unsigned int* strongRowPtr, const unsigned int* strongColIdx, const unsigned int* randomPriority, const unsigned int* nCells, int* aggregateId, unsigned int* nUndecided) {
