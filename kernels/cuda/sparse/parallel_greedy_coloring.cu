...
extern "C" __global__ void navatala_sparse_parallel_greedy_coloring(const unsigned int* rowPtr, const unsigned int* colIdx, const unsigned int* nRows, const unsigned int* seed, int* colors, unsigned int* nColors) {
