...
extern "C" __global__ void navatala_sparse_compute_so_c_ldu_fill_f32(const unsigned int* owner, const unsigned int* neighbour, const float* upper, const float* lower, const unsigned int* cellFaceOffsets, const unsigned int* cellFaceIdx, const unsigned int* strongRowPtr, const float* theta, const unsigned int* nCells, unsigned int* strongColIdx) {
