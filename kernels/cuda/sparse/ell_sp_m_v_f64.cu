...
extern "C" __global__ void navatala_sparse_ell_sp_m_v_f64(const unsigned int* ellColIdx, const double* ellValues, const double* x, const unsigned int* nRows, const unsigned int* maxNnzPerRow, double* y) {
