...
extern "C" __global__ void navatala_sparse_aggregate_size2_confirm(const int* pickArray, const unsigned int* nRows, int* aggregateId, unsigned int* nAggregates) {
