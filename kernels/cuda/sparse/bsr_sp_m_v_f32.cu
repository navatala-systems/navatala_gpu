...
extern "C" __global__ void navatala_sparse_bsr_sp_m_v_f32(const unsigned int* rowPtr, const unsigned int* colIdx, const float* values, const float* x, const unsigned int* nBlockRows, const unsigned int* blockDim, float* y) {
