...
extern "C" __global__ void navatala_sparse_pipe_c_g_fused_f64(const double* p, const double* Ap, const double* diagInv, const double* alpha, const unsigned int* n, double* x, double* r, double* z, double* partials) {
