...
extern "C" __global__ void navatala_sparse_compute_residual_f32(const unsigned int* rowPtr, const unsigned int* colInd, const float* values, const float* x, const float* b, const unsigned int* n, float* residual) {
