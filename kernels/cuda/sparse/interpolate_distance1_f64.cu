...
extern "C" __global__ void navatala_sparse_interpolate_distance1_f64(const unsigned int* rowPtr, const unsigned int* colIdx, const double* values, const unsigned int* strongMask, const int* cfMarking, const unsigned int* ProwPtr, const unsigned int* nRows, unsigned int* PcolIdx, double* Pvalues) {
