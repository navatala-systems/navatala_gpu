...
extern "C" __global__ void navatala_sparse_interpolate_distance2_f32(const unsigned int* rowPtr, const unsigned int* colIdx, const float* values, const unsigned int* strongMask, const int* cfMarking, const unsigned int* diagIdx, const unsigned int* ProwPtr, const unsigned int* nRows, unsigned int* PcolIdx, float* Pvalues) {
