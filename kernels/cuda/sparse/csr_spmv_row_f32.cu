...
extern "C" __global__ void navatala_sparse_csr_spmv_row_f32(const unsigned int* rowPtr, const unsigned int* colInd, const float* values, const float* x, const unsigned int* n, float* y) {
