...
extern "C" __global__ void navatala_sparse_min_max_coloring(const unsigned int* rowPtr, const unsigned int* colIdx, const unsigned int* nRows, int* colors, unsigned int* nColors) {
