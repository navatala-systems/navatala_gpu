...
extern "C" __global__ void navatala_sparse_interpolate_ext_no_i_count_f32(const unsigned int* rowPtr, const unsigned int* colIdx, const unsigned int* strongMask, const int* cfMarking, const unsigned int* nRows, unsigned int* nnzPerRow) {
