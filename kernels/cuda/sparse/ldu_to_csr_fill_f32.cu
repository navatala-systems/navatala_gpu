...
extern "C" __global__ void navatala_sparse_ldu_to_csr_fill_f32(const unsigned int* owner, const unsigned int* neighbour, const float* upper, const float* lower, const unsigned int* rowPtr, const unsigned int* nInternalFaces, const unsigned int* nCells, unsigned int* colInd, float* values, unsigned int* insertIdx) {
