...
extern "C" __global__ void navatala_sparse_csr_spmv_row_f64(const unsigned int* rowPtr, const unsigned int* colInd, const double* values, const double* x, const unsigned int* n, double* y) {
