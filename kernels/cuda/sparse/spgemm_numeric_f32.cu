...
extern "C" __global__ void navatala_sparse_spgemm_numeric_f32(const unsigned int* ArowPtr, const unsigned int* AcolIdx, const float* Avalues, const unsigned int* BrowPtr, const unsigned int* BcolIdx, const float* Bvalues, const unsigned int* CrowPtr, const unsigned int* nRowsA, unsigned int* CcolIdx, float* Cvalues) {
