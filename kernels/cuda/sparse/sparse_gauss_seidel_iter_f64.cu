...
extern "C" __global__ void navatala_sparse_sparse_gauss_seidel_iter_f64(const unsigned int* rowPtr, const unsigned int* colInd, const double* values, const double* x, const double* b, const unsigned int* n, double* x_new) {
