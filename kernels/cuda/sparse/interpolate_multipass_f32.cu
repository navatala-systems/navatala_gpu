...
extern "C" __global__ void navatala_sparse_interpolate_multipass_f32(const unsigned int* rowPtr, const unsigned int* colIdx, const float* values, const unsigned int* strongMask, const int* cfMarking, const unsigned int* diagIdx, const unsigned int* ProwPtr, const unsigned int* nRows, const unsigned int* maxPass, unsigned int* PcolIdx, float* Pvalues) {
