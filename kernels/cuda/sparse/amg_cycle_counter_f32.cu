...
extern "C" __global__ void navatala_sparse_amg_cycle_counter_f32(const float* residualNorm, const float* tolerance, const unsigned int* maxCycles, unsigned int* cycleCount, unsigned int* converged) {
