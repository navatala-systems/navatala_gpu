...
extern "C" __global__ void navatala_sparse_pipe_c_g_fused_f32(const float* p, const float* Ap, const float* diagInv, const float* alpha, const unsigned int* n, float* x, float* r, float* z, float* partials) {
