...
extern "C" __global__ void navatala_sparse_compute_so_c_ldu_fill_f64(const unsigned int* owner, const unsigned int* neighbour, const double* upper, const double* lower, const unsigned int* cellFaceOffsets, const unsigned int* cellFaceIdx, const unsigned int* strongRowPtr, const double* theta, const unsigned int* nCells, unsigned int* strongColIdx) {
