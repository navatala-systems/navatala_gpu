...
#include <cuda_bf16.h>
extern "C" __global__ void navatala_ml_normal_bf16(const unsigned int* count, const unsigned int* seed, __nv_bfloat16* _output) {
  ...
  if (gid < countVal) {
    ...
    __nv_bfloat16 outV = ((__nv_bfloat16)(z));
    _output[gid] = outV;
  }
}
