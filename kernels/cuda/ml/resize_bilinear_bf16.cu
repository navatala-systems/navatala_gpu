...
#include <cuda_bf16.h>
extern "C" __global__ void navatala_ml_resize_bilinear_bf16(const __nv_bfloat16* _input, const unsigned int* inSize, const unsigned int* outSize, __nv_bfloat16* _output) {
