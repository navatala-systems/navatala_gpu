...
#include <cuda_bf16.h>
extern "C" __global__ void navatala_ml_layernorm_bf16(const __nv_bfloat16* x, const __nv_bfloat16* gamma, const __nv_bfloat16* beta, const unsigned int* count, const float* eps, __nv_bfloat16* _output) {
