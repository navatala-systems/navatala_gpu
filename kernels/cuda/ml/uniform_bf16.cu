...
#include <cuda_bf16.h>
extern "C" __global__ void navatala_ml_uniform_bf16(const unsigned int* count, const unsigned int* seed, __nv_bfloat16* _output) {
  ...
  if (gid < countVal) {
    ...
    __nv_bfloat16 outV = ((__nv_bfloat16)(uF));
    _output[gid] = outV;
  }
}
